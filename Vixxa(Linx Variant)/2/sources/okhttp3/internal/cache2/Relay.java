...
public final class Relay {
    ...
    public final class RelaySource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:44:?, code lost:
            ...
            r1.this$0.getUpstreamBuffer().copyTo(r22, 0, r19);
            r1.sourcePos += r19;
            r13 = r1.fileOperator;
            kotlin.jvm.internal.Intrinsics.checkNotNull(r13);
            r13.write(r1.this$0.getUpstreamPos() + 32, r1.this$0.getUpstreamBuffer().clone(), r11);
            r2 = r1.this$0;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:48:0x0123, code lost:
            if (r2.getBuffer().size() <= r2.getBufferMaxSize()) goto L_0x0139;
         */
        ...
        public long read(okio.Buffer r22, long r23) throws java.io.IOException {
            /*
                ...
                monitor-enter(r8)
            L_0x0012:
                long r6 = r8.getUpstreamPos()     // Catch:{ all -> 0x016e }
                long r9 = r1.sourcePos     // Catch:{ all -> 0x016e }
                int r0 = (r9 > r6 ? 1 : (r9 == r6 ? 0 : -1))
                r4 = 2
                r6 = -1
                if (r0 == 0) goto L_0x0055
                long r9 = r8.getUpstreamPos()     // Catch:{ all -> 0x016e }
                okio.Buffer r0 = r8.getBuffer()     // Catch:{ all -> 0x016e }
                long r11 = r0.size()     // Catch:{ all -> 0x016e }
                long r9 = r9 - r11
                long r11 = r1.sourcePos     // Catch:{ all -> 0x016e }
            ...
            L_0x0034:
                ...
                long r11 = r1.sourcePos     // Catch:{ all -> 0x016e }
                long r6 = r6 - r11
                long r11 = java.lang.Math.min(r2, r6)     // Catch:{ all -> 0x016e }
                okio.Buffer r2 = r8.getBuffer()     // Catch:{ all -> 0x016e }
                long r3 = r1.sourcePos     // Catch:{ all -> 0x016e }
                long r6 = r3 - r9
                r3 = r22
                r4 = r6
                r6 = r11
                r2.copyTo((okio.Buffer) r3, (long) r4, (long) r6)     // Catch:{ all -> 0x016e }
                long r2 = r1.sourcePos     // Catch:{ all -> 0x016e }
                long r2 = r2 + r11
                r1.sourcePos = r2     // Catch:{ all -> 0x016e }
                monitor-exit(r8)
                return r11
            L_0x0055:
                boolean r0 = r8.getComplete()     // Catch:{ all -> 0x016e }
                if (r0 == 0) goto L_0x005d
                monitor-exit(r8)
                return r6
            L_0x005d:
                java.lang.Thread r0 = r8.getUpstreamReader()     // Catch:{ all -> 0x016e }
                if (r0 == 0) goto L_0x0069
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x016e }
                r0.waitUntilNotified(r8)     // Catch:{ all -> 0x016e }
                goto L_0x0012
            L_0x0069:
                java.lang.Thread r0 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x016e }
                r8.setUpstreamReader(r0)     // Catch:{ all -> 0x016e }
                r0 = 1
            L_0x0071:
                monitor-exit(r8)
                r8 = 32
            ...
            L_0x0097:
                r10 = 0
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015a }
                okio.Source r0 = r0.getUpstream()     // Catch:{ all -> 0x015a }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x015a }
                okhttp3.internal.cache2.Relay r4 = r1.this$0     // Catch:{ all -> 0x015a }
                okio.Buffer r4 = r4.getUpstreamBuffer()     // Catch:{ all -> 0x015a }
                okhttp3.internal.cache2.Relay r11 = r1.this$0     // Catch:{ all -> 0x015a }
                long r11 = r11.getBufferMaxSize()     // Catch:{ all -> 0x015a }
                long r11 = r0.read(r4, r11)     // Catch:{ all -> 0x015a }
                int r0 = (r11 > r6 ? 1 : (r11 == r6 ? 0 : -1))
                if (r0 != 0) goto L_0x00d1
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015a }
                long r2 = r0.getUpstreamPos()     // Catch:{ all -> 0x015a }
                r0.commit(r2)     // Catch:{ all -> 0x015a }
                okhttp3.internal.cache2.Relay r2 = r1.this$0
                monitor-enter(r2)
                r2.setUpstreamReader(r10)     // Catch:{ all -> 0x00ce }
                r0 = r2
                java.lang.Object r0 = (java.lang.Object) r0     // Catch:{ all -> 0x00ce }
            ...
            L_0x00ce:
                ...
                throw r0
            L_0x00d1:
                long r19 = java.lang.Math.min(r11, r2)     // Catch:{ all -> 0x015a }
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015a }
                okio.Buffer r2 = r0.getUpstreamBuffer()     // Catch:{ all -> 0x015a }
                r6 = 0
                r3 = r22
                r4 = r6
                r6 = r19
                r2.copyTo((okio.Buffer) r3, (long) r4, (long) r6)     // Catch:{ all -> 0x015a }
                long r2 = r1.sourcePos     // Catch:{ all -> 0x015a }
                long r2 = r2 + r19
                r1.sourcePos = r2     // Catch:{ all -> 0x015a }
                okhttp3.internal.cache2.FileOperator r13 = r1.fileOperator     // Catch:{ all -> 0x015a }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r13)     // Catch:{ all -> 0x015a }
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015a }
                long r2 = r0.getUpstreamPos()     // Catch:{ all -> 0x015a }
                long r14 = r2 + r8
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015a }
                okio.Buffer r0 = r0.getUpstreamBuffer()     // Catch:{ all -> 0x015a }
                okio.Buffer r16 = r0.clone()     // Catch:{ all -> 0x015a }
                r17 = r11
                r13.write(r14, r16, r17)     // Catch:{ all -> 0x015a }
                okhttp3.internal.cache2.Relay r2 = r1.this$0     // Catch:{ all -> 0x015a }
                monitor-enter(r2)     // Catch:{ all -> 0x015a }
                okio.Buffer r0 = r2.getBuffer()     // Catch:{ all -> 0x0157 }
                okio.Buffer r3 = r2.getUpstreamBuffer()     // Catch:{ all -> 0x0157 }
                r0.write((okio.Buffer) r3, (long) r11)     // Catch:{ all -> 0x0157 }
                okio.Buffer r0 = r2.getBuffer()     // Catch:{ all -> 0x0157 }
                long r3 = r0.size()     // Catch:{ all -> 0x0157 }
                long r5 = r2.getBufferMaxSize()     // Catch:{ all -> 0x0157 }
                int r0 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
                if (r0 <= 0) goto L_0x0139
                okio.Buffer r0 = r2.getBuffer()     // Catch:{ all -> 0x0157 }
                okio.Buffer r3 = r2.getBuffer()     // Catch:{ all -> 0x0157 }
                long r3 = r3.size()     // Catch:{ all -> 0x0157 }
                long r5 = r2.getBufferMaxSize()     // Catch:{ all -> 0x0157 }
                long r3 = r3 - r5
                r0.skip(r3)     // Catch:{ all -> 0x0157 }
            L_0x0139:
                long r3 = r2.getUpstreamPos()     // Catch:{ all -> 0x0157 }
                long r3 = r3 + r11
                r2.setUpstreamPos(r3)     // Catch:{ all -> 0x0157 }
                ...
                r0 = r2
                java.lang.Object r0 = (java.lang.Object) r0     // Catch:{ all -> 0x0154 }
                r0.notifyAll()     // Catch:{ all -> 0x0154 }
            ...
            L_0x015a:
                ...
                okhttp3.internal.cache2.Relay r2 = r1.this$0
                monitor-enter(r2)
                r2.setUpstreamReader(r10)     // Catch:{ all -> 0x016b }
                r3 = r2
                java.lang.Object r3 = (java.lang.Object) r3     // Catch:{ all -> 0x016b }
                r3.notifyAll()     // Catch:{ all -> 0x016b }
                kotlin.Unit r3 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x016b }
                monitor-exit(r2)
                throw r0
            L_0x016b:
                r0 = move-exception
