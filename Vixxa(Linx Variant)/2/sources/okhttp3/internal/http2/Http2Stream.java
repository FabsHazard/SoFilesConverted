...
public final class Http2Stream {
    ...
    public final synchronized okhttp3.Headers takeHeaders() throws java.io.IOException {
        ...
        L_0x0016:
            ...
            java.util.Collection r0 = (java.util.Collection) r0     // Catch:{ all -> 0x004c }
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r1)     // Catch:{ all -> 0x004c }
        ...
        L_0x0034:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x004c }
            r0.<init>(r1)     // Catch:{ all -> 0x004c }
        L_0x0042:
            java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x004c }
    ...
    public final class FramingSink implements Sink {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x0068, code lost:
            if (r10.trailers == null) goto L_0x0091;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:29:0x0072, code lost:
            if (r10.sendBuffer.size() <= 0) goto L_0x0078;
         */
        ...
        public void close() throws java.io.IOException {
            ...
            L_0x0034:
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
                boolean r1 = r10.getClosed()     // Catch:{ all -> 0x00d1 }
                if (r1 == 0) goto L_0x003f
                monitor-exit(r0)
                return
            L_0x003f:
                okhttp3.internal.http2.ErrorCode r1 = r0.getErrorCode$okhttp()     // Catch:{ all -> 0x00d1 }
                r2 = 0
                r3 = 1
            ...
            L_0x00b6:
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
                r10.setClosed(r3)     // Catch:{ all -> 0x00ce }
                kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00ce }
                monitor-exit(r0)
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                okhttp3.internal.http2.Http2Connection r0 = r0.getConnection()
                r0.flush()
    ...
    public final void receiveHeaders(okhttp3.Headers r3, boolean r4) {
        ...
        L_0x0037:
            monitor-enter(r2)
            boolean r0 = r2.hasResponseHeaders     // Catch:{ all -> 0x0071 }
            r1 = 1
            if (r0 == 0) goto L_0x0048
            if (r4 != 0) goto L_0x0040
            goto L_0x0048
        L_0x0040:
            okhttp3.internal.http2.Http2Stream$FramingSource r0 = r2.getSource$okhttp()     // Catch:{ all -> 0x0071 }
            r0.setTrailers(r3)     // Catch:{ all -> 0x0071 }
            goto L_0x0051
        L_0x0048:
            r2.hasResponseHeaders = r1     // Catch:{ all -> 0x0071 }
            java.util.ArrayDeque<okhttp3.Headers> r0 = r2.headersQueue     // Catch:{ all -> 0x0071 }
            java.util.Collection r0 = (java.util.Collection) r0     // Catch:{ all -> 0x0071 }
            r0.add(r3)     // Catch:{ all -> 0x0071 }
        L_0x0051:
            if (r4 == 0) goto L_0x005a
            okhttp3.internal.http2.Http2Stream$FramingSource r3 = r2.getSource$okhttp()     // Catch:{ all -> 0x0071 }
            r3.setFinished$okhttp(r1)     // Catch:{ all -> 0x0071 }
        L_0x005a:
            boolean r3 = r2.isOpen()     // Catch:{ all -> 0x0071 }
            r4 = r2
            java.lang.Object r4 = (java.lang.Object) r4     // Catch:{ all -> 0x0071 }
            r4.notifyAll()     // Catch:{ all -> 0x0071 }
            kotlin.Unit r4 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0071 }
            monitor-exit(r2)
