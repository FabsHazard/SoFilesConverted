...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:18:0x009f A[Catch:{ IOException -> 0x00fc }] */
    ...
    public final void connect(int r17, int r18, int r19, int r20, boolean r21, okhttp3.Call r22, okhttp3.EventListener r23) {
        ...
        L_0x0095:
            ...
            r12 = r11
        L_0x0097:
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00fc }
            boolean r0 = r0.requiresTunnel()     // Catch:{ IOException -> 0x00fc }
            ...
            r5 = r22
            r6 = r23
            r1.connectTunnel(r2, r3, r4, r5, r6)     // Catch:{ IOException -> 0x00fc }
            java.net.Socket r0 = r7.rawSocket     // Catch:{ IOException -> 0x00fc }
        ...
        L_0x00b8:
            r13 = r17
            r14 = r18
            r7.connectSocket(r13, r14, r8, r9)     // Catch:{ IOException -> 0x00fa }
        L_0x00bf:
            r15 = r20
            r7.establishProtocol(r10, r15, r8, r9)     // Catch:{ IOException -> 0x00f8 }
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00f8 }
            java.net.InetSocketAddress r0 = r0.socketAddress()     // Catch:{ IOException -> 0x00f8 }
            okhttp3.Route r1 = r7.route     // Catch:{ IOException -> 0x00f8 }
            java.net.Proxy r1 = r1.proxy()     // Catch:{ IOException -> 0x00f8 }
            okhttp3.Protocol r2 = r7.protocol     // Catch:{ IOException -> 0x00f8 }
            r9.connectEnd(r8, r0, r1, r2)     // Catch:{ IOException -> 0x00f8 }
        L_0x00d5:
            okhttp3.Route r0 = r7.route
    ...
    /* JADX WARNING: Removed duplicated region for block: B:37:0x0199  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r11) throws java.io.IOException {
        /*
            ...
            r4 = 0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r3)     // Catch:{ all -> 0x018a }
            java.net.Socket r5 = r10.rawSocket     // Catch:{ all -> 0x018a }
            okhttp3.HttpUrl r6 = r2.url()     // Catch:{ all -> 0x018a }
            java.lang.String r6 = r6.host()     // Catch:{ all -> 0x018a }
            okhttp3.HttpUrl r7 = r2.url()     // Catch:{ all -> 0x018a }
            int r7 = r7.port()     // Catch:{ all -> 0x018a }
            r8 = 1
            java.net.Socket r3 = r3.createSocket(r5, r6, r7, r8)     // Catch:{ all -> 0x018a }
            if (r3 == 0) goto L_0x0182
            javax.net.ssl.SSLSocket r3 = (javax.net.ssl.SSLSocket) r3     // Catch:{ all -> 0x018a }
            okhttp3.ConnectionSpec r11 = r11.configureSecureSocket(r3)     // Catch:{ all -> 0x017f }
            boolean r5 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x017f }
            if (r5 == 0) goto L_0x004c
            okhttp3.internal.platform.Platform$Companion r5 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x017f }
            okhttp3.internal.platform.Platform r5 = r5.get()     // Catch:{ all -> 0x017f }
            okhttp3.HttpUrl r6 = r2.url()     // Catch:{ all -> 0x017f }
            java.lang.String r6 = r6.host()     // Catch:{ all -> 0x017f }
            java.util.List r7 = r2.protocols()     // Catch:{ all -> 0x017f }
            r5.configureTlsExtensions(r3, r6, r7)     // Catch:{ all -> 0x017f }
        L_0x004c:
            r3.startHandshake()     // Catch:{ all -> 0x017f }
            javax.net.ssl.SSLSession r5 = r3.getSession()     // Catch:{ all -> 0x017f }
            okhttp3.Handshake$Companion r6 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x017f }
            java.lang.String r7 = "sslSocketSession"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r5, r7)     // Catch:{ all -> 0x017f }
            okhttp3.Handshake r6 = r6.get(r5)     // Catch:{ all -> 0x017f }
            javax.net.ssl.HostnameVerifier r7 = r2.hostnameVerifier()     // Catch:{ all -> 0x017f }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r7)     // Catch:{ all -> 0x017f }
            okhttp3.HttpUrl r9 = r2.url()     // Catch:{ all -> 0x017f }
            java.lang.String r9 = r9.host()     // Catch:{ all -> 0x017f }
            boolean r5 = r7.verify(r9, r5)     // Catch:{ all -> 0x017f }
            if (r5 != 0) goto L_0x0102
            java.util.List r11 = r6.peerCertificates()     // Catch:{ all -> 0x017f }
            r5 = r11
            java.util.Collection r5 = (java.util.Collection) r5     // Catch:{ all -> 0x017f }
            boolean r5 = r5.isEmpty()     // Catch:{ all -> 0x017f }
            if (r5 != 0) goto L_0x00e1
            r1 = 0
            java.lang.Object r11 = r11.get(r1)     // Catch:{ all -> 0x017f }
            java.security.cert.X509Certificate r11 = (java.security.cert.X509Certificate) r11     // Catch:{ all -> 0x017f }
            javax.net.ssl.SSLPeerUnverifiedException r1 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x017f }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x017f }
            r5.<init>(r0)     // Catch:{ all -> 0x017f }
            okhttp3.HttpUrl r0 = r2.url()     // Catch:{ all -> 0x017f }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x017f }
            java.lang.StringBuilder r0 = r5.append(r0)     // Catch:{ all -> 0x017f }
            java.lang.String r2 = " not verified:\n              |    certificate: "
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x017f }
            okhttp3.CertificatePinner$Companion r2 = okhttp3.CertificatePinner.Companion     // Catch:{ all -> 0x017f }
            r5 = r11
            java.security.cert.Certificate r5 = (java.security.cert.Certificate) r5     // Catch:{ all -> 0x017f }
            java.lang.String r2 = r2.pin(r5)     // Catch:{ all -> 0x017f }
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x017f }
            java.lang.String r2 = "\n              |    DN: "
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x017f }
            java.security.Principal r2 = r11.getSubjectDN()     // Catch:{ all -> 0x017f }
            java.lang.String r2 = r2.getName()     // Catch:{ all -> 0x017f }
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x017f }
            java.lang.String r2 = "\n              |    subjectAltNames: "
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x017f }
            okhttp3.internal.tls.OkHostnameVerifier r2 = okhttp3.internal.tls.OkHostnameVerifier.INSTANCE     // Catch:{ all -> 0x017f }
            java.util.List r11 = r2.allSubjectAltNames(r11)     // Catch:{ all -> 0x017f }
            java.lang.StringBuilder r11 = r0.append(r11)     // Catch:{ all -> 0x017f }
            java.lang.String r0 = "\n              "
            java.lang.StringBuilder r11 = r11.append(r0)     // Catch:{ all -> 0x017f }
            java.lang.String r11 = r11.toString()     // Catch:{ all -> 0x017f }
            java.lang.String r11 = kotlin.text.StringsKt.trimMargin$default(r11, r4, r8, r4)     // Catch:{ all -> 0x017f }
            r1.<init>(r11)     // Catch:{ all -> 0x017f }
        ...
        L_0x00e1:
            ...
            okhttp3.HttpUrl r1 = r2.url()     // Catch:{ all -> 0x017f }
            java.lang.String r1 = r1.host()     // Catch:{ all -> 0x017f }
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ all -> 0x017f }
            java.lang.String r1 = " not verified (no certificates)"
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ all -> 0x017f }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x017f }
            r11.<init>(r0)     // Catch:{ all -> 0x017f }
            throw r11     // Catch:{ all -> 0x017f }
        L_0x0102:
            okhttp3.CertificatePinner r0 = r2.certificatePinner()     // Catch:{ all -> 0x017f }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x017f }
            okhttp3.Handshake r1 = new okhttp3.Handshake     // Catch:{ all -> 0x017f }
            okhttp3.TlsVersion r5 = r6.tlsVersion()     // Catch:{ all -> 0x017f }
            okhttp3.CipherSuite r7 = r6.cipherSuite()     // Catch:{ all -> 0x017f }
            java.util.List r8 = r6.localCertificates()     // Catch:{ all -> 0x017f }
            ...
            r9.<init>(r0, r6, r2)     // Catch:{ all -> 0x017f }
            kotlin.jvm.functions.Function0 r9 = (kotlin.jvm.functions.Function0) r9     // Catch:{ all -> 0x017f }
            r1.<init>(r5, r7, r8, r9)     // Catch:{ all -> 0x017f }
            r10.handshake = r1     // Catch:{ all -> 0x017f }
            okhttp3.HttpUrl r1 = r2.url()     // Catch:{ all -> 0x017f }
            java.lang.String r1 = r1.host()     // Catch:{ all -> 0x017f }
            okhttp3.internal.connection.RealConnection$connectTls$2 r2 = new okhttp3.internal.connection.RealConnection$connectTls$2     // Catch:{ all -> 0x017f }
            r2.<init>(r10)     // Catch:{ all -> 0x017f }
            kotlin.jvm.functions.Function0 r2 = (kotlin.jvm.functions.Function0) r2     // Catch:{ all -> 0x017f }
            r0.check$okhttp(r1, r2)     // Catch:{ all -> 0x017f }
            boolean r11 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x017f }
            if (r11 == 0) goto L_0x0146
            okhttp3.internal.platform.Platform$Companion r11 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x017f }
            okhttp3.internal.platform.Platform r11 = r11.get()     // Catch:{ all -> 0x017f }
            java.lang.String r4 = r11.getSelectedProtocol(r3)     // Catch:{ all -> 0x017f }
            goto L_0x0149
        L_0x0146:
            r11 = r4
        ...
        L_0x0149:
            r11 = r3
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x017f }
            r10.socket = r11     // Catch:{ all -> 0x017f }
            r11 = r3
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x017f }
            okio.Source r11 = okio.Okio.source((java.net.Socket) r11)     // Catch:{ all -> 0x017f }
            okio.BufferedSource r11 = okio.Okio.buffer((okio.Source) r11)     // Catch:{ all -> 0x017f }
            r10.source = r11     // Catch:{ all -> 0x017f }
            r11 = r3
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x017f }
            okio.Sink r11 = okio.Okio.sink((java.net.Socket) r11)     // Catch:{ all -> 0x017f }
            okio.BufferedSink r11 = okio.Okio.buffer((okio.Sink) r11)     // Catch:{ all -> 0x017f }
            r10.sink = r11     // Catch:{ all -> 0x017f }
            if (r4 == 0) goto L_0x0171
            okhttp3.Protocol$Companion r11 = okhttp3.Protocol.Companion     // Catch:{ all -> 0x017f }
            okhttp3.Protocol r11 = r11.get(r4)     // Catch:{ all -> 0x017f }
            goto L_0x0173
        L_0x0171:
            okhttp3.Protocol r11 = okhttp3.Protocol.HTTP_1_1     // Catch:{ all -> 0x017f }
        L_0x0173:
            r10.protocol = r11     // Catch:{ all -> 0x017f }
    ...
    private final boolean certificateSupportHost(HttpUrl httpUrl, Handshake handshake2) {
        ...
        return !peerCertificates.isEmpty() && OkHostnameVerifier.INSTANCE.verify(httpUrl.host(), (X509Certificate) peerCertificates.get(0));
    }
    ...
    public String toString() {
        ...
        Object obj = PushBuildConfig.sdk_conf_debug_level;
