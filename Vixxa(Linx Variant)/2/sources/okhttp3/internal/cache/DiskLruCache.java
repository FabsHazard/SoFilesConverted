...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        r10.redundantOpCount = r0 - getLruEntries$okhttp().size();
     */
    ...
    /* JADX WARNING: Unknown top exception splitter block from list: {B:16:0x0067=Splitter:B:16:0x0067, B:24:0x0089=Splitter:B:24:0x0089} */
    ...
    private final void readJournal() throws java.io.IOException {
        /*
            ...
            r3 = r2
            okio.BufferedSource r3 = (okio.BufferedSource) r3     // Catch:{ all -> 0x00ba }
            java.lang.String r4 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ba }
            java.lang.String r5 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ba }
            java.lang.String r6 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ba }
            java.lang.String r7 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ba }
            java.lang.String r8 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00ba }
            java.lang.String r9 = MAGIC     // Catch:{ all -> 0x00ba }
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r9, (java.lang.Object) r4)     // Catch:{ all -> 0x00ba }
            if (r9 == 0) goto L_0x0089
            java.lang.String r9 = VERSION_1     // Catch:{ all -> 0x00ba }
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r9, (java.lang.Object) r5)     // Catch:{ all -> 0x00ba }
            if (r9 == 0) goto L_0x0089
            int r9 = r10.appVersion     // Catch:{ all -> 0x00ba }
            java.lang.String r9 = java.lang.String.valueOf(r9)     // Catch:{ all -> 0x00ba }
            boolean r6 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r9, (java.lang.Object) r6)     // Catch:{ all -> 0x00ba }
            if (r6 == 0) goto L_0x0089
            int r6 = r10.getValueCount$okhttp()     // Catch:{ all -> 0x00ba }
            java.lang.String r6 = java.lang.String.valueOf(r6)     // Catch:{ all -> 0x00ba }
            boolean r6 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r6, (java.lang.Object) r7)     // Catch:{ all -> 0x00ba }
            if (r6 == 0) goto L_0x0089
            r6 = r8
            java.lang.CharSequence r6 = (java.lang.CharSequence) r6     // Catch:{ all -> 0x00ba }
        ...
        L_0x005d:
            ...
            goto L_0x005d
        L_0x0067:
            java.util.LinkedHashMap r1 = r10.getLruEntries$okhttp()     // Catch:{ all -> 0x00ba }
            int r1 = r1.size()     // Catch:{ all -> 0x00ba }
            int r0 = r0 - r1
            r10.redundantOpCount = r0     // Catch:{ all -> 0x00ba }
            boolean r0 = r3.exhausted()     // Catch:{ all -> 0x00ba }
            if (r0 != 0) goto L_0x007c
            r10.rebuildJournal$okhttp()     // Catch:{ all -> 0x00ba }
            goto L_0x0082
        L_0x007c:
            okio.BufferedSink r0 = r10.newJournalWriter()     // Catch:{ all -> 0x00ba }
            r10.journalWriter = r0     // Catch:{ all -> 0x00ba }
        L_0x0082:
            ...
            return
        L_0x0089:
            java.io.IOException r3 = new java.io.IOException     // Catch:{ all -> 0x00ba }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ba }
            r6.<init>(r1)     // Catch:{ all -> 0x00ba }
            java.lang.StringBuilder r1 = r6.append(r4)     // Catch:{ all -> 0x00ba }
            java.lang.StringBuilder r1 = r1.append(r0)     // Catch:{ all -> 0x00ba }
            java.lang.StringBuilder r1 = r1.append(r5)     // Catch:{ all -> 0x00ba }
            java.lang.StringBuilder r1 = r1.append(r0)     // Catch:{ all -> 0x00ba }
            java.lang.StringBuilder r1 = r1.append(r7)     // Catch:{ all -> 0x00ba }
            java.lang.StringBuilder r0 = r1.append(r0)     // Catch:{ all -> 0x00ba }
            java.lang.StringBuilder r0 = r0.append(r8)     // Catch:{ all -> 0x00ba }
            r1 = 93
    ...
    public final synchronized void rebuildJournal$okhttp() throws java.io.IOException {
        /*
            r7 = this;
            monitor-enter(r7)
            okio.BufferedSink r0 = r7.journalWriter     // Catch:{ all -> 0x00cf }
            if (r0 != 0) goto L_0x0006
            goto L_0x0009
        L_0x0006:
            r0.close()     // Catch:{ all -> 0x00cf }
        L_0x0009:
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00cf }
            java.io.File r1 = r7.journalFileTmp     // Catch:{ all -> 0x00cf }
            ...
            r1 = r0
            okio.BufferedSink r1 = (okio.BufferedSink) r1     // Catch:{ all -> 0x00c8 }
            java.lang.String r2 = MAGIC     // Catch:{ all -> 0x00c8 }
            okio.BufferedSink r2 = r1.writeUtf8(r2)     // Catch:{ all -> 0x00c8 }
            r3 = 10
            r2.writeByte(r3)     // Catch:{ all -> 0x00c8 }
            java.lang.String r2 = VERSION_1     // Catch:{ all -> 0x00c8 }
            okio.BufferedSink r2 = r1.writeUtf8(r2)     // Catch:{ all -> 0x00c8 }
            r2.writeByte(r3)     // Catch:{ all -> 0x00c8 }
            int r2 = r7.appVersion     // Catch:{ all -> 0x00c8 }
            long r4 = (long) r2     // Catch:{ all -> 0x00c8 }
            okio.BufferedSink r2 = r1.writeDecimalLong(r4)     // Catch:{ all -> 0x00c8 }
            r2.writeByte(r3)     // Catch:{ all -> 0x00c8 }
            int r2 = r7.getValueCount$okhttp()     // Catch:{ all -> 0x00c8 }
            long r4 = (long) r2     // Catch:{ all -> 0x00c8 }
            okio.BufferedSink r2 = r1.writeDecimalLong(r4)     // Catch:{ all -> 0x00c8 }
            r2.writeByte(r3)     // Catch:{ all -> 0x00c8 }
            r1.writeByte(r3)     // Catch:{ all -> 0x00c8 }
            java.util.LinkedHashMap r2 = r7.getLruEntries$okhttp()     // Catch:{ all -> 0x00c8 }
            java.util.Collection r2 = r2.values()     // Catch:{ all -> 0x00c8 }
            java.util.Iterator r2 = r2.iterator()     // Catch:{ all -> 0x00c8 }
        L_0x0053:
            boolean r4 = r2.hasNext()     // Catch:{ all -> 0x00c8 }
            if (r4 == 0) goto L_0x0092
            java.lang.Object r4 = r2.next()     // Catch:{ all -> 0x00c8 }
            okhttp3.internal.cache.DiskLruCache$Entry r4 = (okhttp3.internal.cache.DiskLruCache.Entry) r4     // Catch:{ all -> 0x00c8 }
            okhttp3.internal.cache.DiskLruCache$Editor r5 = r4.getCurrentEditor$okhttp()     // Catch:{ all -> 0x00c8 }
            r6 = 32
            if (r5 == 0) goto L_0x007b
            java.lang.String r5 = DIRTY     // Catch:{ all -> 0x00c8 }
            okio.BufferedSink r5 = r1.writeUtf8(r5)     // Catch:{ all -> 0x00c8 }
            r5.writeByte(r6)     // Catch:{ all -> 0x00c8 }
            java.lang.String r4 = r4.getKey$okhttp()     // Catch:{ all -> 0x00c8 }
            r1.writeUtf8(r4)     // Catch:{ all -> 0x00c8 }
            r1.writeByte(r3)     // Catch:{ all -> 0x00c8 }
            goto L_0x0053
        L_0x007b:
            java.lang.String r5 = CLEAN     // Catch:{ all -> 0x00c8 }
            okio.BufferedSink r5 = r1.writeUtf8(r5)     // Catch:{ all -> 0x00c8 }
            r5.writeByte(r6)     // Catch:{ all -> 0x00c8 }
            java.lang.String r5 = r4.getKey$okhttp()     // Catch:{ all -> 0x00c8 }
            r1.writeUtf8(r5)     // Catch:{ all -> 0x00c8 }
            r4.writeLengths$okhttp(r1)     // Catch:{ all -> 0x00c8 }
            r1.writeByte(r3)     // Catch:{ all -> 0x00c8 }
            goto L_0x0053
        L_0x0092:
            kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00c8 }
            r1 = 0
            kotlin.io.CloseableKt.closeFinally(r0, r1)     // Catch:{ all -> 0x00cf }
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00cf }
            java.io.File r1 = r7.journalFile     // Catch:{ all -> 0x00cf }
            boolean r0 = r0.exists(r1)     // Catch:{ all -> 0x00cf }
            if (r0 == 0) goto L_0x00ab
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00cf }
            java.io.File r1 = r7.journalFile     // Catch:{ all -> 0x00cf }
            java.io.File r2 = r7.journalFileBackup     // Catch:{ all -> 0x00cf }
            r0.rename(r1, r2)     // Catch:{ all -> 0x00cf }
        L_0x00ab:
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00cf }
            java.io.File r1 = r7.journalFileTmp     // Catch:{ all -> 0x00cf }
            java.io.File r2 = r7.journalFile     // Catch:{ all -> 0x00cf }
            r0.rename(r1, r2)     // Catch:{ all -> 0x00cf }
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00cf }
            java.io.File r1 = r7.journalFileBackup     // Catch:{ all -> 0x00cf }
            r0.delete(r1)     // Catch:{ all -> 0x00cf }
            okio.BufferedSink r0 = r7.newJournalWriter()     // Catch:{ all -> 0x00cf }
            r7.journalWriter = r0     // Catch:{ all -> 0x00cf }
            r0 = 0
            r7.hasJournalErrors = r0     // Catch:{ all -> 0x00cf }
            r7.mostRecentRebuildFailed = r0     // Catch:{ all -> 0x00cf }
            monitor-exit(r7)
            return
        L_0x00c8:
            r1 = move-exception
    ...
    public final class Editor {
        ...
        public final okio.Source newSource(int r5) {
            /*
                ...
                monitor-enter(r0)
                boolean r1 = r4.done     // Catch:{ all -> 0x0055 }
                if (r1 != 0) goto L_0x0049
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.getEntry$okhttp()     // Catch:{ all -> 0x0055 }
                boolean r1 = r1.getReadable$okhttp()     // Catch:{ all -> 0x0055 }
                r2 = 0
                if (r1 == 0) goto L_0x0047
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.getEntry$okhttp()     // Catch:{ all -> 0x0055 }
                okhttp3.internal.cache.DiskLruCache$Editor r1 = r1.getCurrentEditor$okhttp()     // Catch:{ all -> 0x0055 }
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r4)     // Catch:{ all -> 0x0055 }
                if (r1 == 0) goto L_0x0047
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.getEntry$okhttp()     // Catch:{ all -> 0x0055 }
                boolean r1 = r1.getZombie$okhttp()     // Catch:{ all -> 0x0055 }
                if (r1 == 0) goto L_0x002b
                goto L_0x0047
            L_0x002b:
                okhttp3.internal.io.FileSystem r1 = r0.getFileSystem$okhttp()     // Catch:{ FileNotFoundException -> 0x0042 }
                okhttp3.internal.cache.DiskLruCache$Entry r3 = r4.getEntry$okhttp()     // Catch:{ FileNotFoundException -> 0x0042 }
            ...
            L_0x0042:
                r5 = r2
                okio.Source r5 = (okio.Source) r5     // Catch:{ all -> 0x0055 }
            L_0x0045:
                monitor-exit(r0)
                return r2
            L_0x0047:
            ...
            L_0x0049:
                ...
                java.lang.IllegalStateException r1 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0055 }
        ...
        public final okio.Sink newSink(int r4) {
            /*
                ...
                monitor-enter(r0)
                boolean r1 = r3.done     // Catch:{ all -> 0x0067 }
                if (r1 != 0) goto L_0x005b
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r3.getEntry$okhttp()     // Catch:{ all -> 0x0067 }
                okhttp3.internal.cache.DiskLruCache$Editor r1 = r1.getCurrentEditor$okhttp()     // Catch:{ all -> 0x0067 }
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r3)     // Catch:{ all -> 0x0067 }
                if (r1 != 0) goto L_0x001b
                okio.Sink r4 = okio.Okio.blackhole()     // Catch:{ all -> 0x0067 }
                monitor-exit(r0)
                return r4
            L_0x001b:
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r3.getEntry$okhttp()     // Catch:{ all -> 0x0067 }
                boolean r1 = r1.getReadable$okhttp()     // Catch:{ all -> 0x0067 }
                if (r1 != 0) goto L_0x002f
                boolean[] r1 = r3.getWritten$okhttp()     // Catch:{ all -> 0x0067 }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x0067 }
                r2 = 1
                r1[r4] = r2     // Catch:{ all -> 0x0067 }
            L_0x002f:
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r3.getEntry$okhttp()     // Catch:{ all -> 0x0067 }
                java.util.List r1 = r1.getDirtyFiles$okhttp()     // Catch:{ all -> 0x0067 }
                java.lang.Object r4 = r1.get(r4)     // Catch:{ all -> 0x0067 }
                java.io.File r4 = (java.io.File) r4     // Catch:{ all -> 0x0067 }
                okhttp3.internal.io.FileSystem r1 = r0.getFileSystem$okhttp()     // Catch:{ FileNotFoundException -> 0x0055 }
                okio.Sink r4 = r1.sink(r4)     // Catch:{ FileNotFoundException -> 0x0055 }
                okhttp3.internal.cache.FaultHidingSink r1 = new okhttp3.internal.cache.FaultHidingSink     // Catch:{ all -> 0x0067 }
                okhttp3.internal.cache.DiskLruCache$Editor$newSink$1$1 r2 = new okhttp3.internal.cache.DiskLruCache$Editor$newSink$1$1     // Catch:{ all -> 0x0067 }
                r2.<init>(r0, r3)     // Catch:{ all -> 0x0067 }
                kotlin.jvm.functions.Function1 r2 = (kotlin.jvm.functions.Function1) r2     // Catch:{ all -> 0x0067 }
                r1.<init>(r4, r2)     // Catch:{ all -> 0x0067 }
                okio.Sink r1 = (okio.Sink) r1     // Catch:{ all -> 0x0067 }
                monitor-exit(r0)
                return r1
            L_0x0055:
                okio.Sink r4 = okio.Okio.blackhole()     // Catch:{ all -> 0x0067 }
            ...
            L_0x005b:
                ...
                java.lang.IllegalStateException r1 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0067 }
