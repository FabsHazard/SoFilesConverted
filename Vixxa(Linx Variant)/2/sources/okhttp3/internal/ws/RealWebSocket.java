...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public synchronized void onReadPong(ByteString byteString) {
        Intrinsics.checkNotNullParameter(byteString, AssistPushConsts.MSG_TYPE_PAYLOAD);
    ...
    public void onReadClose(int r6, java.lang.String r7) {
        /*
            ...
            monitor-enter(r5)
            int r1 = r5.receivedCloseCode     // Catch:{ all -> 0x0087 }
            if (r1 != r0) goto L_0x007b
            r5.receivedCloseCode = r6     // Catch:{ all -> 0x0087 }
            r5.receivedCloseReason = r7     // Catch:{ all -> 0x0087 }
            boolean r0 = r5.enqueuedClose     // Catch:{ all -> 0x0087 }
            r1 = 0
            if (r0 == 0) goto L_0x0031
            java.util.ArrayDeque<java.lang.Object> r0 = r5.messageAndCloseQueue     // Catch:{ all -> 0x0087 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x0087 }
            if (r0 == 0) goto L_0x0031
            okhttp3.internal.ws.RealWebSocket$Streams r0 = r5.streams     // Catch:{ all -> 0x0087 }
            r5.streams = r1     // Catch:{ all -> 0x0087 }
            okhttp3.internal.ws.WebSocketReader r2 = r5.reader     // Catch:{ all -> 0x0087 }
            r5.reader = r1     // Catch:{ all -> 0x0087 }
            okhttp3.internal.ws.WebSocketWriter r3 = r5.writer     // Catch:{ all -> 0x0087 }
            r5.writer = r1     // Catch:{ all -> 0x0087 }
            okhttp3.internal.concurrent.TaskQueue r1 = r5.taskQueue     // Catch:{ all -> 0x0087 }
            r1.shutdown()     // Catch:{ all -> 0x0087 }
            r1 = r0
            goto L_0x0033
        L_0x0031:
            r2 = r1
        ...
        L_0x0033:
            ...
            monitor-exit(r5)
            okhttp3.WebSocketListener r0 = r5.listener     // Catch:{ all -> 0x0061 }
            r4 = r5
            okhttp3.WebSocket r4 = (okhttp3.WebSocket) r4     // Catch:{ all -> 0x0061 }
            r0.onClosing(r4, r6, r7)     // Catch:{ all -> 0x0061 }
            if (r1 == 0) goto L_0x0048
            okhttp3.WebSocketListener r0 = r5.listener     // Catch:{ all -> 0x0061 }
            r4 = r5
            okhttp3.WebSocket r4 = (okhttp3.WebSocket) r4     // Catch:{ all -> 0x0061 }
            r0.onClosed(r4, r6, r7)     // Catch:{ all -> 0x0061 }
        L_0x0048:
        ...
        L_0x007b:
            ...
            java.lang.IllegalStateException r7 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0087 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0087 }
            r7.<init>(r6)     // Catch:{ all -> 0x0087 }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized boolean close(int r6, java.lang.String r7, long r8) {
        /*
            r5 = this;
            monitor-enter(r5)
            okhttp3.internal.ws.WebSocketProtocol r0 = okhttp3.internal.ws.WebSocketProtocol.INSTANCE     // Catch:{ all -> 0x0049 }
            r0.validateCloseCode(r6)     // Catch:{ all -> 0x0049 }
            if (r7 == 0) goto L_0x002a
            okio.ByteString$Companion r0 = okio.ByteString.Companion     // Catch:{ all -> 0x0049 }
            okio.ByteString r0 = r0.encodeUtf8(r7)     // Catch:{ all -> 0x0049 }
            ...
            goto L_0x002b
        L_0x001a:
            java.lang.String r6 = "reason.size() > 123: "
            java.lang.String r6 = kotlin.jvm.internal.Intrinsics.stringPlus(r6, r7)     // Catch:{ all -> 0x0049 }
            java.lang.IllegalArgumentException r7 = new java.lang.IllegalArgumentException     // Catch:{ all -> 0x0049 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0049 }
            r7.<init>(r6)     // Catch:{ all -> 0x0049 }
            throw r7     // Catch:{ all -> 0x0049 }
        L_0x002a:
            r0 = 0
        L_0x002b:
            boolean r7 = r5.failed     // Catch:{ all -> 0x0049 }
            if (r7 != 0) goto L_0x0046
            boolean r7 = r5.enqueuedClose     // Catch:{ all -> 0x0049 }
            if (r7 == 0) goto L_0x0034
            goto L_0x0046
        L_0x0034:
            r7 = 1
            r5.enqueuedClose = r7     // Catch:{ all -> 0x0049 }
            java.util.ArrayDeque<java.lang.Object> r1 = r5.messageAndCloseQueue     // Catch:{ all -> 0x0049 }
            okhttp3.internal.ws.RealWebSocket$Close r2 = new okhttp3.internal.ws.RealWebSocket$Close     // Catch:{ all -> 0x0049 }
            r2.<init>(r6, r0, r8)     // Catch:{ all -> 0x0049 }
            r1.add(r2)     // Catch:{ all -> 0x0049 }
            r5.runWriter()     // Catch:{ all -> 0x0049 }
            monitor-exit(r5)
            return r7
        L_0x0046:
            monitor-exit(r5)
