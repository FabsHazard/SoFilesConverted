...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m1943deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    private static final class Entry {
        ...
        public Entry(okio.Source r9) throws java.io.IOException {
            /*
                ...
                r1 = r0
                okio.Source r1 = (okio.Source) r1     // Catch:{ all -> 0x0125 }
                okio.BufferedSource r9 = okio.Okio.buffer((okio.Source) r9)     // Catch:{ all -> 0x0125 }
                java.lang.String r1 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x0125 }
                okhttp3.HttpUrl$Companion r2 = okhttp3.HttpUrl.Companion     // Catch:{ all -> 0x0125 }
                okhttp3.HttpUrl r2 = r2.parse(r1)     // Catch:{ all -> 0x0125 }
                if (r2 == 0) goto L_0x0108
                r8.url = r2     // Catch:{ all -> 0x0125 }
                java.lang.String r1 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x0125 }
                r8.requestMethod = r1     // Catch:{ all -> 0x0125 }
                okhttp3.Headers$Builder r1 = new okhttp3.Headers$Builder     // Catch:{ all -> 0x0125 }
                r1.<init>()     // Catch:{ all -> 0x0125 }
                okhttp3.Cache$Companion r2 = okhttp3.Cache.Companion     // Catch:{ all -> 0x0125 }
                int r2 = r2.readInt$okhttp(r9)     // Catch:{ all -> 0x0125 }
                r3 = 0
                r4 = r3
            L_0x0033:
                if (r4 >= r2) goto L_0x003f
                int r4 = r4 + 1
                java.lang.String r5 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x0125 }
                r1.addLenient$okhttp(r5)     // Catch:{ all -> 0x0125 }
                goto L_0x0033
            L_0x003f:
                okhttp3.Headers r1 = r1.build()     // Catch:{ all -> 0x0125 }
                r8.varyHeaders = r1     // Catch:{ all -> 0x0125 }
                okhttp3.internal.http.StatusLine$Companion r1 = okhttp3.internal.http.StatusLine.Companion     // Catch:{ all -> 0x0125 }
                java.lang.String r2 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x0125 }
                okhttp3.internal.http.StatusLine r1 = r1.parse(r2)     // Catch:{ all -> 0x0125 }
                okhttp3.Protocol r2 = r1.protocol     // Catch:{ all -> 0x0125 }
                r8.protocol = r2     // Catch:{ all -> 0x0125 }
                int r2 = r1.code     // Catch:{ all -> 0x0125 }
                r8.code = r2     // Catch:{ all -> 0x0125 }
                java.lang.String r1 = r1.message     // Catch:{ all -> 0x0125 }
                r8.message = r1     // Catch:{ all -> 0x0125 }
                okhttp3.Headers$Builder r1 = new okhttp3.Headers$Builder     // Catch:{ all -> 0x0125 }
                r1.<init>()     // Catch:{ all -> 0x0125 }
                okhttp3.Cache$Companion r2 = okhttp3.Cache.Companion     // Catch:{ all -> 0x0125 }
                int r2 = r2.readInt$okhttp(r9)     // Catch:{ all -> 0x0125 }
            L_0x0066:
                ...
                int r3 = r3 + 1
                java.lang.String r4 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x0125 }
                r1.addLenient$okhttp(r4)     // Catch:{ all -> 0x0125 }
                goto L_0x0066
            L_0x0072:
                java.lang.String r2 = SENT_MILLIS     // Catch:{ all -> 0x0125 }
                java.lang.String r3 = r1.get(r2)     // Catch:{ all -> 0x0125 }
                java.lang.String r4 = RECEIVED_MILLIS     // Catch:{ all -> 0x0125 }
                java.lang.String r5 = r1.get(r4)     // Catch:{ all -> 0x0125 }
                r1.removeAll(r2)     // Catch:{ all -> 0x0125 }
                r1.removeAll(r4)     // Catch:{ all -> 0x0125 }
                r6 = 0
                if (r3 != 0) goto L_0x008a
                r2 = r6
                goto L_0x008e
            L_0x008a:
                long r2 = java.lang.Long.parseLong(r3)     // Catch:{ all -> 0x0125 }
            L_0x008e:
                r8.sentRequestMillis = r2     // Catch:{ all -> 0x0125 }
                if (r5 != 0) goto L_0x0093
                goto L_0x0097
            L_0x0093:
                long r6 = java.lang.Long.parseLong(r5)     // Catch:{ all -> 0x0125 }
            L_0x0097:
                r8.receivedResponseMillis = r6     // Catch:{ all -> 0x0125 }
                okhttp3.Headers r1 = r1.build()     // Catch:{ all -> 0x0125 }
                r8.responseHeaders = r1     // Catch:{ all -> 0x0125 }
                boolean r1 = r8.isHttps()     // Catch:{ all -> 0x0125 }
                r2 = 0
                if (r1 == 0) goto L_0x0100
                java.lang.String r1 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x0125 }
                r3 = r1
                java.lang.CharSequence r3 = (java.lang.CharSequence) r3     // Catch:{ all -> 0x0125 }
                int r3 = r3.length()     // Catch:{ all -> 0x0125 }
                if (r3 > 0) goto L_0x00e1
                java.lang.String r1 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x0125 }
                okhttp3.CipherSuite$Companion r3 = okhttp3.CipherSuite.Companion     // Catch:{ all -> 0x0125 }
                okhttp3.CipherSuite r1 = r3.forJavaName(r1)     // Catch:{ all -> 0x0125 }
                java.util.List r3 = r8.readCertificateList(r9)     // Catch:{ all -> 0x0125 }
                java.util.List r4 = r8.readCertificateList(r9)     // Catch:{ all -> 0x0125 }
                boolean r5 = r9.exhausted()     // Catch:{ all -> 0x0125 }
                if (r5 != 0) goto L_0x00d6
                okhttp3.TlsVersion$Companion r5 = okhttp3.TlsVersion.Companion     // Catch:{ all -> 0x0125 }
                java.lang.String r9 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x0125 }
                okhttp3.TlsVersion r9 = r5.forJavaName(r9)     // Catch:{ all -> 0x0125 }
                goto L_0x00d8
            L_0x00d6:
                okhttp3.TlsVersion r9 = okhttp3.TlsVersion.SSL_3_0     // Catch:{ all -> 0x0125 }
            L_0x00d8:
                okhttp3.Handshake$Companion r5 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x0125 }
                okhttp3.Handshake r9 = r5.get(r9, r1, r3, r4)     // Catch:{ all -> 0x0125 }
                r8.handshake = r9     // Catch:{ all -> 0x0125 }
                goto L_0x0102
            L_0x00e1:
                java.io.IOException r9 = new java.io.IOException     // Catch:{ all -> 0x0125 }
                ...
                java.lang.StringBuilder r1 = r2.append(r1)     // Catch:{ all -> 0x0125 }
                r2 = 34
                java.lang.StringBuilder r1 = r1.append(r2)     // Catch:{ all -> 0x0125 }
                java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x0125 }
                r9.<init>(r1)     // Catch:{ all -> 0x0125 }
                throw r9     // Catch:{ all -> 0x0125 }
            L_0x0100:
                r8.handshake = r2     // Catch:{ all -> 0x0125 }
            L_0x0102:
                kotlin.Unit r9 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0125 }
                kotlin.io.CloseableKt.closeFinally(r0, r2)
                return
            L_0x0108:
                java.io.IOException r9 = new java.io.IOException     // Catch:{ all -> 0x0125 }
                java.lang.String r2 = "Cache corruption for "
                java.lang.String r1 = kotlin.jvm.internal.Intrinsics.stringPlus(r2, r1)     // Catch:{ all -> 0x0125 }
                r9.<init>(r1)     // Catch:{ all -> 0x0125 }
                okhttp3.internal.platform.Platform$Companion r1 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0125 }
                okhttp3.internal.platform.Platform r1 = r1.get()     // Catch:{ all -> 0x0125 }
                java.lang.String r2 = "cache corruption"
                r3 = r9
                java.lang.Throwable r3 = (java.lang.Throwable) r3     // Catch:{ all -> 0x0125 }
                r4 = 5
                r1.log(r2, r4, r3)     // Catch:{ all -> 0x0125 }
                java.lang.Throwable r9 = (java.lang.Throwable) r9     // Catch:{ all -> 0x0125 }
                throw r9     // Catch:{ all -> 0x0125 }
            L_0x0125:
                r9 = move-exception
