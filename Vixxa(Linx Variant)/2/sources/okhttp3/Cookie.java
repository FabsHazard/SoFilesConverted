...
import com.microtech.aidexx.views.selector.time.LunarCalendar;
...
public final class Cookie {
    ...
    public final String m1966deprecated_name() {
        return this.name;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "value", imports = {}))
    /* renamed from: -deprecated_value  reason: not valid java name */
    public final String m1970deprecated_value() {
        return this.value;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "persistent", imports = {}))
    /* renamed from: -deprecated_persistent  reason: not valid java name */
    public final boolean m1968deprecated_persistent() {
        return this.persistent;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "expiresAt", imports = {}))
    /* renamed from: -deprecated_expiresAt  reason: not valid java name */
    public final long m1963deprecated_expiresAt() {
        return this.expiresAt;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "hostOnly", imports = {}))
    /* renamed from: -deprecated_hostOnly  reason: not valid java name */
    public final boolean m1964deprecated_hostOnly() {
        return this.hostOnly;
    }
    ...
    public final String m1962deprecated_domain() {
        return this.domain;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "path", imports = {}))
    /* renamed from: -deprecated_path  reason: not valid java name */
    public final String m1967deprecated_path() {
        return this.path;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "httpOnly", imports = {}))
    /* renamed from: -deprecated_httpOnly  reason: not valid java name */
    public final boolean m1965deprecated_httpOnly() {
        return this.httpOnly;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "secure", imports = {}))
    /* renamed from: -deprecated_secure  reason: not valid java name */
    public final boolean m1969deprecated_secure() {
        return this.secure;
    }
    ...
    public static final class Companion {
        ...
        public final boolean pathMatch(HttpUrl httpUrl, String str) {
            ...
            return StringsKt.startsWith$default(encodedPath, str, false, 2, (Object) null) && (StringsKt.endsWith$default(str, InternalZipConstants.ZIP_FILE_SEPARATOR, false, 2, (Object) null) || encodedPath.charAt(str.length()) == '/');
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x0100, code lost:
            if (r1 > okhttp3.internal.http.DatesKt.MAX_DATE) goto L_0x0108;
         */
        ...
        /* JADX WARNING: Removed duplicated region for block: B:69:0x0135 A[RETURN] */
        ...
        public final okhttp3.Cookie parse$okhttp(long r26, okhttp3.HttpUrl r28, java.lang.String r29) {
            ...
            L_0x0081:
                ...
                int r9 = r13.length()     // Catch:{ IllegalArgumentException -> 0x00d0 }
                long r23 = r0.parseExpires(r13, r3, r9)     // Catch:{ IllegalArgumentException -> 0x00d0 }
                goto L_0x009e
            L_0x0092:
            ...
            L_0x00a1:
                ...
                java.lang.String r10 = r0.parseDomain(r13)     // Catch:{ IllegalArgumentException -> 0x00d0 }
                r20 = r3
                goto L_0x00d0
            L_0x00b0:
        ...
        private final int dateCharacterOffset(String str, int i, int i2, boolean z) {
            while (i < i2) {
                ...
                if (((charAt < ' ' && charAt != 9) || charAt >= 127 || (charAt <= '9' && '0' <= charAt) || ((charAt <= 'z' && 'a' <= charAt) || ((charAt <= 'Z' && 'A' <= charAt) || charAt == ':'))) == (!z)) {
                    return i;
                }
                i = i3;
            }
