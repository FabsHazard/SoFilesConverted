...
final class BaseActivity$checkEnvironment$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Ref.BooleanRef $needBtPermission;
    final /* synthetic */ BaseActivity<VM, VB> this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BaseActivity$checkEnvironment$2(Ref.BooleanRef booleanRef, BaseActivity<VM, VB> baseActivity) {
        super(0);
    ...
    public final void invoke() {
        ...
        String string = baseActivity.getString(R.string.permission_location_title_ph, new Object[]{this.this$0.getString(R.string.app_name)});
        Intrinsics.checkNotNullExpressionValue(string, "getString(...)");
        String string2 = this.this$0.getString(R.string.permission_location_desc_real, new Object[]{this.this$0.getString(R.string.app_name)});
        ...
        EnquireManager.showEnquireOrNot$default(instance, baseActivity, string, string2, new Function0<Unit>() {
            public final void invoke() {
                PermissionsUtil.requestPermissions$default(PermissionsUtil.INSTANCE, baseActivity2, PermissionGroups.INSTANCE.getLocation(), (Function0) null, 4, (Object) null);
            }
