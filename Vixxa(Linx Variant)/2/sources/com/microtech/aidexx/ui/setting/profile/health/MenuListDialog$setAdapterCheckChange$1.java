...
final class MenuListDialog$setAdapterCheckChange$1 extends Lambda implements Function2<Integer, T, Boolean> {
    final /* synthetic */ MenuListDialog<T> this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MenuListDialog$setAdapterCheckChange$1(MenuListDialog<T> menuListDialog) {
        super(2);
    ...
    public final Boolean invoke(int i, T t) {
        ...
        if (t.isExclusive()) {
            ...
            MenuListDialog<T> menuListDialog2 = this.this$0;
            int i4 = 0;
            for (Object next2 : this.this$0.menuListAdapter.getData()) {
                int i5 = i4 + 1;
                if (i4 < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                MenuCheckItem menuCheckItem2 = (MenuCheckItem) next2;
                if (menuCheckItem2.isExclusive()) {
                    menuCheckItem2.setCheck(false);
                    menuListDialog2.menuListAdapter.notifyItemChanged(i4);
                }
                i4 = i5;
            }
        }
