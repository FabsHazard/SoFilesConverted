...
final class AlertSettingsActivity$initEvent$2$hyperSelectView$1 extends Lambda implements Function1<Float, Unit> {
    final /* synthetic */ AlertSettingsActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AlertSettingsActivity$initEvent$2$hyperSelectView$1(AlertSettingsActivity alertSettingsActivity) {
        super(1);
    ...
    public final void invoke(float f) {
        if (f != ThresholdManager.INSTANCE.getHyper()) {
            ...
            ((ActivitySettingsAlertBinding) this.this$0.getBinding()).hyperThreshold.setValue(GlucoseUtilKt.toGlucoseStringWithUnit(f));
