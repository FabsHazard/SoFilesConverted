...
@DebugMetadata(c = "com.microtech.aidexx.ui.setting.share.ShareAndFollowEditActivity$onClick$1", f = "ShareAndFollowEditActivity.kt", i = {}, l = {146, 149}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: ShareAndFollowEditActivity.kt */
final class ShareAndFollowEditActivity$onClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ String $alias;
    int label;
    final /* synthetic */ ShareAndFollowEditActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ShareAndFollowEditActivity$onClick$1(ShareAndFollowEditActivity shareAndFollowEditActivity, String str, Continuation<? super ShareAndFollowEditActivity$onClick$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ShareAndFollowEditActivity$onClick$1(this.this$0, this.$alias, continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ShareAndFollowEditActivity$onClick$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = access$getSfViewModel.modifyShareUser(str, userAuthorizationId, this);
