...
public final class BaseEventViewModel$loadHistory$2$invokeSuspend$$inlined$sortedByDescending$1<T> implements Comparator {
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(((BaseEventDetail) t2).getCreateTime(), ((BaseEventDetail) t).getCreateTime());
    }
}
