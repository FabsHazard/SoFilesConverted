...
public final class MedicineViewModel$getDetailHistory$$inlined$queryHistory$1<V> implements Callable {
    final /* synthetic */ long $limit;
    final /* synthetic */ Property $timestampProperty;

    public MedicineViewModel$getDetailHistory$$inlined$queryHistory$1(long j, Property property) {
        this.$limit = j;
        this.$timestampProperty = property;
    }

    public final List<MedicationEntity> call() {
        Property<MedicationEntity> deleteStatusProperty = EventDao.INSTANCE.getDeleteStatusProperty(MedicationEntity.class);
        if (deleteStatusProperty == null) {
            return null;
        }
        long j = this.$limit;
        Property property = this.$timestampProperty;
        Box<MedicationEntity> boxFor = ObjectBox.INSTANCE.getStore().boxFor(MedicationEntity.class);
        Intrinsics.checkNotNullExpressionValue(boxFor, "boxFor(...)");
        QueryBuilder<MedicationEntity> query = boxFor.query();
