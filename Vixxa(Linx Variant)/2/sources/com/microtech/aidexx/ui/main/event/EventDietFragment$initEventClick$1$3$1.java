...
final class EventDietFragment$initEventClick$1$3$1 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ FragmentEventDietBinding $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EventDietFragment$initEventClick$1$3$1(FragmentEventDietBinding fragmentEventDietBinding) {
        super(1);
    ...
    public final void invoke(String str) {
        ...
        this.$this_apply.tvDietTime.setText(str);
    }
}
