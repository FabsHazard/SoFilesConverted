...
final class EventOthersFragment$initEventClick$1$1$1 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ FragmentEventOthersBinding $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EventOthersFragment$initEventClick$1$1$1(FragmentEventOthersBinding fragmentEventOthersBinding) {
        super(1);
    ...
    public final void invoke(boolean z) {
        if (z) {
            this.$this_apply.etOthersContent.setText("");
        }
    }
}
