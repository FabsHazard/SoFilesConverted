...
final class SportPresetDialog$intDeleteUI$1$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ SportPresetDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SportPresetDialog$intDeleteUI$1$1(SportPresetDialog sportPresetDialog) {
        super(0);
