...
public final class DietViewModel$getDetailHistory$$inlined$queryHistory$1<V> implements Callable {
    final /* synthetic */ long $limit;
    final /* synthetic */ Property $timestampProperty;

    public DietViewModel$getDetailHistory$$inlined$queryHistory$1(long j, Property property) {
        this.$limit = j;
        this.$timestampProperty = property;
    }

    public final List<DietEntity> call() {
        Property<DietEntity> deleteStatusProperty = EventDao.INSTANCE.getDeleteStatusProperty(DietEntity.class);
        ...
        QueryBuilder<DietEntity> query = boxFor.query();
