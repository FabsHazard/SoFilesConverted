...
final class HomeFragment$MainHandler$handleMessage$1$5 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MainActivity $it;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HomeFragment$MainHandler$handleMessage$1$5(MainActivity mainActivity) {
        super(0);
