...
final class HistoryFragment$onCreateView$1 extends Lambda implements Function1<BaseEventEntity, Unit> {
    final /* synthetic */ HistoryFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HistoryFragment$onCreateView$1(HistoryFragment historyFragment) {
        super(1);
    ...
    public final void invoke(BaseEventEntity baseEventEntity) {
        ...
        this.this$0.toJumpDate = new Date(baseEventEntity.convertToCurZoneTs());
    }
}
