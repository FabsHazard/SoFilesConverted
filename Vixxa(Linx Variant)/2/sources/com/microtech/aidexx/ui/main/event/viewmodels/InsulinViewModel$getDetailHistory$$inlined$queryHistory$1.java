...
public final class InsulinViewModel$getDetailHistory$$inlined$queryHistory$1<V> implements Callable {
    final /* synthetic */ long $limit;
    final /* synthetic */ Property $timestampProperty;

    public InsulinViewModel$getDetailHistory$$inlined$queryHistory$1(long j, Property property) {
        this.$limit = j;
        this.$timestampProperty = property;
    }

    public final List<InsulinEntity> call() {
        Property<InsulinEntity> deleteStatusProperty = EventDao.INSTANCE.getDeleteStatusProperty(InsulinEntity.class);
        ...
        QueryBuilder<InsulinEntity> query = boxFor.query();
