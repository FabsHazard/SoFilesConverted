...
public final class EventHistoryChartViewHolder$1$1 implements GlucoseChart.ExtraParams {
    ...
    EventHistoryChartViewHolder$1$1(EventHistoryChartViewHolder eventHistoryChartViewHolder) {
    ...
    public float xMax() {
        return this.this$0.getVm().xMax();
    }

    public float xMin() {
        return this.this$0.getVm().xMin();
    }

    public float xRange() {
        return this.this$0.getVm().xRange();
    }

    public float xMargin() {
        return this.this$0.getVm().xMargin();
    }

    public float lowerLimit() {
        return this.this$0.getVm().getLowerLimit();
    }

    public float upperLimit() {
        return this.this$0.getVm().getUpperLimit();
    }
