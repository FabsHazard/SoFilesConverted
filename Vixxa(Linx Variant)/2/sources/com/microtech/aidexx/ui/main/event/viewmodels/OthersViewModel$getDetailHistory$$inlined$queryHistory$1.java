...
public final class OthersViewModel$getDetailHistory$$inlined$queryHistory$1<V> implements Callable {
    final /* synthetic */ long $limit;
    final /* synthetic */ Property $timestampProperty;

    public OthersViewModel$getDetailHistory$$inlined$queryHistory$1(long j, Property property) {
        this.$limit = j;
        this.$timestampProperty = property;
    }

    public final List<OthersEntity> call() {
        Property<OthersEntity> deleteStatusProperty = EventDao.INSTANCE.getDeleteStatusProperty(OthersEntity.class);
        ...
        QueryBuilder<OthersEntity> query = boxFor.query();
