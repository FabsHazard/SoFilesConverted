...
public class MultiChart extends CombinedChart {
    ...
    private YAxis.AxisDependency majorAxis = YAxis.AxisDependency.LEFT;
    ...
    public MultiChart(Context context) {
        super(context);
    }

    public MultiChart(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public MultiChart(Context context, AttributeSet attributeSet, int i) {
    ...
    public Bitmap getChartBitmap() {
        ...
        if (bitmap2 == null) {
            bitmap2 = Bitmap.createBitmap(getWidth(), getHeight(), Bitmap.Config.ARGB_4444);
        }
        this.bitmap = bitmap2;
    ...
    @Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0007\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\n\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0007\u001a\u00020\b2\b\u0010\t\u001a\u0004\u0018\u00010\nH\u0016J,\u0010\u000b\u001a\u00020\b2\b\u0010\f\u001a\u0004\u0018\u00010\n2\b\u0010\r\u001a\u0004\u0018\u00010\n2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u000fH\u0016J\u001c\u0010\u0011\u001a\u00020\b2\b\u0010\t\u001a\u0004\u0018\u00010\n2\b\u0010\u0012\u001a\u0004\u0018\u00010\u0013H\u0016J\u001c\u0010\u0014\u001a\u00020\b2\b\u0010\t\u001a\u0004\u0018\u00010\n2\b\u0010\u0012\u001a\u0004\u0018\u00010\u0013H\u0016J\u0010\u0010\u0015\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016J\"\u0010\u0016\u001a\u00020\b2\b\u0010\t\u001a\u0004\u0018\u00010\n2\u0006\u0010\u0017\u001a\u00020\u000f2\u0006\u0010\u0018\u001a\u00020\u000fH\u0016J\u0012\u0010\u0019\u001a\u00020\b2\b\u0010\t\u001a\u0004\u0018\u00010\nH\u0016J\"\u0010\u001a\u001a\u00020\b2\b\u0010\t\u001a\u0004\u0018\u00010\n2\u0006\u0010\u001b\u001a\u00020\u000f2\u0006\u0010\u001c\u001a\u00020\u000fH\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000¨\u0006\u001d"}, d2 = {"Lcom/microtech/aidexx/ui/main/trend/view/MultiChart$MyOnChartGestureListener;", "Lcom/github/mikephil/charting/listener/OnChartGestureListener;", "(Lcom/microtech/aidexx/ui/main/trend/view/MultiChart;)V", "chart", "Lcom/microtech/aidexx/ui/main/trend/view/MultiChart;", "highlightAllowed", "", "onChartDoubleTapped", "", "me", "Landroid/view/MotionEvent;", "onChartFling", "me1", "me2", "velocityX", "", "velocityY", "onChartGestureEnd", "lastPerformedGesture", "Lcom/github/mikephil/charting/listener/ChartTouchListener$ChartGesture;", "onChartGestureStart", "onChartLongPressed", "onChartScale", "scaleX", "scaleY", "onChartSingleTapped", "onChartTranslate", "dX", "dY", "app_gpGrxMmolRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* compiled from: MultiChart.kt */
    public final class MyOnChartGestureListener implements OnChartGestureListener {
        private final MultiChart chart;
        ...
        public void onChartLongPressed(MotionEvent motionEvent) {
            ...
            if (MultiChart.this.getHighlightOnLongPressedEnable()) {
                if (this.highlightAllowed) {
                    MultiChart.this.setSelectAllow(true);
                    Function1<Float, Unit> onSelectX = MultiChart.this.getOnSelectX();
                    if (onSelectX != null) {
                        onSelectX.invoke(Float.valueOf((float) MultiChart.this.getValuesByTouchPoint(motionEvent.getX(), motionEvent.getY(), MultiChart.this.getMajorAxis()).x));
                    }
