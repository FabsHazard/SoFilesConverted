...
final class EventMedicineFragment$initEventClick$1$1$1 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ FragmentEventMedicineBinding $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EventMedicineFragment$initEventClick$1$1$1(FragmentEventMedicineBinding fragmentEventMedicineBinding) {
        super(1);
    ...
    public final void invoke(boolean z) {
        if (z) {
            this.$this_apply.etMedicineName.setText("");
        }
    }
}
