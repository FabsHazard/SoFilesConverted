...
final class BaseEventFragment$initToSaveList$2$2 extends Lambda implements Function1<BaseEventDetail, Unit> {
    final /* synthetic */ int $position;
    final /* synthetic */ BaseEventFragment<VM, VB> this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BaseEventFragment$initToSaveList$2$2(BaseEventFragment<VM, VB> baseEventFragment, int i) {
        super(1);
    ...
    public final void invoke(BaseEventDetail baseEventDetail) {
        this.this$0.getViewModel().removeSaveDetailList(this.$position);
        this.this$0.getToSaveDetailAdapter().getData().remove(this.$position);
        this.this$0.getToSaveDetailAdapter().notifyItemRemoved(this.$position);
    }
}
