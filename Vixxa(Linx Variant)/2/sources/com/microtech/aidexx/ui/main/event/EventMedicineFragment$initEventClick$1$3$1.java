...
final class EventMedicineFragment$initEventClick$1$3$1 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ FragmentEventMedicineBinding $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EventMedicineFragment$initEventClick$1$3$1(FragmentEventMedicineBinding fragmentEventMedicineBinding) {
        super(1);
    ...
    public final void invoke(String str) {
        ...
        this.$this_apply.tvMedicineTime.setText(str);
    }
}
