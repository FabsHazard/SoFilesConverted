...
public final class ChartViewHolder$1$5 implements GlucoseChart.ExtraParams {
    ...
    ChartViewHolder$1$5(FragmentHomeBinding fragmentHomeBinding, ChartViewHolder chartViewHolder) {
        ...
        this.rlDescription = chartViewHolder.vb.rlDescription;
        this.outerDescriptionU = fragmentHomeBinding.descriptionTvContent;
        this.goToHistory = chartViewHolder.vb.goToHistory;
        this.onGoToHistory = new ChartViewHolder$1$5$onGoToHistory$1(chartViewHolder);
        this.curDateTv = fragmentHomeBinding.tvXTime;
        this.onChartEvent = new ChartViewHolder$1$5$onChartEvent$1(chartViewHolder, fragmentHomeBinding);
    }
