...
final class MedicinePresetDialog$intDeleteUI$1$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MedicinePresetDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MedicinePresetDialog$intDeleteUI$1$1(MedicinePresetDialog medicinePresetDialog) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (access$getOnDeleteClick$p != null) {
            access$getOnDeleteClick$p.invoke(null);
        }
    }
}
