...
public final class InsulinViewModel extends BaseEventViewModel<InsulinEntity, InsulinDetail, InsulinPresetEntity> {
    ...
    public Object queryPresetByName(String str, Continuation<? super List<? extends InsulinPresetEntity>> continuation) {
        return EventDbRepository.queryInsulinPresetByName$default(EventDbRepository.INSTANCE, str, (String) null, (String) null, (String) null, continuation, 14, (Object) null);
    }
    ...
    public java.lang.Object getDetailHistory(kotlin.coroutines.Continuation<? super java.util.List<com.microtech.aidexx.db.entity.event.InsulinDetail>> r8) {
        /*
            r7 = this;
            boolean r0 = r8 instanceof com.microtech.aidexx.ui.main.event.viewmodels.InsulinViewModel$getDetailHistory$1
        ...
        L_0x0032:
            ...
            io.objectbox.Property<com.microtech.aidexx.db.entity.event.InsulinEntity> r8 = com.microtech.aidexx.db.entity.event.InsulinEntity_.timestamp
            ...
            com.microtech.aidexx.ui.main.event.viewmodels.InsulinViewModel$getDetailHistory$$inlined$queryHistory$1 r4 = new com.microtech.aidexx.ui.main.event.viewmodels.InsulinViewModel$getDetailHistory$$inlined$queryHistory$1
            r5 = 15
            r4.<init>(r5, r8)
        ...
        L_0x0069:
            ...
            com.microtech.aidexx.db.entity.event.InsulinEntity r1 = (com.microtech.aidexx.db.entity.event.InsulinEntity) r1
    ...
    public Object genEventEntityWhenSave(Continuation<? super InsulinEntity> continuation) {
        ...
        Iterable<InsulinDetail> toSaveDetailList = getToSaveDetailList();
        Collection arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(toSaveDetailList, 10));
        for (InsulinDetail insulinDetail : toSaveDetailList) {
            insulinDetail.setUnitStr("U");
            insulinDetail.setInsulinId(insulinEntity.getInsulinId());
            arrayList.add(insulinDetail);
        }
        ...
        insulinEntity.setUserId(UserInfoManager.Companion.instance().userId());
        insulinEntity.setInsulinDosage(Boxing.boxFloat((float) ((InsulinDetail) CollectionsKt.last(getToSaveDetailList())).getQuantity()));
        insulinEntity.setInsulinName(((InsulinDetail) CollectionsKt.last(getToSaveDetailList())).getName());
