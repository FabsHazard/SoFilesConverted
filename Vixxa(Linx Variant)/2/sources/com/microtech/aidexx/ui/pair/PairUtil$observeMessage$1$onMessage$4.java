...
final class PairUtil$observeMessage$1$onMessage$4 extends Lambda implements Function0<Unit> {
    final /* synthetic */ TransmitterManager $instance;
    final /* synthetic */ DeviceModel $model;
    final /* synthetic */ CoroutineScope $scope;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PairUtil$observeMessage$1$onMessage$4(CoroutineScope coroutineScope, TransmitterManager transmitterManager, DeviceModel deviceModel) {
        super(0);
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(transmitterManager, deviceModel, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                transmitterManager.set(deviceModel);
    ...
    public final void invoke() {
        ...
        final TransmitterManager transmitterManager = this.$instance;
