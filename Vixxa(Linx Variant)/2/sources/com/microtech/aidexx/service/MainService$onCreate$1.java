...
final class MainService$onCreate$1 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ MainService this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MainService$onCreate$1(MainService mainService) {
        super(1);
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(mainService, z, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                LocalNotificationManager.INSTANCE.updateNotification(mainService, z);
