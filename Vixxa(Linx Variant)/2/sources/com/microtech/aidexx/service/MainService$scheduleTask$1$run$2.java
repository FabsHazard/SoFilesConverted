...
@DebugMetadata(c = "com.microtech.aidexx.service.MainService$scheduleTask$1$run$2", f = "MainService.kt", i = {}, l = {157, 158, 159, 160}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: MainService.kt */
final class MainService$scheduleTask$1$run$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;

    MainService$scheduleTask$1$run$2(Continuation<? super MainService$scheduleTask$1$run$2> continuation) {
        super(2, continuation);
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MainService$scheduleTask$1$run$2(continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MainService$scheduleTask$1$run$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r7) {
        ...
        L_0x006c:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.microtech.aidexx.service.MainService$scheduleTask$1$run$2.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
