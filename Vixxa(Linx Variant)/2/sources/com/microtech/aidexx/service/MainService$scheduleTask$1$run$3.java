...
@DebugMetadata(c = "com.microtech.aidexx.service.MainService$scheduleTask$1$run$3", f = "MainService.kt", i = {}, l = {164, 166}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: MainService.kt */
final class MainService$scheduleTask$1$run$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;

    MainService$scheduleTask$1$run$3(Continuation<? super MainService$scheduleTask$1$run$3> continuation) {
        super(2, continuation);
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MainService$scheduleTask$1$run$3(continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MainService$scheduleTask$1$run$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
