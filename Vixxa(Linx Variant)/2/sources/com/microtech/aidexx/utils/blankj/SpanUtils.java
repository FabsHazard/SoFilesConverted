...
public final class SpanUtils {
    ...
    public SpanUtils setFontSize(int i, boolean z) {
        if (z) {
            this.fontSize = (int) ((((float) i) * Resources.getSystem().getDisplayMetrics().scaledDensity) + 0.5f);
        } else {
            this.fontSize = i;
        }
        return this;
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(Bitmap bitmap, int i) {
            super(i);
            BitmapDrawable bitmapDrawable = new BitmapDrawable(ExtendsKt.getContext().getResources(), bitmap);
        ...
        public Drawable getDrawable() {
            ...
            if (this.mContentUri != null) {
                try {
                    InputStream openInputStream = ExtendsKt.getContext().getContentResolver().openInputStream(this.mContentUri);
                    BitmapDrawable bitmapDrawable2 = new BitmapDrawable(ExtendsKt.getContext().getResources(), BitmapFactory.decodeStream(openInputStream));
                    try {
                ...
                try {
                    drawable = ContextCompat.getDrawable(ExtendsKt.getContext(), this.mResourceId);
                    try {
