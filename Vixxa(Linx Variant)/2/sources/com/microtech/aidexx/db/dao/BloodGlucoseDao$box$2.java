...
final class BloodGlucoseDao$box$2 extends Lambda implements Function0<Box<BloodGlucoseEntity>> {
    public static final BloodGlucoseDao$box$2 INSTANCE = new BloodGlucoseDao$box$2();

    BloodGlucoseDao$box$2() {
        super(0);
    }
