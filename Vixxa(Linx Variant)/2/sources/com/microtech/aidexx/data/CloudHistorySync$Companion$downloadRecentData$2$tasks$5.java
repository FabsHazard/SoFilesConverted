...
@DebugMetadata(c = "com.microtech.aidexx.data.CloudHistorySync$Companion$downloadRecentData$2$tasks$5", f = "CloudHistorySync.kt", i = {0, 0, 0, 0}, l = {305}, m = "invokeSuspend", n = {"loginStateKey$iv", "taskItemListKey$iv", "startAutoIncrementColumn$iv", "endAutoIncrementColumn$iv"}, s = {"L$0", "L$1", "L$2", "L$3"})
/* compiled from: CloudHistorySync.kt */
final class CloudHistorySync$Companion$downloadRecentData$2$tasks$5 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CloudHistorySync$Companion$downloadRecentData$2$tasks$5(String str, Ref.BooleanRef booleanRef, Continuation<? super CloudHistorySync$Companion$downloadRecentData$2$tasks$5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CloudHistorySync$Companion$downloadRecentData$2$tasks$5(this.$userId, this.$isSuccess, continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CloudHistorySync$Companion$downloadRecentData$2$tasks$5) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Class<CalibrateEntity> cls = CalibrateEntity.class;
            ...
            z = true;
            this.label = 1;
            obj2 = BuildersKt.withContext(Dispatchers.getIO(), new CloudHistorySync$Companion$downloadRecentData$2$tasks$5$invokeSuspend$$inlined$getRecentData$default$1(loginStateKey, objectRef3, str3, loginMaxIdKey, 5000, 500, objectRef4, cls, (Continuation) null), this);
