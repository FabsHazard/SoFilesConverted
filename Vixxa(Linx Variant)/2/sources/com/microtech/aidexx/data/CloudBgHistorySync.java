...
@Metadata(d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\r\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0002\bÆ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003JO\u0010\u0012\u001a\u0010\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u0014\u0018\u00010\u00132.\u0010\u0015\u001a*\u0012\u0004\u0012\u00020\u0017\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00180\u0016j\u0014\u0012\u0004\u0012\u00020\u0017\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u0018`\u0019H@ø\u0001\u0000¢\u0006\u0002\u0010\u001aJA\u0010\u001b\u001a\u00020\u001c2\f\u0010\u001d\u001a\b\u0012\u0004\u0012\u00020\u00020\u00182\u000e\u0010\u001e\u001a\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u00142\u0006\u0010\u001f\u001a\u00020 2\b\u0010\u0010\u001a\u0004\u0018\u00010\u0017H@ø\u0001\u0000¢\u0006\u0002\u0010!R\u001a\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00020\u00058VX\u0004¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00020\u00058VX\u0004¢\u0006\u0006\u001a\u0004\b\t\u0010\u0007R\u001a\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00020\u00058VX\u0004¢\u0006\u0006\u001a\u0004\b\u000b\u0010\u0007R\u001a\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u00020\u00058VX\u0004¢\u0006\u0006\u001a\u0004\b\r\u0010\u0007R\u001a\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00020\u00058VX\u0004¢\u0006\u0006\u001a\u0004\b\u000f\u0010\u0007R\u001a\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u00020\u00058VX\u0004¢\u0006\u0006\u001a\u0004\b\u0011\u0010\u0007\u0002\u0004\n\u0002\b\u0019¨\u0006\""}, d2 = {"Lcom/microtech/aidexx/data/CloudBgHistorySync;", "Lcom/microtech/aidexx/data/CloudHistorySync;", "Lcom/microtech/aidexx/db/entity/BloodGlucoseEntity;", "()V", "deleteStatus", "Lio/objectbox/Property;", "getDeleteStatus", "()Lio/objectbox/Property;", "frontRecordId", "getFrontRecordId", "id", "getId", "idx", "getIdx", "uploadState", "getUploadState", "userId", "getUserId", "postLocalData", "Lcom/microtech/aidexx/common/net/entity/BaseResponse;", "", "map", "Ljava/util/HashMap;", "", "", "Lkotlin/collections/HashMap;", "(Ljava/util/HashMap;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "replaceEventData", "", "origin", "responseList", "type", "", "(Ljava/util/List;Ljava/util/List;ILjava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "app_gpGrxMmolRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* compiled from: CloudBgHistorySync.kt */
public final class CloudBgHistorySync extends CloudHistorySync<BloodGlucoseEntity> {
    public static final CloudBgHistorySync INSTANCE = new CloudBgHistorySync();

    private CloudBgHistorySync() {
    }

    public Property<BloodGlucoseEntity> getIdx() {
        Property<BloodGlucoseEntity> property = BloodGlucoseEntity_.idx;
        Intrinsics.checkNotNullExpressionValue(property, "idx");
        return property;
    }

    public Property<BloodGlucoseEntity> getId() {
        Property<BloodGlucoseEntity> property = BloodGlucoseEntity_.id;
        Intrinsics.checkNotNullExpressionValue(property, "id");
        return property;
    }

    public Property<BloodGlucoseEntity> getFrontRecordId() {
        Property<BloodGlucoseEntity> property = BloodGlucoseEntity_.bloodGlucoseId;
        Intrinsics.checkNotNullExpressionValue(property, "bloodGlucoseId");
        return property;
    }

    public Property<BloodGlucoseEntity> getUserId() {
        Property<BloodGlucoseEntity> property = BloodGlucoseEntity_.userId;
        Intrinsics.checkNotNullExpressionValue(property, "userId");
        return property;
    }

    public Property<BloodGlucoseEntity> getDeleteStatus() {
    ...
    public Property<BloodGlucoseEntity> getUploadState() {
        Property<BloodGlucoseEntity> property = BloodGlucoseEntity_.uploadState;
    ...
    public java.lang.Object postLocalData(java.util.HashMap<java.lang.String, java.util.List<com.microtech.aidexx.db.entity.BloodGlucoseEntity>> r6, kotlin.coroutines.Continuation<? super com.microtech.aidexx.common.net.entity.BaseResponse<java.util.List<com.microtech.aidexx.db.entity.BloodGlucoseEntity>>> r7) {
        /*
            r5 = this;
            boolean r0 = r7 instanceof com.microtech.aidexx.data.CloudBgHistorySync$postLocalData$1
            if (r0 == 0) goto L_0x0014
            r0 = r7
            com.microtech.aidexx.data.CloudBgHistorySync$postLocalData$1 r0 = (com.microtech.aidexx.data.CloudBgHistorySync$postLocalData$1) r0
            int r1 = r0.label
            ...
            goto L_0x0019
        L_0x0014:
            com.microtech.aidexx.data.CloudBgHistorySync$postLocalData$1 r0 = new com.microtech.aidexx.data.CloudBgHistorySync$postLocalData$1
            r0.<init>(r5, r7)
        L_0x0019:
            ...
            com.microtech.aidexx.data.CloudBgHistorySync r6 = (com.microtech.aidexx.data.CloudBgHistorySync) r6
        ...
        L_0x0045:
            ...
            r0.L$0 = r5
            r0.label = r4
            java.lang.Object r7 = r7.postBgHistory(r6, r0)
        ...
        L_0x0073:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.microtech.aidexx.data.CloudBgHistorySync.postLocalData(java.util.HashMap, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public Object replaceEventData(List<BloodGlucoseEntity> list, List<BloodGlucoseEntity> list2, int i, String str, Continuation<? super Unit> continuation) {
        if (list2 != null && !list2.isEmpty() && list.size() == list2.size()) {
            ...
            INSTANCE.getEntityBox().put(list);
        }
