...
public final class CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
    ...
    public CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1(String str, Ref.ObjectRef objectRef, String str2, String str3, int i, int i2, Ref.ObjectRef objectRef2, Class cls, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1 cloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1 = new CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1(this.$loginStateKey, this.$startAutoIncrementColumn, this.$userId, this.$loginMaxIdKey, this.$count, this.$pageSize, this.$endAutoIncrementColumn, this.$clazz, continuation);
        cloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1.L$0 = obj;
        return cloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
        return ((CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r26) {
        ...
        L_0x0086:
            ...
            java.lang.Class<com.microtech.aidexx.db.entity.event.OthersEntity> r6 = com.microtech.aidexx.db.entity.event.OthersEntity.class
        ...
        L_0x00ba:
            ...
            com.microtech.aidexx.data.CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1$1 r9 = new com.microtech.aidexx.data.CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1$1
            r9.<init>(r4, r3, r2)
        ...
        L_0x013a:
            r0.element = r2
            com.microtech.aidexx.data.CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1$2 r0 = new com.microtech.aidexx.data.CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1$2
        ...
        L_0x036d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.microtech.aidexx.data.CloudHistorySync$Companion$downloadRecentData$2$tasks$10$invokeSuspend$$inlined$getRecentData$default$1.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
