...
import com.microtech.aidexx.views.selector.base.OnOptionsSelectChangeListener;
...
public class WheelOptions<T> {
    ...
    /* access modifiers changed from: private */
    public final WheelView wv_option1;
    /* access modifiers changed from: private */
    public final WheelView wv_option2;
    /* access modifiers changed from: private */
    public final WheelView wv_option3;
    ...
    public void setPicker(List<T> list, List<List<T>> list2, List<List<List<T>>> list3) {
        ...
        if (this.mOptions3Items != null) {
            this.wv_option3.setAdapter(new ArrayWheelAdapter((List) this.mOptions3Items.get(0).get(0)));
        }
    ...
    public int[] getCurrentItems() {
        ...
        if (list2 == null || list2.size() <= 0) {
            ...
            if (this.wv_option3.getCurrentItem() <= ((List) this.mOptions3Items.get(iArr[0]).get(iArr[1])).size() - 1) {
    ...
    private void itemSelected(int i, int i2, int i3) {
        ...
        if (this.mOptions3Items != null) {
            this.wv_option3.setAdapter(new ArrayWheelAdapter((List) this.mOptions3Items.get(i).get(i2)));
            this.wv_option3.setCurrentItem(i3);
        }
    }
