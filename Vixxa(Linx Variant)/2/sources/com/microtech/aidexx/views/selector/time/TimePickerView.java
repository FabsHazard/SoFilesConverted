...
import com.microtech.aidexx.views.selector.base.BasePickerView;
import com.microtech.aidexx.views.selector.base.PickerOptions;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (this.mPickerOptions.customListener == null) {
            ...
            button.setText(TextUtils.isEmpty(this.mPickerOptions.textContentConfirm) ? context.getResources().getString(R.string.com_action_sure) : this.mPickerOptions.textContentConfirm);
            button2.setText(TextUtils.isEmpty(this.mPickerOptions.textContentCancel) ? context.getResources().getString(R.string.com_action_cancel) : this.mPickerOptions.textContentCancel);
    ...
    private void initWheelTime(LinearLayout linearLayout) {
        ...
        if (this.mPickerOptions.timeSelectChangeListener != null) {
            this.wheelTime.setSelectChangeCallback(new TimePickerView$$ExternalSyntheticLambda0(this));
        }
    ...
    /* renamed from: lambda$initWheelTime$0$com-microtech-aidexx-views-selector-time-TimePickerView  reason: not valid java name */
    public /* synthetic */ void m296lambda$initWheelTime$0$commicrotechaidexxviewsselectortimeTimePickerView() {
        try {
            this.mPickerOptions.timeSelectChangeListener.onTimeSelectChanged(WheelTime.dateFormat.parse(this.wheelTime.getTime()));
    ...
    public void returnData() {
        if (this.mPickerOptions.timeSelectListener != null) {
            try {
                WheelTime.dateFormat.setTimeZone(TimeZone.getDefault());
    ...
    public void setLunarCalendar(boolean z) {
        try {
            Calendar instance = Calendar.getInstance();
            instance.setTime((Date) Objects.requireNonNull(WheelTime.dateFormat.parse(this.wheelTime.getTime())));
