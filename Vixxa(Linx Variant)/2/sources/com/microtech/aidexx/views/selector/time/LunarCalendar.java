...
public class LunarCalendar {
    ...
    public static final int[] lunarToSolar(int i, int i2, int i3, boolean z) {
        ...
        for (int i9 = 1; i9 < i2; i9++) {
            i4 = ((524288 >> (i9 + -1)) & LUNAR_INFO[i5]) == 0 ? i4 + 29 : i4 + 30;
        }
        int i10 = i4 + i3;
        int i11 = LUNAR_INFO[i5];
        int i12 = (15728640 & i11) >> 20;
        if (i12 != 0 && (i2 > i12 || (i2 == i12 && z))) {
            i10 = ((524288 >> (i2 - 1)) & i11) == 0 ? i10 + 29 : i10 + 30;
        }
    ...
    public static final int[] solarToLunar(int i, int i2, int i3) {
        ...
        int i6 = iArr2[i5];
        int bitInt = getBitInt(i6, 12, 9);
        int bitInt2 = getBitInt(i6, 4, 5);
        int bitInt3 = getBitInt(i6, 5, 0);
        int i7 = lunar_month_days[i5];
        int bitInt4 = getBitInt(i7, 4, 13);
        int i8 = i5 + iArr2[0];
        long solarToInt = (solarToInt(i, i2, i3) - solarToInt(bitInt, bitInt2, bitInt3)) + 1;
        int i9 = 1;
        for (int i10 = 0; i10 < 13; i10++) {
            long j = (long) (getBitInt(i7, 1, 12 - i10) == 1 ? 30 : 29);
            if (solarToInt <= j) {
                break;
            }
            i9++;
        ...
        int i11 = (int) solarToInt;
        iArr[0] = i8;
        iArr[1] = i9;
        if (bitInt4 != 0 && i9 > bitInt4) {
            iArr[1] = i9 - 1;
            if (i9 == bitInt4 + 1) {
                i4 = 1;
            }
    ...
    public static final int[] solarToLunarDeprecated(int i, int i2, int i3) {
        int i4 = MIN_YEAR;
        int i5 = 0;
        int time = (int) ((new GregorianCalendar(i, i2 - 1, i3).getTime().getTime() - new GregorianCalendar(MIN_YEAR, 0, 31).getTime().getTime()) / TimeUtils.oneDayMillis);
        int i6 = 0;
