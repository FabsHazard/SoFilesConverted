...
public class SwipeDeleteMenuLayout extends ViewGroup {
    private static final String TAG = "zxt/SwipeMenuLayout";
    private static boolean isTouching;
    private static SwipeDeleteMenuLayout mViewCache;
    ...
    public SwipeDeleteMenuLayout(Context context) {
        this(context, (AttributeSet) null);
    }

    public SwipeDeleteMenuLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public SwipeDeleteMenuLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    public SwipeDeleteMenuLayout setIos(boolean z) {
        this.isIos = z;
        return this;
    }
    ...
    public SwipeDeleteMenuLayout setLeftSwipe(boolean z) {
        this.isLeftSwipe = z;
        return this;
    }

    public static SwipeDeleteMenuLayout getViewCache() {
        return mViewCache;
    }
    ...
    public boolean dispatchTouchEvent(android.view.MotionEvent r6) {
        ...
        L_0x010a:
            ...
            float r4 = r6.getRawY()
            r0.set(r1, r4)
            com.microtech.aidexx.views.SwipeDeleteMenuLayout r0 = mViewCache
        ...
        L_0x0140:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.microtech.aidexx.views.SwipeDeleteMenuLayout.dispatchTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void smoothExpand() {
        ...
        cancelAnim();
        ValueAnimator ofInt = ValueAnimator.ofInt(new int[]{getScrollX(), this.isLeftSwipe ? this.mRightMenuWidths : -this.mRightMenuWidths});
        this.mExpandAnim = ofInt;
        ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                SwipeDeleteMenuLayout.this.scrollTo(((Integer) valueAnimator.getAnimatedValue()).intValue(), 0);
            }
        });
        ...
        this.mExpandAnim.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animator) {
                boolean unused = SwipeDeleteMenuLayout.this.isExpand = true;
            }
        });
    ...
    public void smoothClose() {
        ...
        this.mCloseAnim.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animator) {
                boolean unused = SwipeDeleteMenuLayout.this.isExpand = false;
            }
        });
    ...
    public void onDetachedFromWindow() {
        SwipeDeleteMenuLayout swipeDeleteMenuLayout = mViewCache;
        if (this == swipeDeleteMenuLayout && swipeDeleteMenuLayout.isExpand) {
            swipeDeleteMenuLayout.smoothClose();
            mViewCache = null;
        }
