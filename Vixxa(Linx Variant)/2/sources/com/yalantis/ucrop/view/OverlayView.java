...
public class OverlayView extends View {
    ...
    public void drawCropGrid(Canvas canvas) {
        if (this.mShowCropGrid) {
            if (this.mGridPoints == null && !this.mCropViewRect.isEmpty()) {
                ...
                for (int i2 = 0; i2 < this.mCropGridRowCount; i2++) {
                    ...
                    this.mGridPoints[i + 1] = (this.mCropViewRect.height() * (f / ((float) (this.mCropGridRowCount + 1)))) + this.mCropViewRect.top;
                    int i3 = i + 3;
                ...
                for (int i4 = 0; i4 < this.mCropGridColumnCount; i4++) {
                    ...
                    this.mGridPoints[i] = (this.mCropViewRect.width() * (f2 / ((float) (this.mCropGridColumnCount + 1)))) + this.mCropViewRect.left;
                    this.mGridPoints[i + 1] = this.mCropViewRect.top;
                    int i5 = i + 3;
                    this.mGridPoints[i + 2] = (this.mCropViewRect.width() * (f2 / ((float) (this.mCropGridColumnCount + 1)))) + this.mCropViewRect.left;
                    i += 4;
        ...
        if (this.mFreestyleCropMode != 0) {
            ...
            rectF2.inset((float) (-i7), (float) i7);
            canvas.clipRect(this.mTempRect, Region.Op.DIFFERENCE);
