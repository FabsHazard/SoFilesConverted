...
public abstract class w {
    ...
    public static com.huawei.hms.hatool.n0 a(java.lang.String r6, byte[] r7, java.util.Map<java.lang.String, java.lang.String> r8, java.lang.String r9) {
        ...
        L_0x0012:
            ...
            r7.<init>(r1, r2)     // Catch:{ a -> 0x007f, SecurityException -> 0x007c, SSLPeerUnverifiedException -> 0x0079, SSLHandshakeException -> 0x0076, ConnectException -> 0x0074, UnknownHostException -> 0x0072, IOException -> 0x0070, all -> 0x006c }
            com.huawei.hms.hatool.k1.a((java.io.Closeable) r3)
            com.huawei.hms.hatool.k1.a((java.io.Closeable) r3)
        ...
        L_0x002f:
            ...
            java.lang.String r3 = b(r6)     // Catch:{ a -> 0x0126, SecurityException -> 0x0063, SSLPeerUnverifiedException -> 0x0060, SSLHandshakeException -> 0x005d, ConnectException -> 0x005a, UnknownHostException -> 0x0057, IOException -> 0x0055, all -> 0x0066 }
            ...
            r4.<init>(r7, r3)     // Catch:{ a -> 0x0126, SecurityException -> 0x0063, SSLPeerUnverifiedException -> 0x0060, SSLHandshakeException -> 0x005d, ConnectException -> 0x005a, UnknownHostException -> 0x0057, IOException -> 0x0055, all -> 0x0066 }
        ...
        L_0x008a:
            ...
            r6.<init>(r4, r2)     // Catch:{ all -> 0x013d }
            com.huawei.hms.hatool.k1.a((java.io.Closeable) r9)
            com.huawei.hms.hatool.k1.a((java.io.Closeable) r8)
            if (r3 == 0) goto L_0x00a0
            com.huawei.hms.hatool.k1.a((java.net.HttpURLConnection) r3)
        L_0x00a0:
            return r6
        L_0x00a1:
            r6 = r3
    ...
    private static void a(java.net.HttpURLConnection r2) {
        /*
            ...
            android.content.Context r1 = com.huawei.hms.hatool.q0.i()     // Catch:{ NoSuchAlgorithmException -> 0x001d, KeyStoreException -> 0x001a, GeneralSecurityException -> 0x0017, IOException -> 0x0014, IllegalAccessException -> 0x0011 }
            com.huawei.secure.android.common.ssl.SecureSSLSocketFactory r0 = com.huawei.secure.android.common.ssl.SecureSSLSocketFactory.getInstance(r1)     // Catch:{ NoSuchAlgorithmException -> 0x001d, KeyStoreException -> 0x001a, GeneralSecurityException -> 0x0017, IOException -> 0x0014, IllegalAccessException -> 0x0011 }
            goto L_0x0023
        L_0x0011:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:?, code lost:
        com.huawei.hms.hatool.v.f("hmsSdk", "When Response Content From Connection inputStream operation exception! " + r4.getResponseCode());
     */
    ...
    private static java.lang.String b(java.net.HttpURLConnection r4) {
        /*
            java.lang.String r0 = "When Response Content From Connection inputStream operation exception! "
            r1 = 0
            java.io.InputStream r1 = r4.getInputStream()     // Catch:{ IOException -> 0x0011 }
            java.lang.String r4 = com.huawei.hms.hatool.k1.a((java.io.InputStream) r1)     // Catch:{ IOException -> 0x0011 }
            com.huawei.hms.hatool.k1.a((java.io.Closeable) r1)
            return r4
        L_0x000f:
            r4 = move-exception
            goto L_0x002d
        L_0x0011:
            int r4 = r4.getResponseCode()     // Catch:{ all -> 0x000f }
            java.lang.String r2 = "hmsSdk"
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x000f }
            r3.<init>(r0)     // Catch:{ all -> 0x000f }
            java.lang.StringBuilder r4 = r3.append(r4)     // Catch:{ all -> 0x000f }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x000f }
            com.huawei.hms.hatool.v.f(r2, r4)     // Catch:{ all -> 0x000f }
            com.huawei.hms.hatool.k1.a((java.io.Closeable) r1)
            java.lang.String r4 = ""
            return r4
        L_0x002d:
