...
public class HmsScan extends HmsScanBase {
    ...
    public static final Parcelable.Creator<HmsScan> CREATOR = new Parcelable.Creator<HmsScan>() {
    ...
    enum SCAN_TYPE_FORMAT {
        ...
        TEL_PHONE_NUMBER_FORM(PointerIconCompat.TYPE_HELP),
        PURE_TEXT_FORM(1004),
        SMS_FORM(1005),
        URL_FORM(1006),
        ...
        private SCAN_TYPE_FORMAT(int i) {
    ...
    public static class LinkUrl implements Parcelable {
        public static final Parcelable.Creator<LinkUrl> CREATOR = new Parcelable.Creator<LinkUrl>() {
    ...
    public static class SmsContent implements Parcelable {
        public static final Parcelable.Creator<SmsContent> CREATOR = new Parcelable.Creator<SmsContent>() {
    ...
    public static class TelPhoneNumber implements Parcelable {
        ...
        public static final Parcelable.Creator<TelPhoneNumber> CREATOR = new Parcelable.Creator<TelPhoneNumber>() {
    ...
    public static class WiFiConnectionInfo implements Parcelable {
        public static final Parcelable.Creator<WiFiConnectionInfo> CREATOR = new Parcelable.Creator<WiFiConnectionInfo>() {
    ...
    public static class EventInfo implements Parcelable {
        ...
        public EventInfo(String str, EventTime eventTime, EventTime eventTime2, String str2) {
            this(str, eventTime, eventTime2, str2, (String) null, (String) null, (String) null);
        }
    ...
    public static class PeopleName implements Parcelable {
        public static final Parcelable.Creator<PeopleName> CREATOR = new Parcelable.Creator<PeopleName>() {
        ...
        public PeopleName(String str, String str2, String str3) {
            this(str, (String) null, (String) null, str2, (String) null, str3, (String) null);
        }
    ...
    public static class ContactDetail implements Parcelable {
        ...
        public ContactDetail(PeopleName peopleName2, String str, String str2, TelPhoneNumber[] telPhoneNumberArr, EmailContent[] emailContentArr, AddressInfo[] addressInfoArr, String[] strArr, String str3) {
            this.peopleName = peopleName2;
            this.title = str;
            this.company = str2;
        ...
        public ContactDetail(PeopleName peopleName2, TelPhoneNumber[] telPhoneNumberArr, EmailContent[] emailContentArr) {
            this(peopleName2, (String) null, (String) null, telPhoneNumberArr, emailContentArr, (AddressInfo[]) null, (String[]) null, (String) null);
        }
    ...
    public static class EventTime implements Parcelable {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeByte(this.isUTCTime ? (byte) 1 : 0);
        ...
        public EventTime(int i, int i2, int i3, int i4, int i5, int i6) {
            this(i, i2, i3, i4, i5, i6, true, (String) null);
        }
    ...
    public static class DriverInfo implements Parcelable {
        ...
        public DriverInfo(String str, String str2, String str3, String str4, String str5) {
            this(str, str2, str3, str4, str5, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null);
        }
