...
public class HmsScanAnalyzer extends MLAnalyzer<HmsScan> {
    ...
    /* access modifiers changed from: private */
    public HmsScanAnalyzerOptions mlVisionScanDetectorOptions;
    ...
    public Task<List<HmsScan>> analyzInAsyn(final MLFrame mLFrame) {
        return Tasks.callInBackground(new Callable<List<HmsScan>>() {
    ...
    public HmsScanAnalyzer() {
        if (AGConnectInstance.getInstance() != null) {
            ...
            o4.d(TAG, "AGConnectInstanceImpl contect is null");
        }
    }
