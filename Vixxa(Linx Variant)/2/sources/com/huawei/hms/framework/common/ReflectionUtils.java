...
public class ReflectionUtils {
    ...
    private static Object invoke(Object obj, Method method, Object... objArr) throws UnsupportedOperationException {
        ...
        try {
            ...
            Logger.e(TAG, "RuntimeException in invoke:", (Throwable) e);
            return null;
        } catch (Exception e2) {
            Logger.e(TAG, "Exception in invoke:", (Throwable) e2);
            return null;
        }
    }
    ...
    public static Method getMethod(Class<?> cls, String str, Class<?>... clsArr) {
        ...
        try {
            ...
            Logger.e(TAG, "SecurityException:", (Throwable) e);
            return null;
        } catch (NoSuchMethodException e2) {
            Logger.e(TAG, "NoSuchMethodException:", (Throwable) e2);
            return null;
        }
    }
    ...
    public static Object getFieldObj(Object obj, String str) {
        ...
        try {
            ...
            Logger.e(TAG, "Exception in getFieldObj :: IllegalAccessException:", (Throwable) e);
            return null;
        } catch (IllegalArgumentException e2) {
            Logger.e(TAG, "Exception in getFieldObj :: IllegalArgumentException:", (Throwable) e2);
            return null;
        } catch (NoSuchFieldException e3) {
            Logger.e(TAG, "Exception in getFieldObj :: NoSuchFieldException:", (Throwable) e3);
            return null;
        } catch (SecurityException e4) {
            Logger.e(TAG, "not security int method getFieldObj,SecurityException:", (Throwable) e4);
            return null;
        }
    }
    ...
    public static Field getField(Object obj, String str) {
        if (obj != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                Logger.e(TAG, "Exception in getField :: IllegalArgumentException:", (Throwable) e);
            } catch (NoSuchFieldException e2) {
                Logger.e(TAG, "Exception in getField :: NoSuchFieldException:", (Throwable) e2);
            } catch (SecurityException e3) {
                Logger.e(TAG, "not security int method getField,SecurityException:", (Throwable) e3);
            }
        }
        return null;
    }
    ...
    public static Object getStaticFieldObj(String str, String str2) {
        ...
        try {
            ...
            Logger.e(TAG, "not security int method getStaticFieldObj,SecurityException:", (Throwable) e4);
            return null;
        }
    }
