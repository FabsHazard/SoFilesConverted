...
public class ExecutorsUtils {
    ...
    public static ExecutorService newFixedThreadPool(int i, String str) {
        int i2 = i;
        int i3 = i;
        ThreadPoolExcutorEnhance threadPoolExcutorEnhance = new ThreadPoolExcutorEnhance(i2, i3, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(), createThreadFactory(str));
        threadPoolExcutorEnhance.allowCoreThreadTimeOut(true);
        return threadPoolExcutorEnhance;
    }
