...
public class NetworkUtil {
    ...
    public static int readDataSaverMode(Context context) {
        ...
        try {
            ...
            Logger.e(TAG, "SystemServer error:", (Throwable) e);
            return 0;
        }
    }
        ...
        if (networkType == 3) {
            ...
            if (cellSignalStrengths.size() > 0) {
                ...
                if (cellSignalStrengths2.size() > 0) {
                    i = cellSignalStrengths2.get(0).getDbm();
                } else {
                    ...
                    i = cellSignalStrengths3.get(0).getDbm();
                }
            }
            ...
            i = cellSignalStrengths4.get(0).getDbm();
            ...
            try {
                ...
                i = cellSignalStrengths5.get(0).getDbm();
            } catch (Throwable th) {
