    ...
    public String a(boolean z) {
        ...
        if (!TextUtils.isEmpty(a2) && a2.matches("\\d+")) {
            try {
                ...
                Logger.w("GeoipCountry", "convert urlParamKey from String to Long catch NumberFormatException.", (Throwable) e);
            }
        }
        if (TextUtils.isEmpty(str2) || e.a(Long.valueOf(j))) {
            ...
            if (z) {
                ...
                this.c.b().a(cVar, (com.huawei.hms.framework.network.grs.b) null, "geoip.countrycode", c2);
            }
        }
        return str2;
    }
