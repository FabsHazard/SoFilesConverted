...
public class c {
    ...
    private com.huawei.hms.framework.network.grs.g.d a(java.util.concurrent.ExecutorService r16, java.util.List<java.lang.String> r17, java.lang.String r18, com.huawei.hms.framework.network.grs.e.c r19) {
        ...
        L_0x0005:
            ...
            r3.put(r0, r1)
            r3 = 1
            long r4 = r9.k     // Catch:{ CancellationException -> 0x0082, ExecutionException -> 0x0079, InterruptedException -> 0x0070, TimeoutException -> 0x0068 }
        ...
        L_0x0053:
            java.lang.String r0 = l     // Catch:{ CancellationException -> 0x0064, ExecutionException -> 0x0061, InterruptedException -> 0x005e, TimeoutException -> 0x005c }
    ...
    private void c() {
        this.j = this.c.a().a(this.a.getGrsParasKey(true, true, this.b) + "ETag", "");
    }
