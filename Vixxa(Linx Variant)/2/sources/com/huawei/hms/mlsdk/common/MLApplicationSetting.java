...
public final class MLApplicationSetting {
    ...
    public final Boolean acceptHa;
    /* access modifiers changed from: private */
    public final String apiKey;
    /* access modifiers changed from: private */
    public final String appId;
    /* access modifiers changed from: private */
    public final String appMLKitGrsPolicy;
    /* access modifiers changed from: private */
    public final String certFingerprint;
    /* access modifiers changed from: private */
    public final Map<String, Object> extProperties;
    /* access modifiers changed from: private */
    public final List<String> haCollectorUrls;
    /* access modifiers changed from: private */
    public final String mlSdkVersion;
    /* access modifiers changed from: private */
    public final List<String> mlServiceUrls;
    /* access modifiers changed from: private */
    ...
    public static final class Factory {
        ...
        private List<String> haCollectorUrls = new ArrayList();
        private String mlSdkVersion;
        private List<String> mlServiceUrls = new ArrayList();
    ...
    public static MLApplicationSetting fromResource(Context context) {
        ...
        if (TextUtils.isEmpty(metadata)) {
            metadata = getKitMetadata(context, BundleKeyConstants.AppInfo.ML_SDK_VERSION, GrsBaseInfo.CountryCodeSource.UNKNOWN);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!equal(this.appId, mLApplicationSetting.appId) || !equal(this.apiKey, mLApplicationSetting.apiKey)) {
            return false;
        }
        return true;
    }
