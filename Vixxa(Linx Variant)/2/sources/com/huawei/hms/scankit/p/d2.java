...
public final class d2 {
    ...
    private u6[] d(u6[] u6VarArr) {
        ...
        u6 u6Var3 = u6VarArr[2];
        u6 u6Var4 = u6VarArr[3];
        u6 a2 = a(u6Var, u6Var2, (a(u6Var3, u6Var4) + 1) * 4);
        u6 a3 = a(u6Var3, u6Var2, (a(u6Var, u6Var4) + 1) * 4);
        int a4 = a(a2, u6Var4);
        int i = a4 + 1;
        int a5 = a(a3, u6Var4);
        int i2 = a5 + 1;
        ...
        float b2 = (((u6Var.b() + u6Var2.b()) + u6Var3.b()) + u6Var4.b()) / 4.0f;
        ...
        int i3 = i2 * 4;
        int i4 = i * 4;
        return new u6[]{a(a(a6, a7, i3), a9, i4), a(a(a7, a6, i3), a8, i4), a(a(a8, a9, i3), a7, i4), a(a(a9, a8, i3), a6, i4)};
    }
    ...
    public j2 a() throws a {
        ...
        if (a2 != null) {
            ...
            return new j2(a(this.a, u6Var, u6Var2, u6Var3, u6Var4, i2, i), new u6[]{u6Var, u6Var2, u6Var3, u6Var4});
        }
        throw a.a();
    }
    ...
    private static u6 a(u6 u6Var, float f, float f2) {
        float b2 = u6Var.b();
        float c = u6Var.c();
        return new u6(b2 < f ? b2 - 1.0f : b2 + 1.0f, c < f2 ? c - 1.0f : c + 1.0f);
    }
    ...
    private boolean a(u6 u6Var) {
        return u6Var.b() >= 0.0f && u6Var.b() < ((float) this.a.e()) && u6Var.c() > 0.0f && u6Var.c() < ((float) this.a.c());
    }
    ...
    private int a(u6 u6Var, u6 u6Var2) {
        ...
        int b3 = (int) u6Var2.b();
        int c2 = (int) u6Var2.c();
        boolean z2 = Math.abs(c2 - c) > Math.abs(b3 - b2);
        if (!z2) {
            int i2 = c;
            c = b2;
            b2 = i2;
        ...
        boolean b4 = d2Var.a.b(z2 ? b2 : c, z2 ? c : b2);
        int i7 = 0;
        int i8 = 0;
        int i9 = 0;
        while (c != c2) {
            boolean b5 = d2Var.a.b(z2 ? b2 : c, z2 ? c : b2);
            i7++;
            if (b5 != b4) {
                i = c2;
                z = z2;
                if (((double) i7) > Math.ceil(((double) i8) / 1.5d)) {
                    i9++;
                    i8 -= (i8 - i7) / i9;
                    b4 = b5;
                    i7 = 0;
