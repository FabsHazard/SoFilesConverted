...
public class o8 {
    public static float a(int i, int i2, u6[] u6VarArr) {
        ...
        int min3 = (int) (((float) Math.min(i2, i)) * 0.85f);
        int i4 = (i - min3) / 2;
        int i5 = (i2 - min3) / 2;
        Rect rect = new Rect(i4, i5, min3 + i4, min3 + i5);
        if (min < ((float) rect.left) && min2 < ((float) rect.top) && max > ((float) rect.right) && max2 > ((float) rect.bottom)) {
            return 1.0f;
        }
        float abs3 = Math.abs(min2 - ((float) rect.top));
        float abs4 = Math.abs(min - ((float) rect.left));
        float abs5 = Math.abs(max - ((float) rect.right));
        float abs6 = Math.abs(max2 - ((float) rect.bottom));
        float f2 = ((float) (rect.left + rect.right)) / 2.0f;
        float f3 = ((float) (rect.top + rect.bottom)) / 2.0f;
        float min4 = Math.min(Math.min(Math.min(abs4, abs5), abs3), abs6);
        if (0.01f > Math.abs(abs4 - min4)) {
            abs = Math.abs(f2 - ((float) rect.left)) * 1.0f;
            abs2 = Math.abs(f2 - min);
        } else if (0.01f > Math.abs(abs5 - min4)) {
            abs = Math.abs(f2 - ((float) rect.right)) * 1.0f;
            abs2 = Math.abs(f2 - max);
        } else if (0.01f > Math.abs(abs3 - min4)) {
            abs = Math.abs(f3 - ((float) rect.top)) * 1.0f;
            abs2 = Math.abs(f3 - min2);
        } else {
            if (0.01f > Math.abs(abs6 - min4)) {
                abs = Math.abs(f3 - ((float) rect.bottom)) * 1.0f;
    ...
    public static float b(int i, int i2, u6[] u6VarArr) {
        ...
        int min3 = (int) (((float) Math.min(i2, i)) * 0.1f);
        Rect rect = new Rect(min3, min3, i - min3, i2 - min3);
        if (min < ((float) rect.left) && min2 < ((float) rect.top) && max > ((float) rect.right) && max2 > ((float) rect.bottom)) {
            return 1.0f;
        }
        float abs3 = Math.abs(max - ((float) rect.right));
        float abs4 = Math.abs(max2 - ((float) rect.bottom));
        float abs5 = Math.abs(min2 - ((float) rect.top));
        float abs6 = Math.abs(min - ((float) rect.left));
        float f2 = ((float) (rect.left + rect.right)) / 2.0f;
        float f3 = ((float) (rect.top + rect.bottom)) / 2.0f;
        float min4 = Math.min(Math.min(Math.min(abs6, abs3), abs5), abs4);
        if (0.01f > Math.abs(abs6 - min4)) {
            abs = Math.abs(f2 - ((float) rect.left));
            abs2 = Math.abs(f2 - min);
        } else if (0.01f > Math.abs(abs3 - min4)) {
            abs = Math.abs(f2 - ((float) rect.right));
            abs2 = Math.abs(f2 - max);
        } else if (0.01f > Math.abs(abs5 - min4)) {
            abs = Math.abs(f3 - ((float) rect.top));
            abs2 = Math.abs(f3 - min2);
        } else {
            if (0.01f > Math.abs(abs4 - min4)) {
                abs = Math.abs(f3 - ((float) rect.bottom));
                abs2 = Math.abs(f3 - max2);
            }
            return Math.min(f, 2.0f) * 0.9f;
        }
