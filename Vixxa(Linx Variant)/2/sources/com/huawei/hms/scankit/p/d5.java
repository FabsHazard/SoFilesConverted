...
/* compiled from: MultipleBarcodeDetector */
public class d5 {
    public List<i2> a = new ArrayList();
    private int b = 0;
                                        ...
                                        if (w7.a(multiBarcodeDetect, i12)) {
                                            ...
                                            if (w7.a(multiBarcodeDetect, i13)) {
                                                ...
                                                if (w7.a(multiBarcodeDetect, i14)) {
                                                    this.a.add(new i2(z, multiBarcodeDetect[i5], multiBarcodeDetect[i6], multiBarcodeDetect[i7], multiBarcodeDetect[i8], multiBarcodeDetect[i9], multiBarcodeDetect[i10], multiBarcodeDetect[i11], multiBarcodeDetect[i12], multiBarcodeDetect[i13], multiBarcodeDetect[i14]));
                                                }
                                            }
                                        }
                                    }
