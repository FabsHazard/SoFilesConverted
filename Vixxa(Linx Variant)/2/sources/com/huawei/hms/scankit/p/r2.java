...
public final class r2 extends r7 {
    ...
    public boolean[] a(String str) {
        ...
        int a = h5.a(zArr, 0, q7.c, true);
        for (int i = 0; i <= 3; i++) {
            a += h5.a(zArr, a, q7.f[Character.digit(str.charAt(i), 10)], false);
        }
        int a2 = a + h5.a(zArr, a, q7.d, false);
        for (int i2 = 4; i2 <= 7; i2++) {
            a2 += h5.a(zArr, a2, q7.f[Character.digit(str.charAt(i2), 10)], true);
        }
        h5.a(zArr, a2, q7.c, true);
        return zArr;
    }
}
