...
public class SSFSecureX509SingleInstance {
            ...
            if (b == null) {
                synchronized (SSFSecureX509SingleInstance.class) {
                    if (b == null) {
                        ...
                        new e().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Context[]{context});
                    }
                }
            }
            return b;
    ...
    public static void updateBks(InputStream inputStream) {
        ...
        if (!(inputStream == null || b == null)) {
            ...
            SSFCompatiableSystemCA.a((X509TrustManager) b);
            SASFCompatiableSystemCA.a((X509TrustManager) b);
        }
