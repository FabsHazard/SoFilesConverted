    ...
    public static byte[] encrypt(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        if (bArr == null) {
            ...
            try {
                ...
                b.b(d, "NoSuchAlgorithmException: " + e2.getMessage());
                return new byte[0];
            } catch (NoSuchPaddingException e3) {
                b.b(d, "NoSuchPaddingException: " + e3.getMessage());
                return new byte[0];
            } catch (InvalidKeyException e4) {
                b.b(d, "InvalidKeyException: " + e4.getMessage());
                return new byte[0];
            } catch (InvalidAlgorithmParameterException e5) {
                b.b(d, "InvalidAlgorithmParameterException: " + e5.getMessage());
                return new byte[0];
            } catch (IllegalBlockSizeException e6) {
                b.b(d, "IllegalBlockSizeException: " + e6.getMessage());
                return new byte[0];
            } catch (BadPaddingException e7) {
                b.b(d, "BadPaddingException: " + e7.getMessage());
                return new byte[0];
            }
        }
    }
