...
public class SecureX509SingleInstance {
            ...
            if (b == null) {
                synchronized (SecureX509SingleInstance.class) {
                    if (b == null) {
                        ...
                        new d().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Context[]{context});
                    }
                }
            }
    ...
    public static void updateBks(InputStream inputStream) {
        ...
        if (!(inputStream == null || b == null)) {
            ...
            SecureSSLSocketFactory.a((X509TrustManager) b);
            SecureApacheSSLSocketFactory.a((X509TrustManager) b);
        }
