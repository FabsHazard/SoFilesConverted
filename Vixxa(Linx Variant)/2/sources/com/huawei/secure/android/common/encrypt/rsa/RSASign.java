    ...
    public static byte[] sign(byte[] bArr, PrivateKey privateKey, boolean z) {
        ...
        if (z) {
            try {
                ...
                b.b(c, "sign NoSuchAlgorithmException: " + e2.getMessage());
                return bArr2;
            } catch (InvalidKeyException e3) {
                b.b(c, "sign InvalidKeyException: " + e3.getMessage());
                return bArr2;
            } catch (SignatureException e4) {
                b.b(c, "sign SignatureException: " + e4.getMessage());
                return bArr2;
            } catch (InvalidAlgorithmParameterException e5) {
                b.b(c, "sign InvalidAlgorithmParameterException: " + e5.getMessage());
                return bArr2;
            } catch (Exception e6) {
