        ...
        synchronized (AesCbcKS.class) {
            ...
            try {
                ...
                if (key == null || !(key instanceof SecretKey)) {
                    b.c(a, "generate key");
                    KeyGenerator instance2 = KeyGenerator.getInstance("AES", b);
                    instance2.init(new KeyGenParameterSpec.Builder(str2, 3).setBlockModes(new String[]{"CBC"}).setEncryptionPaddings(new String[]{"PKCS7Padding"}).setKeySize(256).build());
