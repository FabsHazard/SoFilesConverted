...
public class c implements X509TrustManager {
    ...
    public void checkServerTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
        ...
        try {
            z = b.a(this.a, x509CertificateArr2);
        } catch (NoSuchProviderException e2) {
            g.b(c, "checkServerTrusted NoSuchProviderException: " + e2.getMessage());
        } catch (NoSuchAlgorithmException e3) {
            g.b(c, "checkServerTrusted NoSuchAlgorithmException: " + e3.getMessage());
        } catch (InvalidKeyException e4) {
            g.b(c, "checkServerTrusted InvalidKeyException: " + e4.getMessage());
    ...
    public X509Certificate[] getAcceptedIssuers() {
        try {
            ...
            for (X509TrustManager acceptedIssuers : this.b) {
