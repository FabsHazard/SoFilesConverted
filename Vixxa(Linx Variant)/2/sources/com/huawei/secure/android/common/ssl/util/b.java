...
public class b {
    ...
    public static boolean b(X509Certificate[] x509CertificateArr) {
        ...
        while (i < length) {
            try {
                ...
                g.b(a, "verifyCertificateDate : exception : " + e2.getMessage());
                return false;
            }
        }
        return true;
    ...
    public static boolean a(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        try {
            ...
            g.b(a, "verify: publickey CertificateException " + e.getMessage());
            return false;
        } catch (InvalidKeyException e2) {
            g.b(a, "verify: publickey InvalidKeyException " + e2.getMessage());
            return false;
        } catch (NoSuchAlgorithmException e3) {
            g.b(a, "verify: publickey NoSuchAlgorithmException " + e3.getMessage());
            return false;
        } catch (NoSuchProviderException e4) {
            g.b(a, "verify: publickey NoSuchProviderException " + e4.getMessage());
            return false;
        } catch (SignatureException e5) {
            g.b(a, "verify: publickey SignatureException " + e5.getMessage());
            return false;
        } catch (Exception e6) {
    ...
    public static X509Certificate a(SslCertificate sslCertificate) {
        ...
        if (byteArray != null) {
            try {
                return (X509Certificate) CertificateFactory.getInstance(e.b).generateCertificate(new ByteArrayInputStream(byteArray));
            } catch (CertificateException e) {
                g.a(a, "exception", e);
            }
        }
