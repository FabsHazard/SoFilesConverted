...
public class e implements g {
    ...
    private SecretKey a() {
        try {
            String a2 = this.a.a("/code/code1", (String) null);
            String a3 = this.a.a("/code/code2", (String) null);
            String a4 = this.a.a("/code/code3", (String) null);
            String a5 = this.a.a("/code/code4", (String) null);
