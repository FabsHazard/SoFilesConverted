...
public final class aj implements Runnable {
    ...
    public aj(Context context, int i2, int i3, byte[] bArr, String str, String str2, ah ahVar, boolean z) {
        this(context, i2, i3, bArr, str, str2, ahVar, 2, 30000, z);
    }
    ...
    private static boolean a(br brVar, aa aaVar, ac acVar) {
        if (brVar == null) {
            ...
            try {
                if (!ap.a(brVar.g) && !aa.b().i().equals(brVar.g)) {
                    ...
                    if (!((Boolean) a4.first).booleanValue()) {
                        ...
                        if (!((Boolean) a5.first).booleanValue()) {
                            ...
                            if (a6 == null) {
                                ...
                                al.c("[Upload] Response cmd is: %d, length of sBuffer is: %d", Integer.valueOf(a6.b), Integer.valueOf(a6.c == null ? 0 : a6.c.length));
