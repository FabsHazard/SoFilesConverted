...
public class DefaultYearView extends YearView {
    ...
    public void onDrawMonth(Canvas canvas, int i, int i2, int i3, int i4, int i5, int i6) {
        canvas.drawText(getContext().getResources().getStringArray(R.array.month_string_array)[i2 - 1], (float) ((i3 + (this.mItemWidth / 2)) - this.mTextPadding), ((float) i4) + this.mMonthTextBaseLine, this.mMonthTextPaint);
    }

    /* access modifiers changed from: protected */
    public void onDrawWeek(Canvas canvas, int i, int i2, int i3, int i4, int i5) {
        canvas.drawText(getContext().getResources().getStringArray(R.array.year_view_week_string_array)[i], (float) (i2 + (i4 / 2)), ((float) i3) + this.mWeekTextBaseLine, this.mWeekTextPaint);
    }
