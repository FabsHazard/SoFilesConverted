...
public abstract class BaseWeekView extends BaseView {
    ...
    private void onClickCalendarPadding() {
        if (this.mDelegate.mClickCalendarPaddingListener != null) {
            ...
            if (calendar != null) {
                this.mDelegate.mClickCalendarPaddingListener.onClickCalendarPadding(this.mX, this.mY, false, calendar, getClickCalendarPaddingObject(this.mX, this.mY, calendar));
            }
        }
    }
