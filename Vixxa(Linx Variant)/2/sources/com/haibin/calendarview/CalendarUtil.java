...
public final class CalendarUtil {
    ...
    public static int getWeekCountBetweenBothCalendar(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        instance.set(i4, i5 - 1, i6);
        return ((weekViewStartDiff + getWeekViewEndDiff(i4, i5, i6, i7)) + (((int) ((instance.getTimeInMillis() - timeInMillis) / 86400000)) + 1)) / 7;
    }
    ...
    public static int getWeekFromCalendarStartWithMinCalendar(Calendar calendar, int i, int i2, int i3, int i4) {
        ...
        return ((weekViewStartDiff + ((int) ((instance.getTimeInMillis() - timeInMillis) / 86400000))) / 7) + 1;
    }
    ...
    public static Calendar getFirstCalendarStartWithMinCalendar(int i, int i2, int i3, int i4, int i5) {
        ...
        instance.setTimeInMillis(timeInMillis - (((long) getWeekViewStartDiff(instance.get(1), instance.get(2) + 1, instance.get(5), i5)) * 86400000));
