...
public class CalendarLayout extends LinearLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mDelegate.isFullScreenCalendar()) {
            super.onMeasure(i, i2);
            this.mContentView.measure(i, View.MeasureSpec.makeMeasureSpec((size - dipToPx) - this.mDelegate.getCalendarItemHeight(), BasicMeasure.EXACTLY));
        ...
        if (monthViewHeight >= size && this.mMonthView.getHeight() > 0) {
            i2 = View.MeasureSpec.makeMeasureSpec(monthViewHeight + dipToPx + this.mDelegate.getWeekBarHeight(), BasicMeasure.EXACTLY);
        ...
        super.onMeasure(i, i2);
        this.mContentView.measure(i, View.MeasureSpec.makeMeasureSpec(size - monthViewHeight, BasicMeasure.EXACTLY));
