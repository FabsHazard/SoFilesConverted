...
final class CalendarViewDelegate {
    ...
    CalendarViewDelegate(Context context, AttributeSet attributeSet) {
        ...
        this.mWeekTextSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.CalendarView_week_text_size, CalendarUtil.dipToPx(context, 12.0f));
        this.mWeekBarHeight = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_week_bar_height, (float) CalendarUtil.dipToPx(context, 40.0f));
        this.mWeekLineMargin = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_week_line_margin, (float) CalendarUtil.dipToPx(context, 0.0f));
        ...
        this.mLunarTextSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.CalendarView_lunar_text_size, CalendarUtil.dipToPx(context, 10.0f));
        this.mCalendarItemHeight = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_calendar_height, (float) CalendarUtil.dipToPx(context, 56.0f));
        this.isFullScreenCalendar = obtainStyledAttributes.getBoolean(R.styleable.CalendarView_calendar_match_parent, false);
        this.mYearViewMonthTextSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.CalendarView_year_view_month_text_size, CalendarUtil.dipToPx(context, 18.0f));
        this.mYearViewDayTextSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.CalendarView_year_view_day_text_size, CalendarUtil.dipToPx(context, 7.0f));
        ...
        this.mYearViewWeekTextSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.CalendarView_year_view_week_text_size, CalendarUtil.dipToPx(context, 8.0f));
        this.mYearViewMonthHeight = obtainStyledAttributes.getDimensionPixelSize(R.styleable.CalendarView_year_view_month_height, CalendarUtil.dipToPx(context, 32.0f));
        this.mYearViewWeekHeight = obtainStyledAttributes.getDimensionPixelSize(R.styleable.CalendarView_year_view_week_height, CalendarUtil.dipToPx(context, 0.0f));
        this.mYearViewPadding = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_year_view_padding, (float) CalendarUtil.dipToPx(context, 12.0f));
        this.mYearViewPaddingLeft = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_year_view_padding_left, (float) CalendarUtil.dipToPx(context, 12.0f));
        this.mYearViewPaddingRight = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_year_view_padding_right, (float) CalendarUtil.dipToPx(context, 12.0f));
        int i3 = this.mYearViewPadding;
        if (i3 != 0) {
            this.mYearViewPaddingLeft = i3;
            this.mYearViewPaddingRight = i3;
        }
        this.mYearViewMonthPaddingTop = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_year_view_month_padding_top, (float) CalendarUtil.dipToPx(context, 4.0f));
        this.mYearViewMonthPaddingBottom = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_year_view_month_padding_bottom, (float) CalendarUtil.dipToPx(context, 4.0f));
        this.mYearViewMonthPaddingLeft = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_year_view_month_padding_left, (float) CalendarUtil.dipToPx(context, 4.0f));
        this.mYearViewMonthPaddingRight = (int) obtainStyledAttributes.getDimension(R.styleable.CalendarView_year_view_month_padding_right, (float) CalendarUtil.dipToPx(context, 4.0f));
    ...
    public final List<Calendar> getSelectCalendarRange() {
        ...
        if (!(this.mSelectedStartRangeCalendar == null || this.mSelectedEndRangeCalendar == null)) {
            ...
            for (long timeInMillis2 = instance.getTimeInMillis(); timeInMillis2 <= timeInMillis; timeInMillis2 += TimeUtils.oneDayMillis) {
