...
public abstract class YearView extends View {
    ...
    private void onDrawWeek(Canvas canvas) {
        if (this.mDelegate.getYearViewWeekHeight() > 0) {
            ...
            for (int i = 0; i < 7; i++) {
                onDrawWeek(canvas, r0, this.mDelegate.getYearViewMonthPaddingLeft() + (i * width), this.mDelegate.getYearViewMonthHeight() + this.mDelegate.getYearViewMonthPaddingTop() + this.mDelegate.getYearViewMonthPaddingBottom(), width, this.mDelegate.getYearViewWeekHeight());
                int i2 = i2 + 1;
                if (i2 >= 7) {
                    i2 = 0;
                }
