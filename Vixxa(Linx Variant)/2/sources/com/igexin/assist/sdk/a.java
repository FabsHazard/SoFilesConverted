...
public class a {
    ...
    static AbstractPushManager a(Context context) {
        try {
            if (d(context)) {
                ...
                b.a("Assist_PM|HoPushManager checkDevice flag = true", new Object[0]);
                return a("com.igexin.assist.control.honor.HoPushManager", context);
            } else if (b(context) && l.C) {
            ...
            } else if (h(context) && com.igexin.push.util.a.f()) {
    ...
    public static boolean d(Context context) {
        ...
        try {
            z = ((Boolean) Class.forName("com.igexin.assist.control.honor.HoPushManager").getMethod("checkHWDevice", new Class[]{Context.class}).invoke((Object) null, new Object[]{context})).booleanValue();
            if (z) {
                a |= 2;
            }
        } catch (Throwable unused) {
    ...
    public static boolean i(Context context) {
        ...
        if (c(context) || b(context) || e(context) || f(context) || g(context) || h(context)) {
            z = true;
        }
        if (z) {
            i |= 2;
