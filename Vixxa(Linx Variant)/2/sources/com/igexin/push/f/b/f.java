...
public class f extends g {
    ...
    public void d_() {
        ...
        boolean b2 = a.b();
        d.g = a.h();
        b.a("RTTask|networkAvailable = " + d.g + ",sdkOnline = " + d.l + ", pushOn =" + d.i + ", isSilentTime= " + a2 + ", blockEndTime= " + b2, new Object[0]);
        if (!d.g || !d.i || d.l || a2 || !b2) {
            b.a("RTTask reconnect timer task stop, connect interval= 20min #######", new Object[0]);
            j = 1200000;
        } else if (a.i() || !TextUtils.isEmpty(d.s)) {
            b.a("RTTask reconnect timer task isOnline = false, try login...", new Object[0]);
            if (System.currentTimeMillis() - this.b < 2500) {
                d.o++;
            }
            if (d.o > 30 && ((double) Math.abs(SystemClock.elapsedRealtime() - this.c)) < 72000.0d) {
                i.a().d();
            }
            ...
            d.E = PeriodicWorkRequest.MIN_PERIODIC_INTERVAL_MILLIS;
            a((long) PeriodicWorkRequest.MIN_PERIODIC_INTERVAL_MILLIS, TimeUnit.MILLISECONDS);
