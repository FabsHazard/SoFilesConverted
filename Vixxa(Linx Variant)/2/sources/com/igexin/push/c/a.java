...
public class a {
    ...
    private synchronized void a(d dVar) {
        ...
        String str = f;
        b.a(sb.append(str).append("|set domain type = ").append(dVar).toString(), new Object[0]);
        if (l.f) {
            if (this.a != dVar) {
                a((List<e>) null);
            }
    ...
    private void a(String str) {
        try {
            ...
            b.a(f + Logger.c + th.toString(), new Object[0]);
        }
    }
        ...
        try {
            synchronized (this.n) {
                ...
                if (!this.k.isEmpty() || !TextUtils.isEmpty(str)) {
                    ...
                    StringBuilder sb = new StringBuilder();
                    String str2 = f;
                    b.a(sb.append(str2).append("cm try = ").append(this.i).append(" times").toString(), new Object[0]);
            ...
            b.a(f + Logger.c + e2.toString(), new Object[0]);
            return null;
        }
    }
    ...
    private void j() {
        ...
        } else if (System.currentTimeMillis() - this.e > TimeUtils.oneDayMillis && this.c > l.p) {
            dVar = d.BACKUP;
        } else {
            return;
        }
    ...
    public boolean a() {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder();
            String str = f;
            b.a(sb.append(str).append("|get from cm = ").append(b2).toString(), new Object[0]);
            if (b2 == null) {
    ...
    public void d() {
        ...
        i.a().c(jSONArray.length() == 0 ? "null" : jSONArray.toString(), !this.p);
    }
