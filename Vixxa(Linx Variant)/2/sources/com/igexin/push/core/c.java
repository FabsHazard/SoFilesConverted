...
public class c implements b {
    ...
    private e f;
    private com.igexin.a.a.b.c g = com.igexin.a.a.b.c.b();
    ...
    private c() {
        this.g.a((com.igexin.a.a.d.a.a<String, Integer, com.igexin.a.a.b.b, d>) new com.igexin.push.d.a(this.a));
        this.g.a((b) this);
        this.i = new a();
    }
    ...
    private void n() {
        ...
        if (Build.VERSION.SDK_INT > 33) {
            this.a.registerReceiver(l.a(), intentFilter, d.az, (Handler) null, 4);
        } else {
            this.a.registerReceiver(l.a(), intentFilter, d.az, (Handler) null);
        }
    }
    ...
    public boolean a(Context context) {
        ...
        if (fVar == null || !fVar.isAlive()) {
            if (!this.j.getAndSet(true)) {
                ...
                this.d = new com.igexin.a.a.b.a.a.d(this.b.getLooper());
            }
            return true;
        }
    ...
    public boolean a(com.igexin.a.a.d.a.e eVar, f fVar) {
        e eVar2 = this.f;
        return eVar2 != null && eVar2.a((Object) eVar);
    }

    public boolean a(com.igexin.a.a.d.e eVar, f fVar) {
        e eVar2 = this.f;
    ...
    public boolean a(boolean z) {
        com.igexin.a.a.c.b.a("CoreLogic|start sdkSwitch isSlave = " + z, new Object[0]);
        if (d.e == null) {
            return false;
        }
        if (!new com.igexin.sdk.a.c(d.e).b()) {
            new com.igexin.sdk.a.d(d.e).a();
            d.i = true;
            new com.igexin.sdk.a.c(d.e).a();
        }
        if (z) {
            new com.igexin.sdk.a.d(d.e).a();
            d.i = true;
    ...
    public void c() {
        ...
        try {
            ...
            d.Z = this.g.a(com.igexin.push.f.b.b.i(), false, true);
            d.aa = this.g.a(com.igexin.push.f.b.f.i(), true, true);
            ...
            w.a().f();
            try {
                AssistPushManager.getInstance().initialize(d.e);
                AssistPushManager.getInstance().register(d.e);
            } catch (Throwable unused) {
            }
        } catch (Throwable th) {
            com.igexin.a.a.c.b.a("CoreLogic|init|failed|" + th.toString(), new Object[0]);
            com.igexin.a.a.c.a.f.a().a("CoreLogic init failed = " + th.toString());
        }
    }
