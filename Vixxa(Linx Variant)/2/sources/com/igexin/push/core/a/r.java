...
public class r extends b {
    ...
    public boolean a(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            b.a("redirect|" + optLong + Logger.c + jSONArray.toString(), new Object[0]);
            int i = 0;
            ...
            if (jSONObject2.has("loc") && jSONObject2.has("conf")) {
                try {
                    ...
                    String str2 = a;
                    b.a(sb.append(str2).append(" set group id : ").append(d.b).toString(), new Object[0]);
                    ...
                    if (a2 != null && a2.length > 1) {
                        ...
                        if (d.aj == 0) {
                            str = a2[1];
                        } else if (System.currentTimeMillis() - d.aj > 7200000) {
                            str = a2[1];
                        } else {
