...
public class f implements a {
    ...
    public a a(PushTaskBean pushTaskBean, BaseAction baseAction) {
        ...
        try {
            ...
            a2.setPackage(d.e.getPackageName());
            a2.addFlags(268435456);
            if (com.igexin.push.util.a.b(a2, d.e)) {
                return a.success;
            }
            com.igexin.a.a.c.b.a(a + "|execute failed, activity not exist", new Object[0]);
            e.a().a(pushTaskBean.getId(), pushTaskBean.getMessageId(), jVar.b());
            return a.stop;
        } catch (Throwable th) {
            com.igexin.a.a.c.b.a(a + "|execute exception = " + th.toString(), new Object[0]);
            e.a().a(pushTaskBean.getId(), pushTaskBean.getMessageId(), jVar.b());
            return a.stop;
        }
    }
    ...
    public boolean b(PushTaskBean pushTaskBean, BaseAction baseAction) {
        ...
        try {
            ...
            a3.setPackage(d.e.getPackageName());
            a3.addFlags(268435456);
            if (com.igexin.push.util.a.b(a3, d.e)) {
                d.e.startActivity(a3);
                a2 = e.a();
            ...
            com.igexin.a.a.c.b.a(a + "|execute exception = " + th.getMessage(), new Object[0]);
            e.a().a(pushTaskBean.getId(), pushTaskBean.getMessageId(), jVar.b());
            return true;
        }
    }
