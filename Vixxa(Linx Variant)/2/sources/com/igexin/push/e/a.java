...
public class a {
    ...
    public int a(String str, c cVar, boolean z) {
        ...
        if (d.l || (cVar instanceof g) || (cVar instanceof i) || (cVar instanceof com.igexin.push.d.c.d)) {
            if (this.b) {
                if (z) {
                    if (com.igexin.a.a.b.c.b().a(SDKUrlConfig.getCmAddress(), 3, com.igexin.push.core.c.a().h(), cVar, true, l.e > 0 ? l.e : 10, new h()) == null) {
                        return -2;
                    }
    ...
    public void a(q qVar) {
        com.igexin.a.a.b.c b2;
        Object aVar;
        if (qVar == q.TCP_IO_EXCEPTION) {
            b2 = com.igexin.a.a.b.c.b();
    ...
    public void i() {
        ...
        b.a(a + "|network changed, available = " + h + ", last = " + d.g, new Object[0]);
