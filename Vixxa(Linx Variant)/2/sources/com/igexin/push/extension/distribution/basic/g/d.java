        ...
        synchronized (d.class) {
            try {
                ...
                if ("huawei".equalsIgnoreCase(a2) || "honor".equalsIgnoreCase(a2)) {
                    int intValue = ((Integer) g.b(com.igexin.push.core.d.e, "hwBadgeNum", 0)).intValue();
                    if (!z) {
                        i += intValue;
                    }
                    g.a(com.igexin.push.core.d.e, "hwBadgeNum", Integer.valueOf(i));
                    Bundle bundle = new Bundle();
                    bundle.putString(WiseOpenHianalyticsData.UNION_PACKAGE, com.igexin.push.core.d.e.getPackageName());
                    bundle.putString("class", b(com.igexin.push.core.d.e));
                    ...
                    if (TextUtils.isEmpty(com.igexin.push.core.d.e.getContentResolver().getType(parse))) {
                        parse = parse2;
                    }
                    com.igexin.push.core.d.e.getContentResolver().call(parse, "change_badge", (String) null, bundle);
                    return true;
                }
            } catch (Throwable unused) {
            }
