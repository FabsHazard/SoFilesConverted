...
public class c extends d {
    ...
    private void a(String str) {
        ...
        File file2 = new File(e.k + str + InternalZipConstants.ZIP_FILE_SEPARATOR);
        if (!file2.exists()) {
            file2.mkdirs();
        }
    }
    ...
    public void a(byte[] bArr) throws Exception {
        ...
        a(this.g);
        String str = e.k + this.g + InternalZipConstants.ZIP_FILE_SEPARATOR + parseInt + "_" + this.i + ".bin";
