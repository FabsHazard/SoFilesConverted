...
public class f extends Handler {
    ...
    public void a(String str) {
        ...
        if (x.a != null && a.c(x.a)) {
            ...
            } else if (this.c.length() <= 5120 && this.c.length() + "Warning! the log cache is too long to show the full content,we suggest you call initialize and setDebugLogger in a short time interval.".length() > 5120) {
