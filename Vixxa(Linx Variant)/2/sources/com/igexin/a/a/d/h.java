...
final class h {
    ...
    final HashMap<Integer, i> b = new HashMap<>();
    final ReentrantLock c = new ReentrantLock();
    ThreadFactory d = new j(this);
    ...
    public final com.igexin.a.a.d.e a() {
        /*
            r4 = this;
        L_0x0000:
            ...
            java.util.concurrent.BlockingQueue<com.igexin.a.a.d.e> r0 = r4.a     // Catch:{ InterruptedException -> 0x0000 }
        ...
        L_0x0010:
            com.igexin.a.a.d.e r0 = (com.igexin.a.a.d.e) r0     // Catch:{ InterruptedException -> 0x0000 }
            goto L_0x001a
        L_0x0013:
            java.util.concurrent.BlockingQueue<com.igexin.a.a.d.e> r0 = r4.a     // Catch:{ InterruptedException -> 0x0000 }
        ...
        L_0x001d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.igexin.a.a.d.h.a():com.igexin.a.a.d.e");
    }
    ...
    public final void a(e eVar) {
        ...
        if (eVar.y != 0) {
            ...
            reentrantLock.lock();
            try {
                i iVar = this.b.get(Integer.valueOf(eVar.y));
                if (iVar != null) {
                    iVar.a.offer(eVar);
                    return;
                }
    ...
    public final boolean a(i iVar) {
        ...
        try {
            ...
            this.b.remove(Integer.valueOf(iVar.d));
            reentrantLock.unlock();
            return false;
        } catch (Throwable th) {
            reentrantLock.unlock();
    ...
    public final Thread f(e eVar) {
        ...
        if (!(eVar == null || eVar.y == 0)) {
            this.b.put(Integer.valueOf(eVar.y), iVar);
        }
        Thread newThread = this.d.newThread(iVar);
        if (newThread != null) {
            this.g++;
        }
        return newThread;
