...
public final class e {
    ...
    public static String a(String[] strArr) {
        ...
        if (!strArr[3].equals("")) {
            sb.append(strArr[3]);
            if (!strArr[3].equals(InternalZipConstants.ZIP_FILE_SEPARATOR)) {
                sb.append('/');
            }
        }
        if (!strArr[4].equals("")) {
    ...
    public static String[] a(String str) {
        ...
        if (sb.length() > 0) {
            ...
            strArr[3] = InternalZipConstants.ZIP_FILE_SEPARATOR;
        }
        return strArr;
    }
    ...
    public static byte[] c(byte[] r3) {
        ...
        L_0x0020:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.igexin.a.a.b.e.c(byte[]):byte[]");
    }
    ...
    public static byte[] d(byte[] r5) {
        ...
        L_0x0035:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.igexin.a.a.b.e.d(byte[]):byte[]");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte[] f(byte[] r3, int r4) throws java.lang.RuntimeException {
        /*
            java.io.ByteArrayInputStream r0 = new java.io.ByteArrayInputStream
            r0.<init>(r3)
        ...
        L_0x0028:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.igexin.a.a.b.e.f(byte[], int):byte[]");
    }
}
