...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    public void init() {
        ...
        paint.setColor(Color.rgb(OtaManagerKt.INITIALIZATION_MTU_VALUE, 189, 51));
        ...
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.mNoDataText)) {
                ...
                if (i == 1) {
                    ...
                    center.x = (float) (((double) center.x) * 2.0d);
                    canvas.drawText(this.mNoDataText, center.x, center.y, this.mInfoPaint);
                }
            }
    ...
    public void highlightValue(Highlight highlight, boolean z) {
        ...
        if (highlight == null) {
            ...
            if (this.mLogEnabled) {
                Log.i(LOG_TAG, "Highlighted: " + highlight);
            }
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            /*
                ...
                r1 = 1
                android.graphics.Bitmap$CompressFormat r2 = android.graphics.Bitmap.CompressFormat.PNG     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                r0 = 2
                int[] r2 = $SwitchMap$android$graphics$Bitmap$CompressFormat     // Catch:{ NoSuchFieldError -> 0x001d }
                android.graphics.Bitmap$CompressFormat r3 = android.graphics.Bitmap.CompressFormat.WEBP     // Catch:{ NoSuchFieldError -> 0x001d }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2[r3] = r0     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r2 = $SwitchMap$android$graphics$Bitmap$CompressFormat     // Catch:{ NoSuchFieldError -> 0x0028 }
                android.graphics.Bitmap$CompressFormat r3 = android.graphics.Bitmap.CompressFormat.JPEG     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r4 = 3
                r2[r3] = r4     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                android.graphics.Paint$Align[] r2 = android.graphics.Paint.Align.values()
                int r2 = r2.length
                int[] r2 = new int[r2]
                $SwitchMap$android$graphics$Paint$Align = r2
                android.graphics.Paint$Align r3 = android.graphics.Paint.Align.LEFT     // Catch:{ NoSuchFieldError -> 0x0039 }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x0039 }
                r2[r3] = r1     // Catch:{ NoSuchFieldError -> 0x0039 }
            L_0x0039:
                int[] r1 = $SwitchMap$android$graphics$Paint$Align     // Catch:{ NoSuchFieldError -> 0x0043 }
                android.graphics.Paint$Align r2 = android.graphics.Paint.Align.RIGHT     // Catch:{ NoSuchFieldError -> 0x0043 }
