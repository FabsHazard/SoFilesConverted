...
public class AnimatedZoomJob extends AnimatedViewPortJob implements Animator.AnimatorListener {
    ...
    public static void recycleInstance(AnimatedZoomJob animatedZoomJob) {
        animatedZoomJob.mViewPortHandler = null;
        animatedZoomJob.xValue = 0.0f;
        animatedZoomJob.yValue = 0.0f;
        animatedZoomJob.mTrans = null;
        animatedZoomJob.view = null;
        animatedZoomJob.xOrigin = 0.0f;
        animatedZoomJob.yOrigin = 0.0f;
        animatedZoomJob.yAxis = null;
        animatedZoomJob.xAxisRange = 0.0f;
        pool.recycle(animatedZoomJob);
    }
