    ...
    public void drawDataSet(Canvas canvas, IRadarDataSet iRadarDataSet, int i) {
        ...
        if (iRadarDataSet.isDrawFilledEnabled()) {
            ...
            if (fillDrawable != null) {
                drawFilledPath(canvas2, path, fillDrawable, iRadarDataSet.isDrawClipPathEnabled());
            } else {
                drawFilledPath(canvas, path, iRadarDataSet.getFillColor(), iRadarDataSet.getFillAlpha(), iRadarDataSet.isDrawClipPathEnabled());
            }
        }
