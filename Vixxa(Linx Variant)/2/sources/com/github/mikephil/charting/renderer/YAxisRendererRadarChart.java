...
public class YAxisRendererRadarChart extends YAxisRenderer {
    ...
    public void computeAxisValues(float f, float f2) {
        ...
        if (((int) (roundToNextSignificant / roundToNextSignificant2)) > 5) {
            double d3 = roundToNextSignificant2 * 10.0d;
            if (Math.floor(d3) != Utils.DOUBLE_EPSILON) {
                roundToNextSignificant = Math.floor(d3);
            }
        }
        ...
        if (this.mAxis.isForceLabelsEnabled()) {
            ...
            if (i2 != 0) {
                ...
                for (double d4 = d; d4 <= d2; d4 += roundToNextSignificant) {
                    z++;
                }
            } else {
                z = isCenterAxisLabelsEnabled;
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            for (int i2 = !this.mYAxis.isDrawBottomYLabelEntryEnabled(); i2 < i; i2++) {
                ...
                canvas.drawText(this.mYAxis.getFormattedLabel(i2), instance.x + labelXOffset, instance.y, this.mAxisLabelPaint);
            }
