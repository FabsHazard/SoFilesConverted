...
public class ScatterDataSet extends LineScatterCandleRadarDataSet<Entry> implements IScatterDataSet {
    protected boolean mAttachedToLineDataSet = false;
    ...
    public void setAttachedToLineDataSet(boolean z) {
        this.mAttachedToLineDataSet = z;
        if (z) {
            setColor(0);
        }
    }

    public boolean isAttachedToLineDataSet() {
        return this.mAttachedToLineDataSet;
    }
