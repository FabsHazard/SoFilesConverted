...
public class CombinedData extends BarLineScatterCandleBubbleData<IBarLineScatterCandleBubbleDataSet<? extends Entry>> {
    ...
    public void calcMinMax() {
        if (this.mDataSets == null) {
            this.mDataSets = new CopyOnWriteArrayList();
        }
        ...
        for (ChartData next : getAllData()) {
            next.calcMinMax();
            List<IBarLineScatterCandleBubbleDataSet> dataSets = next.getDataSets();
            ...
            for (IBarLineScatterCandleBubbleDataSet iBarLineScatterCandleBubbleDataSet : dataSets) {
                if (iBarLineScatterCandleBubbleDataSet.getAxisDependency() == YAxis.AxisDependency.LEFT) {
                    if (iBarLineScatterCandleBubbleDataSet.getYMax() > this.mLeftAxisMax) {
                        this.mLeftAxisMax = iBarLineScatterCandleBubbleDataSet.getYMax();
                    }
                    if (iBarLineScatterCandleBubbleDataSet.getYMin() < this.mLeftAxisMin) {
                        this.mLeftAxisMin = iBarLineScatterCandleBubbleDataSet.getYMin();
                    }
                } else {
                    if (iBarLineScatterCandleBubbleDataSet.getYMax() > this.mRightAxisMax) {
                        this.mRightAxisMax = iBarLineScatterCandleBubbleDataSet.getYMax();
                    }
                    if (iBarLineScatterCandleBubbleDataSet.getYMin() < this.mRightAxisMin) {
                        this.mRightAxisMin = iBarLineScatterCandleBubbleDataSet.getYMin();
                    }
                }
            }
        }
