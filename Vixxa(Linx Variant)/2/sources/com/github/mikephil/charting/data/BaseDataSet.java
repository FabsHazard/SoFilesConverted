...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
    ...
    protected List<Float> mGradientPositions;
    ...
    public List<Float> getGradientPositions() {
    ...
    public void setGradientPositions(List<Float> list) {
        this.mGradientPositions = list;
    }
    ...
    public int getIndexInEntries(int i) {
        for (int i2 = 0; i2 < getEntryCount(); i2++) {
            ...
            if (entryForIndex != null && ((float) i) == entryForIndex.getX()) {
                return i2;
            }
        }
        return -1;
    ...
    public boolean contains(T t) {
        for (int i = 0; i < getEntryCount(); i++) {
            Entry entryForIndex = getEntryForIndex(i);
            if (entryForIndex != null && entryForIndex.equals(t)) {
                return true;
            }
        }
        return false;
