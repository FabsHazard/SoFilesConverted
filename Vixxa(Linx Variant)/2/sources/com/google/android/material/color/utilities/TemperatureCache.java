...
public final class TemperatureCache {
    ...
    private List<Hct> getHctsByHue() {
        ...
        ArrayList arrayList = new ArrayList();
        for (double d = Utils.DOUBLE_EPSILON; d <= 360.0d; d += 1.0d) {
    ...
    public /* synthetic */ Double m92lambda$getHctsByTemp$0$comgoogleandroidmaterialcolorutilitiesTemperatureCache(Hct hct) {
