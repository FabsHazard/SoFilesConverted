...
public final class DynamicColor {
    ...
    public double getTone(DynamicScheme dynamicScheme) {
        ...
        boolean z = true;
        boolean z2 = dynamicScheme2.contrastLevel < Utils.DOUBLE_EPSILON;
        if (dynamicScheme2.contrastLevel != Utils.DOUBLE_EPSILON) {
        ...
        if (apply != null) {
            ...
            return calculateDynamicTone(dynamicScheme, this.tone, new DynamicColor$$ExternalSyntheticLambda11(dynamicScheme2), new DynamicColor$$ExternalSyntheticLambda12(doubleValue), new DynamicColor$$ExternalSyntheticLambda13(apply), this.toneDeltaConstraint, new DynamicColor$$ExternalSyntheticLambda14(d2), new DynamicColor$$ExternalSyntheticLambda15(d));
        }
        d = 21.0d;
        return calculateDynamicTone(dynamicScheme, this.tone, new DynamicColor$$ExternalSyntheticLambda11(dynamicScheme2), new DynamicColor$$ExternalSyntheticLambda12(doubleValue), new DynamicColor$$ExternalSyntheticLambda13(apply), this.toneDeltaConstraint, new DynamicColor$$ExternalSyntheticLambda14(d2), new DynamicColor$$ExternalSyntheticLambda15(d));
    }
    ...
    static double ensureToneDelta(double d, double d2, DynamicScheme dynamicScheme, Function<DynamicScheme, ToneDeltaConstraint> function, Function<DynamicColor, Double> function2) {
        ...
        boolean z = true;
        if (i == 1) {
            return MathUtils.clampDouble(Utils.DOUBLE_EPSILON, 100.0d, doubleValue + d3);
        }
        if (i == 2) {
            return MathUtils.clampDouble(Utils.DOUBLE_EPSILON, 100.0d, doubleValue - d3);
        }
