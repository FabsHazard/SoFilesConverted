...
final class ColorResourcesTableCreator {
    ...
    private static class PackageChunk {
        ...
        public void writeTo(ByteArrayOutputStream byteArrayOutputStream) throws IOException {
            ...
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(DeviceModelKt.GLUCOSE_NUM_ONE_DAY));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(this.typeStrings.getChunkSize() + DeviceModelKt.GLUCOSE_NUM_ONE_DAY));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
        ...
        /* access modifiers changed from: package-private */
        public int getChunkSize() {
            return this.typeStrings.getChunkSize() + DeviceModelKt.GLUCOSE_NUM_ONE_DAY + this.keyStrings.getChunkSize() + this.typeSpecChunk.getChunkSizeWithTypeChunk();
        }
    }
