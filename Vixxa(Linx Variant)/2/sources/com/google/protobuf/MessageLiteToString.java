    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (substring.endsWith(LIST_SUFFIX) && !substring.endsWith(BUILDER_LIST_SUFFIX) && !substring.equals(LIST_SUFFIX)) {
                String str2 = substring.substring(0, 1).toLowerCase() + substring.substring(1, substring.length() - LIST_SUFFIX.length());
            ...
            if (substring.endsWith(MAP_SUFFIX) && !substring.equals(MAP_SUFFIX)) {
                String str3 = substring.substring(0, 1).toLowerCase() + substring.substring(1, substring.length() - MAP_SUFFIX.length());
            ...
            if (((Method) hashMap2.get("set" + substring)) != null && (!substring.endsWith(BYTES_SUFFIX) || !hashMap.containsKey("get" + substring.substring(0, substring.length() - BYTES_SUFFIX.length())))) {
