                    ...
                    if (b4 < 0) {
                        ...
                        if (b5 >= 0) {
                            ...
                            if (b6 < 0) {
                                ...
                                i5 = i + 5;
                                byte b7 = bArr[i6];
                                byte b8 = (b6 ^ (b7 << 28)) ^ ByteCompanionObject.MIN_VALUE;
                                if (b7 < 0) {
                                    i6 = i + 6;
                                    if (bArr[i5] < 0) {
                                        i5 = i + 7;
    ...
    private static final class StreamDecoder extends CodedInputStream {
        ...
        private void skipRawBytesSlowPath(int r9) throws java.io.IOException {
            ...
            L_0x001d:
                ...
                long r0 = r1.skip(r4)     // Catch:{ all -> 0x0061 }
                r6 = 0
            ...
            if (this.currentByteBufferLimit != j) {
                ...
                if (b3 >= 0) {
                    ...
                    if (b4 < 0) {
                        ...
                        long j4 = 3 + j;
                        byte b5 = (UnsafeUtil.getByte(j3) << 14) ^ b4;
                        if (b5 >= 0) {
                            b2 = b5 ^ ByteCompanionObject.MIN_VALUE;
                        } else {
                            long j5 = 4 + j;
            ...
            if (this.currentByteBufferLimit != j4) {
                ...
                if (b >= 0) {
                    ...
                    if (b2 < 0) {
                        ...
                        long j7 = 3 + j4;
                        byte b3 = (UnsafeUtil.getByte(j6) << 14) ^ b2;
                        if (b3 >= 0) {
                            j = (long) (b3 ^ ByteCompanionObject.MIN_VALUE);
                            j6 = j7;
                        } else {
                            long j8 = 4 + j4;
                            byte b4 = b3 ^ (UnsafeUtil.getByte(j7) << 21);
                            if (b4 < 0) {
                                j = (long) (-2080896 ^ b4);
                                j6 = j8;
                            } else {
