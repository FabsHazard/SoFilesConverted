    ...
    static final class UnsafeProcessor extends Processor {
        ...
        public int partialIsValidUtf8(int r11, byte[] r12, int r13, int r14) {
            ...
            L_0x0010:
                ...
                long r6 = r6 + r0
                byte r11 = com.google.protobuf.UnsafeUtil.getByte((byte[]) r12, (long) r0)
            ...
            L_0x005e:
                ...
                long r8 = r0 + r6
                byte r3 = com.google.protobuf.UnsafeUtil.getByte((byte[]) r12, (long) r0)
        ...
        public String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
                ...
                int i4 = 0;
                while (r11 < i3) {
                    byte b = UnsafeUtil.getByte(bArr, (long) r11);
                    if (!DecodeUtil.isOneByte(b)) {
                        break;
                    }
                    i = r11 + 1;
                ...
                while (r11 < i3) {
                    ...
                    if (DecodeUtil.isOneByte(b2)) {
                        ...
                        int i9 = r11 + 3;
                        r11 += 4;
                        DecodeUtil.handleFourBytes(b2, b4, UnsafeUtil.getByte(bArr, (long) (r11 + 2)), UnsafeUtil.getByte(bArr, (long) i9), cArr, i5);
                        i5 += 2;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
        ...
        public void encodeUtf8Direct(java.lang.CharSequence r28, java.nio.ByteBuffer r29) {
            /*
                ...
                r0 = r28
                r1 = r29
                long r2 = com.google.protobuf.UnsafeUtil.addressOffset(r29)
                int r4 = r29.position()
                long r4 = (long) r4
                long r4 = r4 + r2
                int r6 = r29.limit()
