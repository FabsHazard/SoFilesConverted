...
public class ISO8601Utils {
    ...
    public static Date parse(String str, ParsePosition parsePosition) throws ParseException {
        ...
        try {
            ...
            int i6 = index + 4;
            int parseInt = parseInt(str2, index, i6);
            if (checkOffset(str2, i6, Soundex.SILENT_MARKER)) {
                i6 = index + 5;
            }
            int i7 = i6 + 2;
            int parseInt2 = parseInt(str2, i6, i7);
            if (checkOffset(str2, i7, Soundex.SILENT_MARKER)) {
                i7 = i6 + 3;
            }
            int i8 = i7 + 2;
            int parseInt3 = parseInt(str2, i7, i8);
            boolean checkOffset = checkOffset(str2, i8, 'T');
            if (checkOffset || str.length() > i8) {
                if (checkOffset) {
                    int i9 = i7 + 5;
                    int parseInt4 = parseInt(str2, i7 + 3, i9);
                    if (checkOffset(str2, i9, ':')) {
                        i9 = i7 + 6;
                    }
                    int i10 = i9 + 2;
                    int parseInt5 = parseInt(str2, i9, i10);
                    if (checkOffset(str2, i10, ':')) {
                        i10 = i9 + 3;
                    }
                    if (str.length() <= i10 || (charAt = str2.charAt(i10)) == 'Z' || charAt == '+' || charAt == '-') {
                        i3 = parseInt5;
                        i2 = 0;
                        i = 0;
                        int i11 = parseInt4;
                        ...
                        int i12 = i10 + 2;
                        i = parseInt(str2, i10, i12);
                        if (i > 59 && i < 63) {
                            i = 59;
                        }
                        if (checkOffset(str2, i12, '.')) {
                            int i13 = i10 + 3;
                            int indexOfNonDigit = indexOfNonDigit(str2, i10 + 4);
                            int min = Math.min(indexOfNonDigit, i10 + 6);
                            int parseInt6 = parseInt(str2, i13, min);
                            int i14 = min - i13;
                            if (i14 == 1) {
                                parseInt6 *= 100;
                            } else if (i14 == 2) {
