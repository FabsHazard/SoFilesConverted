...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent {
    ...
    public void setStateDirectLoading(boolean z) {
        if (this.mState != RefreshState.Loading) {
            ...
            if (onLoadMoreListener != null) {
                ...
                finishLoadMore((int) MessageHandler.WHAT_SMOOTH_SCROLL);
            }
    ...
    protected class FlingRunnable implements Runnable {
        ...
        public java.lang.Runnable start() {
            ...
            L_0x0075:
                ...
                com.scwang.smart.refresh.layout.SmartRefreshLayout r2 = com.scwang.smart.refresh.layout.SmartRefreshLayout.this
                int r2 = r2.mSpinner
                float r3 = r11.mVelocity
                r4 = 0
            L_0x0080:
                int r5 = r2 * r0
                if (r5 <= 0) goto L_0x00d4
                double r5 = (double) r3
                float r3 = r11.mDamping
                double r7 = (double) r3
                int r4 = r4 + 1
                int r3 = r11.mFrameDelay
                int r3 = r3 * r4
                float r3 = (float) r3
    ...
    public void moveSpinnerInfinitely(float f) {
        ...
        if (this.mState == RefreshState.TwoLevel && f2 > 0.0f) {
            ...
            this.mKernel.moveSpinner((int) (-Math.min(d10 * (1.0d - Math.pow(100.0d, (-d11) / (max6 == Utils.DOUBLE_EPSILON ? 1.0d : max6))), d11)), true);
        }
            ...
            this.mHandler.postDelayed(new Runnable() {
                public void run() {
                    if (SmartRefreshLayout.this.mLoadMoreListener != null) {
                        ...
                        SmartRefreshLayout.this.finishLoadMore((int) MessageHandler.WHAT_SMOOTH_SCROLL);
                    }
                ...
                if (onFinish < Integer.MAX_VALUE) {
                    ...
                    SmartRefreshLayout.this.mHandler.postDelayed(new Runnable() {
                        public void run() {
                            ...
                            AnonymousClass1 r3 = new AnimatorListenerAdapter() {
                                public void onAnimationEnd(Animator animator) {
                                    if (animator == null || animator.getDuration() != 0) {
                                        SmartRefreshLayout.this.mFooterLocked = false;
                                        if (z2) {
                            ...
                            if (valueAnimator != null) {
                                ...
                                r3.onAnimationEnd((Animator) null);
                            }
                        }
