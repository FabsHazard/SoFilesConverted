...
public class BottomMenuArrayAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.spaceDialogxRightPadding = (Space) view2.findViewById(R.id.space_dialogx_right_padding);
        ...
        if (this.bottomMenu.getMenuMenuItemLayoutRefreshCallback() != null) {
            this.bottomMenu.getMenuMenuItemLayoutRefreshCallback().getView(this.bottomMenu, i, view2, viewGroup);
        }
        return view2;
    }
