...
public class TextInfo {
    ...
    public int getFontSizeComplexUnit() {
        ...
        int i = AnonymousClass1.$SwitchMap$com$kongzue$dialogx$util$TextInfo$FONT_SIZE_UNIT[this.fontSizeUnit.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i != 2) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.kongzue.dialogx.util.TextInfo.AnonymousClass1.<clinit>():void");
        }
    }
