...
public final class Downsampler {
    ...
    private Bitmap decodeFromWrappedStreams(ImageReader imageReader, BitmapFactory.Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, PreferredColorSpace preferredColorSpace, boolean z, int i, int i2, boolean z2, DecodeCallbacks decodeCallbacks) throws IOException {
        ...
        int i14 = imageOrientation;
        ImageReader imageReader3 = imageReader2;
        calculateConfig(imageReader, decodeFormat, z3, isExifOrientationRequired, options, i3, i11);
        ...
        if (shouldUsePool(imageType2)) {
            if (i13 < 0 || i12 < 0 || !z2) {
                ...
                if (Log.isLoggable(TAG, 2)) {
                    Log.v(TAG, "Calculated target [" + i7 + "x" + i6 + "] for source [" + i13 + "x" + i12 + "], sampleSize: " + i16 + ", targetDensity: " + options3.inTargetDensity + ", density: " + options3.inDensity + ", density multiplier: " + f);
                }
            } else {
                i7 = i3;
                i6 = i11;
        ...
        if (preferredColorSpace3 != null) {
            if (Build.VERSION.SDK_INT >= 28) {
                options3.inPreferredColorSpace = ColorSpace.get((preferredColorSpace3 != PreferredColorSpace.DISPLAY_P3 || options3.outColorSpace == null || !options3.outColorSpace.isWideGamut()) ? ColorSpace.Named.SRGB : ColorSpace.Named.DISPLAY_P3);
