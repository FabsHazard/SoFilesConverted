...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r7, com.bumptech.glide.load.DataSource r8, boolean r9) {
        /*
            ...
            r2.throwIfRecycled()
            r2 = 0
            java.lang.Object r3 = r6.requestLock     // Catch:{ all -> 0x00c5 }
            monitor-enter(r3)     // Catch:{ all -> 0x00c5 }
            r6.loadStatus = r2     // Catch:{ all -> 0x00c2 }
            if (r7 != 0) goto L_0x0030
            com.bumptech.glide.load.engine.GlideException r7 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00c2 }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ all -> 0x00c2 }
            r8.<init>(r1)     // Catch:{ all -> 0x00c2 }
            java.lang.Class<R> r9 = r6.transcodeClass     // Catch:{ all -> 0x00c2 }
            java.lang.StringBuilder r8 = r8.append(r9)     // Catch:{ all -> 0x00c2 }
            ...
            r6.onLoadFailed(r7)     // Catch:{ all -> 0x00c2 }
            monitor-exit(r3)     // Catch:{ all -> 0x00c2 }
            return
        L_0x0030:
            java.lang.Object r1 = r7.get()     // Catch:{ all -> 0x00c2 }
            if (r1 == 0) goto L_0x0064
            java.lang.Class<R> r4 = r6.transcodeClass     // Catch:{ all -> 0x00c2 }
            java.lang.Class r5 = r1.getClass()     // Catch:{ all -> 0x00c2 }
            boolean r4 = r4.isAssignableFrom(r5)     // Catch:{ all -> 0x00c2 }
            if (r4 != 0) goto L_0x0043
            goto L_0x0064
        L_0x0043:
            boolean r0 = r6.canSetResource()     // Catch:{ all -> 0x00c2 }
            if (r0 != 0) goto L_0x005f
            r6.resource = r2     // Catch:{ all -> 0x00be }
            com.bumptech.glide.request.SingleRequest$Status r8 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch:{ all -> 0x00be }
            r6.status = r8     // Catch:{ all -> 0x00be }
            java.lang.String r8 = "GlideRequest"
            int r9 = r6.cookie     // Catch:{ all -> 0x00be }
            com.bumptech.glide.util.pool.GlideTrace.endSectionAsync(r8, r9)     // Catch:{ all -> 0x00be }
        ...
        L_0x005e:
            return
        L_0x005f:
            r6.onResourceReady(r7, r1, r8, r9)     // Catch:{ all -> 0x00c2 }
            monitor-exit(r3)     // Catch:{ all -> 0x00c2 }
            return
        L_0x0064:
            r6.resource = r2     // Catch:{ all -> 0x00be }
            com.bumptech.glide.load.engine.GlideException r8 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00be }
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x00be }
            r9.<init>(r0)     // Catch:{ all -> 0x00be }
            java.lang.Class<R> r0 = r6.transcodeClass     // Catch:{ all -> 0x00be }
            java.lang.StringBuilder r9 = r9.append(r0)     // Catch:{ all -> 0x00be }
            java.lang.String r0 = " but instead got "
            java.lang.StringBuilder r9 = r9.append(r0)     // Catch:{ all -> 0x00be }
            if (r1 == 0) goto L_0x0080
            java.lang.Class r0 = r1.getClass()     // Catch:{ all -> 0x00be }
            goto L_0x0082
        L_0x0080:
            java.lang.String r0 = ""
        L_0x0082:
            ...
            java.lang.String r0 = "{"
            java.lang.StringBuilder r9 = r9.append(r0)     // Catch:{ all -> 0x00be }
            java.lang.StringBuilder r9 = r9.append(r1)     // Catch:{ all -> 0x00be }
            java.lang.String r0 = "} inside Resource{"
            java.lang.StringBuilder r9 = r9.append(r0)     // Catch:{ all -> 0x00be }
            java.lang.StringBuilder r9 = r9.append(r7)     // Catch:{ all -> 0x00be }
            java.lang.String r0 = "}."
            java.lang.StringBuilder r9 = r9.append(r0)     // Catch:{ all -> 0x00be }
        ...
        L_0x00a7:
            ...
            r6.onLoadFailed(r8)     // Catch:{ all -> 0x00be }
            monitor-exit(r3)     // Catch:{ all -> 0x00be }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x00b0 A[Catch:{ all -> 0x00c8 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r10, R r11, com.bumptech.glide.load.DataSource r12, boolean r13) {
        ...
        L_0x0073:
            ...
            r6 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r9.requestListeners     // Catch:{ all -> 0x00c8 }
            if (r0 == 0) goto L_0x0099
            java.util.Iterator r7 = r0.iterator()     // Catch:{ all -> 0x00c8 }
            r8 = r6
        L_0x0080:
            boolean r0 = r7.hasNext()     // Catch:{ all -> 0x00c8 }
            if (r0 == 0) goto L_0x009a
            java.lang.Object r0 = r7.next()     // Catch:{ all -> 0x00c8 }
            com.bumptech.glide.request.RequestListener r0 = (com.bumptech.glide.request.RequestListener) r0     // Catch:{ all -> 0x00c8 }
            java.lang.Object r2 = r9.model     // Catch:{ all -> 0x00c8 }
            com.bumptech.glide.request.target.Target<R> r3 = r9.target     // Catch:{ all -> 0x00c8 }
            r1 = r11
            r4 = r12
            r5 = r13
            boolean r0 = r0.onResourceReady(r1, r2, r3, r4, r5)     // Catch:{ all -> 0x00c8 }
            r8 = r8 | r0
            goto L_0x0080
        L_0x0099:
            r8 = r6
        L_0x009a:
            com.bumptech.glide.request.RequestListener<R> r0 = r9.targetListener     // Catch:{ all -> 0x00c8 }
        ...
        L_0x00ad:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r10 = r9.animationFactory     // Catch:{ all -> 0x00c8 }
            com.bumptech.glide.request.transition.Transition r10 = r10.build(r12, r13)     // Catch:{ all -> 0x00c8 }
            com.bumptech.glide.request.target.Target<R> r12 = r9.target     // Catch:{ all -> 0x00c8 }
            r12.onResourceReady(r11, r10)     // Catch:{ all -> 0x00c8 }
        L_0x00bb:
