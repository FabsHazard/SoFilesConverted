...
public class PeriodFormatterBuilder {
    ...
    static class FieldFormatter implements PeriodPrinter, PeriodParser {
        ...
        public int parseInto(ReadWritablePeriod readWritablePeriod, String str, int i, Locale locale) {
            ...
            if (periodFieldAffix2 != null) {
                i5 = periodFieldAffix2.parse(str2, i5);
                if (i5 < 0) {
                    return !z ? ~i5 : i5;
                }
                z = true;
            ...
            if (periodFieldAffix3 == null || z) {
                ...
                i2 = periodFieldAffix3.scan(str2, i5);
                if (i2 < 0) {
                    return !z ? ~i2 : i2;
                }
                z = true;
            ...
            if (i10 != 8 && i10 != 9) {
                setFieldValue(readWritablePeriod2, i10, parseInt(str2, i5, i7));
            } else if (i6 < 0) {
                setFieldValue(readWritablePeriod2, 6, parseInt(str2, i5, i7));
                setFieldValue(readWritablePeriod2, 7, 0);
            } else {
                int i11 = 0;
                int parseInt = parseInt(str2, i5, (i6 - i5) - 1);
                setFieldValue(readWritablePeriod2, 6, parseInt);
                int i12 = (i5 + i7) - i6;
                if (i12 > 0) {
                    if (i12 >= 3) {
                        i11 = parseInt(str2, i6, 3);
                    } else {
                        int parseInt2 = parseInt(str2, i6, i12);
                        i11 = i12 == 1 ? parseInt2 * 100 : parseInt2 * 10;
                    }
                    if (z3 || parseInt < 0) {
                        i11 = -i11;
                    }
                }
                setFieldValue(readWritablePeriod2, 7, i11);
            }
            int i13 = i5 + i7;
