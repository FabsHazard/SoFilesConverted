...
public class ISODateTimeFormat {
        ...
        if (collection.remove(DateTimeFieldType.year())) {
            ...
            if (collection.remove(DateTimeFieldType.monthOfYear())) {
                if (collection.remove(DateTimeFieldType.dayOfMonth())) {
                    ...
                    dateTimeFormatterBuilder.appendLiteral((char) Soundex.SILENT_MARKER);
                    dateTimeFormatterBuilder.appendMonthOfYear(2);
                    return true;
                }
    ...
    static final class Constants {
        ...
        private static DateTimeFormatter monthElement() {
            ...
            return dateTimeFormatter == null ? new DateTimeFormatterBuilder().appendLiteral((char) Soundex.SILENT_MARKER).appendMonthOfYear(2).toFormatter() : dateTimeFormatter;
        }

        private static DateTimeFormatter dayOfMonthElement() {
            DateTimeFormatter dateTimeFormatter = dme;
            return dateTimeFormatter == null ? new DateTimeFormatterBuilder().appendLiteral((char) Soundex.SILENT_MARKER).appendDayOfMonth(2).toFormatter() : dateTimeFormatter;
        }
        ...
        private static DateTimeFormatter dayOfWeekElement() {
            ...
            return dateTimeFormatter == null ? new DateTimeFormatterBuilder().appendLiteral((char) Soundex.SILENT_MARKER).appendDayOfWeek(1).toFormatter() : dateTimeFormatter;
        }

        private static DateTimeFormatter dayOfYearElement() {
            DateTimeFormatter dateTimeFormatter = dye;
            return dateTimeFormatter == null ? new DateTimeFormatterBuilder().appendLiteral((char) Soundex.SILENT_MARKER).appendDayOfYear(3).toFormatter() : dateTimeFormatter;
        }
