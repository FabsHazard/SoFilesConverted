...
public final class Minutes extends BaseSingleFieldPeriod {
    ...
    public static Minutes minutes(int i) {
        ...
        if (i != 2) {
            return i != 3 ? new Minutes(i) : THREE;
        }
        return TWO;
    }
    ...
    public static Minutes standardMinutesIn(ReadablePeriod readablePeriod) {
        return minutes(BaseSingleFieldPeriod.standardPeriodIn(readablePeriod, TimeUtils.oneMinuteMillis));
    }
    ...
    public Duration toStandardDuration() {
        return new Duration(((long) getValue()) * TimeUtils.oneMinuteMillis);
    }
