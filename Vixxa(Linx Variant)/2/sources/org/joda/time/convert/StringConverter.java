            ...
            if (substring.length() > 0) {
                ...
                if (substring2.length() > 0) {
                    ...
                    if (charAt2 != 'P' && charAt2 != 'p') {
                        ...
                        if (period != null) {
                            j = chronology3.add((ReadablePeriod) period, j2, -1);
                        }
                    } else if (period == null) {
                        ...
                        j2 = chronology3.add((ReadablePeriod) parsePeriod, j, 1);
                    } else {
                        throw new IllegalArgumentException("Interval composed of two durations: " + str);
                    }
                    readWritableInterval2.setInterval(j, j2);
