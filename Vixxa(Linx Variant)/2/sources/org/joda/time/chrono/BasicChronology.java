...
abstract class BasicChronology extends AssembledChronology {
    ...
    static {
        ...
        PreciseDurationField preciseDurationField2 = new PreciseDurationField(DurationFieldType.minutes(), TimeUtils.oneMinuteMillis);
        ...
        PreciseDurationField preciseDurationField5 = new PreciseDurationField(DurationFieldType.days(), TimeUtils.oneDayMillis);
    ...
    public long getFirstWeekOfYearMillis(int i) {
        ...
        return dayOfWeek > 8 - this.iMinDaysInFirstWeek ? yearMillis + (((long) (8 - dayOfWeek)) * TimeUtils.oneDayMillis) : yearMillis - (((long) (dayOfWeek - 1)) * TimeUtils.oneDayMillis);
    }
    ...
    public long getYearMonthDayMillis(int i, int i2, int i3) {
        return getYearMillis(i) + getTotalMillisByYearMonth(i, i2) + (((long) (i3 - 1)) * TimeUtils.oneDayMillis);
    }
    ...
    public int getDayOfMonth(long j, int i, int i2) {
        return ((int) ((j - (getYearMillis(i) + getTotalMillisByYearMonth(i, i2))) / TimeUtils.oneDayMillis)) + 1;
    }
    ...
    public int getDayOfYear(long j, int i) {
        return ((int) ((j - getYearMillis(i)) / TimeUtils.oneDayMillis)) + 1;
    }
    ...
    public int getDayOfWeek(long j) {
        long j2;
        if (j >= 0) {
            j2 = j / TimeUtils.oneDayMillis;
        } else {
            j2 = (j - 86399999) / TimeUtils.oneDayMillis;
            if (j2 < -3) {
                return ((int) ((j2 + 4) % 7)) + 7;
            }
        }
    ...
    public int getMillisOfDay(long j) {
        if (j >= 0) {
            return (int) (j % TimeUtils.oneDayMillis);
        }
        return ((int) ((j + 1) % TimeUtils.oneDayMillis)) + 86399999;
    }
