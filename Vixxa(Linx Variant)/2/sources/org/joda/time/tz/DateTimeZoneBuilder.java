...
public class DateTimeZoneBuilder {
    ...
    static void writeMillis(DataOutput dataOutput, long j) throws IOException {
        ...
        if (j % TimeUtils.oneMinuteMillis == 0) {
            long j3 = j / TimeUtils.oneMinuteMillis;
            if (((j3 << 34) >> 34) == j3) {
                dataOutput.writeInt(((int) (LockFreeTaskQueueCore.HEAD_MASK & j3)) | BasicMeasure.EXACTLY);
                return;
            }
        }
        if (j % 1000 == 0) {
    ...
    private static final class DSTZone extends DateTimeZone {
        ...
        public long nextTransition(long r9) {
            ...
            L_0x0018:
                r5 = r9
            L_0x0019:
                int r1 = r1.getSaveMillis()     // Catch:{ ArithmeticException | IllegalArgumentException -> 0x002b }
                long r0 = r2.next(r9, r0, r1)     // Catch:{ ArithmeticException | IllegalArgumentException -> 0x002b }
        ...
        public long previousTransition(long r11) {
            ...
            L_0x001b:
                r7 = r11
            L_0x001c:
                int r3 = r3.getSaveMillis()     // Catch:{ ArithmeticException | IllegalArgumentException -> 0x002e }
                long r2 = r4.previous(r11, r2, r3)     // Catch:{ ArithmeticException | IllegalArgumentException -> 0x002e }
