...
public class DefaultNameProvider implements NameProvider {
    ...
    private synchronized java.lang.String[] getNameSet(java.util.Locale r10, java.lang.String r11, java.lang.String r12) {
        /*
            ...
            goto L_0x00d1
        L_0x000a:
            java.util.HashMap<java.util.Locale, java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.Object>>> r1 = r9.iByLocaleCache     // Catch:{ all -> 0x00ce }
            java.lang.Object r1 = r1.get(r10)     // Catch:{ all -> 0x00ce }
            java.util.Map r1 = (java.util.Map) r1     // Catch:{ all -> 0x00ce }
            if (r1 != 0) goto L_0x001e
            java.util.HashMap<java.util.Locale, java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.Object>>> r1 = r9.iByLocaleCache     // Catch:{ all -> 0x00ce }
            java.util.HashMap r2 = r9.createCache()     // Catch:{ all -> 0x00ce }
            r1.put(r10, r2)     // Catch:{ all -> 0x00ce }
            r1 = r2
        L_0x001e:
            java.lang.Object r2 = r1.get(r11)     // Catch:{ all -> 0x00ce }
            java.util.Map r2 = (java.util.Map) r2     // Catch:{ all -> 0x00ce }
            if (r2 != 0) goto L_0x00c4
            java.util.HashMap r2 = r9.createCache()     // Catch:{ all -> 0x00ce }
            r1.put(r11, r2)     // Catch:{ all -> 0x00ce }
            java.util.Locale r1 = java.util.Locale.ENGLISH     // Catch:{ all -> 0x00ce }
            java.text.DateFormatSymbols r1 = org.joda.time.DateTimeUtils.getDateFormatSymbols(r1)     // Catch:{ all -> 0x00ce }
            java.lang.String[][] r1 = r1.getZoneStrings()     // Catch:{ all -> 0x00ce }
            int r3 = r1.length     // Catch:{ all -> 0x00ce }
            r4 = 0
            r5 = r4
        L_0x003a:
            r6 = 5
            if (r5 >= r3) goto L_0x0050
            r7 = r1[r5]     // Catch:{ all -> 0x00ce }
            if (r7 == 0) goto L_0x004d
            int r8 = r7.length     // Catch:{ all -> 0x00ce }
            if (r8 < r6) goto L_0x004d
            r8 = r7[r4]     // Catch:{ all -> 0x00ce }
            boolean r8 = r11.equals(r8)     // Catch:{ all -> 0x00ce }
        ...
        L_0x0050:
            r7 = r0
        L_0x0051:
            java.text.DateFormatSymbols r10 = org.joda.time.DateTimeUtils.getDateFormatSymbols(r10)     // Catch:{ all -> 0x00ce }
            java.lang.String[][] r10 = r10.getZoneStrings()     // Catch:{ all -> 0x00ce }
            int r1 = r10.length     // Catch:{ all -> 0x00ce }
            r3 = r4
        L_0x005b:
            if (r3 >= r1) goto L_0x0071
            r5 = r10[r3]     // Catch:{ all -> 0x00ce }
            if (r5 == 0) goto L_0x006e
            int r8 = r5.length     // Catch:{ all -> 0x00ce }
            if (r8 < r6) goto L_0x006e
            r8 = r5[r4]     // Catch:{ all -> 0x00ce }
            boolean r8 = r11.equals(r8)     // Catch:{ all -> 0x00ce }
        ...
        L_0x0071:
            ...
            r10 = 2
            r11 = r7[r10]     // Catch:{ all -> 0x00ce }
            java.lang.String[] r1 = new java.lang.String[r10]     // Catch:{ all -> 0x00ce }
            r3 = r0[r10]     // Catch:{ all -> 0x00ce }
            r1[r4] = r3     // Catch:{ all -> 0x00ce }
            r3 = 1
            r5 = r0[r3]     // Catch:{ all -> 0x00ce }
            r1[r3] = r5     // Catch:{ all -> 0x00ce }
            r2.put(r11, r1)     // Catch:{ all -> 0x00ce }
            r11 = r7[r10]     // Catch:{ all -> 0x00ce }
            r1 = 4
            r5 = r7[r1]     // Catch:{ all -> 0x00ce }
            boolean r11 = r11.equals(r5)     // Catch:{ all -> 0x00ce }
            r5 = 3
            if (r11 == 0) goto L_0x00b5
            java.lang.StringBuilder r11 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ce }
            r11.<init>()     // Catch:{ all -> 0x00ce }
            r6 = r7[r1]     // Catch:{ all -> 0x00ce }
            java.lang.StringBuilder r11 = r11.append(r6)     // Catch:{ all -> 0x00ce }
            java.lang.String r6 = "-Summer"
            java.lang.StringBuilder r11 = r11.append(r6)     // Catch:{ all -> 0x00ce }
            java.lang.String r11 = r11.toString()     // Catch:{ all -> 0x00ce }
            java.lang.String[] r10 = new java.lang.String[r10]     // Catch:{ all -> 0x00ce }
            r1 = r0[r1]     // Catch:{ all -> 0x00ce }
            r10[r4] = r1     // Catch:{ all -> 0x00ce }
            r0 = r0[r5]     // Catch:{ all -> 0x00ce }
            r10[r3] = r0     // Catch:{ all -> 0x00ce }
            r2.put(r11, r10)     // Catch:{ all -> 0x00ce }
            goto L_0x00c4
        L_0x00b5:
            r11 = r7[r1]     // Catch:{ all -> 0x00ce }
            java.lang.String[] r10 = new java.lang.String[r10]     // Catch:{ all -> 0x00ce }
            r1 = r0[r1]     // Catch:{ all -> 0x00ce }
            r10[r4] = r1     // Catch:{ all -> 0x00ce }
            r0 = r0[r5]     // Catch:{ all -> 0x00ce }
            ...
            r2.put(r11, r10)     // Catch:{ all -> 0x00ce }
        L_0x00c4:
            java.lang.Object r10 = r2.get(r12)     // Catch:{ all -> 0x00ce }
            java.lang.String[] r10 = (java.lang.String[]) r10     // Catch:{ all -> 0x00ce }
            java.lang.String[] r10 = (java.lang.String[]) r10     // Catch:{ all -> 0x00ce }
            monitor-exit(r9)
            return r10
        L_0x00ce:
