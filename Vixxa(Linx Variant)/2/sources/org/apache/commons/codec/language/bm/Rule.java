...
public class Rule {
    ...
    static {
        ...
        L_0x0086:
            ...
            java.lang.String r13 = createResourceName(r4, r9, r11)     // Catch:{ all -> 0x00a5 }
            java.util.Map r13 = parseRules(r12, r13)     // Catch:{ all -> 0x00a5 }
            r10.put(r11, r13)     // Catch:{ all -> 0x00a5 }
    ...
    private static PhonemeExpr parsePhonemeExpr(String str) {
        ...
        if (str.endsWith(")")) {
            ...
            if (substring.startsWith(Logger.c) || substring.endsWith(Logger.c)) {
