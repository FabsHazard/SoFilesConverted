...
public class DoubleMetaphone implements StringEncoder {
            ...
            if (contains(str, i2, 2, "LI") && !z) {
                ...
                if (contains(str, i2, 2, "ER") || charAt(str, i2) == 'Y') {
                    if (!contains(str, 0, 6, "DANGER", "RANGER", "MANGER")) {
                        int i3 = i - 1;
                        if (!contains(str, i3, 1, ExifInterface.LONGITUDE_EAST, "I")) {
        ...
        if (charAt(str, i2) == 'H') {
            ...
            if (contains(str, i3, 2, "OO", "ER", "EN", "UY", "ED", "EM")) {
                if (contains(str, i3, 2, "ER", "EN")) {
                    doubleMetaphoneResult.append(OtaManagerKt.AIDEX_VERSION, "SK");
                } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x0031, code lost:
        if (contains(r10, r12, 2, "WH") != false) goto L_0x0033;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private int handleW(java.lang.String r10, org.apache.commons.codec.language.DoubleMetaphone.DoubleMetaphoneResult r11, int r12) {
        ...
        L_0x0085:
            ...
            r11.append((java.lang.String) r10, (java.lang.String) r0)
            int r12 = r12 + r5
            goto L_0x00a2
        L_0x009e:
            r11.appendAlternate((char) r1)
        L_0x00a1:
            int r12 = r12 + r0
        L_0x00a2:
            return r12
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x0036, code lost:
        if (contains(r7, r9 - 2, 2, "AU", com.huawei.hms.feature.dynamic.f.e.d) == false) goto L_0x0038;
     */
