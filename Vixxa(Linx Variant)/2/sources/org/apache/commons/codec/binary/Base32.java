            ...
            if (context2.eof && context2.modulus > 0) {
                ...
                switch (context2.modulus) {
                    ...
                    case 3:
                        ...
                        context2.pos = i12 + 1;
                        ensureBufferSize2[i12] = (byte) ((int) ((context2.lbitWorkArea >> MASK_3BITS) & 255));
                        return;
                    case 4:
                        ...
                        context2.pos = i13 + 1;
                        ensureBufferSize2[i13] = (byte) ((int) ((context2.lbitWorkArea >> 8) & 255));
                        int i14 = context2.pos;
                        context2.pos = i14 + 1;
                        ensureBufferSize2[i14] = (byte) ((int) (context2.lbitWorkArea & 255));
                        return;
                    case 5:
                        ...
                        context2.pos = i15 + 1;
                        ensureBufferSize2[i15] = (byte) ((int) ((context2.lbitWorkArea >> 16) & 255));
                        int i16 = context2.pos;
                        context2.pos = i16 + 1;
                        ensureBufferSize2[i16] = (byte) ((int) ((context2.lbitWorkArea >> 8) & 255));
                        int i17 = context2.pos;
                        context2.pos = i17 + 1;
                        ensureBufferSize2[i17] = (byte) ((int) (context2.lbitWorkArea & 255));
                        return;
                    case 6:
                        validateTrailingCharacters();
                        ...
                        context2.pos = i18 + 1;
                        ensureBufferSize2[i18] = (byte) ((int) ((context2.lbitWorkArea >> 16) & 255));
                        int i19 = context2.pos;
                        context2.pos = i19 + 1;
                        ensureBufferSize2[i19] = (byte) ((int) ((context2.lbitWorkArea >> 8) & 255));
                        int i20 = context2.pos;
                        context2.pos = i20 + 1;
                        ensureBufferSize2[i20] = (byte) ((int) (context2.lbitWorkArea & 255));
                        return;
                    case 7:
                        ...
                        context2.pos = i21 + 1;
                        ensureBufferSize2[i21] = (byte) ((int) ((context2.lbitWorkArea >> 24) & 255));
                        int i22 = context2.pos;
                        context2.pos = i22 + 1;
                        ensureBufferSize2[i22] = (byte) ((int) ((context2.lbitWorkArea >> 16) & 255));
                        int i23 = context2.pos;
                        context2.pos = i23 + 1;
                        ensureBufferSize2[i23] = (byte) ((int) ((context2.lbitWorkArea >> 8) & 255));
                        int i24 = context2.pos;
                        context2.pos = i24 + 1;
                        ensureBufferSize2[i24] = (byte) ((int) (context2.lbitWorkArea & 255));
                        return;
                    default:
                ...
                context2.pos = i25 + 1;
                ensureBufferSize2[i25] = (byte) ((int) ((context2.lbitWorkArea >> 2) & 255));
            }
        }
    }
