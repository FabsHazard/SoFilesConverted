...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1665getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1666minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1816minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1664elapsedNowUwyO8pc() {
        return Duration.m1711minusLRDsOJo(this.mark.m1813elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1667plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1712plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
