...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m413constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m424setVurrAj0(r0, i, r2.m411unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m492constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m503setVXSXFK8(r0, i, r2.m490unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m571constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m582setk8EXiF4(r0, i, r2.m569unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m676constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m687set01HTLdE(r0, i, r2.m674unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m438constructorimpl(i + r1.m490unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m517constructorimpl(j + r2.m569unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m438constructorimpl(i + UInt.m438constructorimpl(r1.m411unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m438constructorimpl(i + UInt.m438constructorimpl(r1.m674unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
