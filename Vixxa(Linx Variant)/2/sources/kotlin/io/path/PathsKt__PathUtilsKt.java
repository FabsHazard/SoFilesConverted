...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getInvariantSeparatorsPathString(Path path) {
        ...
        if (Intrinsics.areEqual((Object) separator, (Object) InternalZipConstants.ZIP_FILE_SEPARATOR)) {
            return path.toString();
        }
        String obj = path.toString();
        Intrinsics.checkNotNull(separator);
        return StringsKt.replace$default(obj, separator, InternalZipConstants.ZIP_FILE_SEPARATOR, false, 4, (Object) null);
    }
