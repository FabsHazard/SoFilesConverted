...
public final class CacheByClassKt {
    ...
    static {
        ...
        try {
            ...
            z = Result.m343constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            z = Result.m343constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m350isSuccessimpl(z)) {
            Result.Companion companion3 = Result.Companion;
            Class cls = (Class) z;
            z = true;
        }
        Object r0 = Result.m343constructorimpl(z);
        if (Result.m349isFailureimpl(r0)) {
            r0 = false;
        }
