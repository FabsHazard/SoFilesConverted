    ...
    public static final class Companion {
        ...
        public final TypeAliasConstructorDescriptor createIfAvailable(StorageManager storageManager, TypeAliasDescriptor typeAliasDescriptor, ClassConstructorDescriptor classConstructorDescriptor) {
            ...
            if (classDescriptor != null) {
                ...
                for (ReceiverParameterDescriptor receiverParameterDescriptor3 : iterable) {
                    ...
                    arrayList.add(DescriptorFactory.createContextReceiverParameterForClass(classDescriptor, safeSubstitute, ((ImplicitContextReceiver) value).getCustomLabelName(), Annotations.Companion.getEMPTY()));
                }
                list = (List) arrayList;
            } else {
