...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
        ...
        private static /* synthetic */ void $$$reportNull$$$0(int i) {
            ...
            switch (i2) {
                ...
                case 19:
                    ...
                    break;
                case 4:
                    objArr[0] = TransmitterActivityKt.OPERATION_TYPE;
                    break;
                case 6:
                    objArr[0] = "modality";
                    break;
    ...
    public PropertyDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        if (this.backingField == null) {
            ...
            fieldDescriptorImpl = new FieldDescriptorImpl(this.backingField.getAnnotations(), createSubstitutedCopy);
        }
        if (this.delegateField != null) {
            fieldDescriptorImpl2 = new FieldDescriptorImpl(this.delegateField.getAnnotations(), createSubstitutedCopy);
        }
