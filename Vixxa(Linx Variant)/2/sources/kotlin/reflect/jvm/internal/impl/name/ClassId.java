...
public final class ClassId {
    ...
    public String asString() {
        ...
        String str = this.packageFqName.asString().replace('.', '/') + InternalZipConstants.ZIP_FILE_SEPARATOR + this.relativeClassName.asString();
        if (str == null) {
            $$$reportNull$$$0(14);
        }
        return str;
    ...
    public String toString() {
        return this.packageFqName.isRoot() ? InternalZipConstants.ZIP_FILE_SEPARATOR + asString() : asString();
    }
}
