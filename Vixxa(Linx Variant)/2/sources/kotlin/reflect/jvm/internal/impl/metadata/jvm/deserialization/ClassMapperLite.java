...
public final class ClassMapperLite {
    ...
    static {
        ...
        if (progressionLastElement >= 0) {
            ...
            while (true) {
                ...
                String str = f6kotlin;
                int i2 = i + 1;
                linkedHashMap.put(sb.append(str).append('/').append((String) listOf.get(i)).toString(), listOf.get(i2));
        ...
        linkedHashMap.put(f6kotlin + "/Unit", ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
    ...
    public static final String mapClass(String str) {
        ...
        return str2 == null ? "L" + StringsKt.replace$default(str, '.', (char) Typography.dollar, false, 4, (Object) null) + ';' : str2;
    }
}
