...
public class JvmClassName {
    ...
    public static JvmClassName byClassId(ClassId classId) {
        ...
        return new JvmClassName(packageFqName.asString().replace('.', '/') + InternalZipConstants.ZIP_FILE_SEPARATOR + replace);
    }
    ...
    public FqName getPackageFqName() {
        int lastIndexOf = this.internalName.lastIndexOf(InternalZipConstants.ZIP_FILE_SEPARATOR);
        if (lastIndexOf != -1) {
