...
public class DescriptorFactory {
    ...
    public static PropertyDescriptor createEnumEntriesProperty(ClassDescriptor classDescriptor) {
        ...
        create.setType(KotlinTypeFactory.simpleType(TypeAttributes.Companion.getEmpty(), findClassAcrossModuleDependencies.getTypeConstructor(), Collections.singletonList(new TypeProjectionImpl(classDescriptor.getDefaultType())), false), Collections.emptyList(), (ReceiverParameterDescriptor) null, (ReceiverParameterDescriptor) null, Collections.emptyList());
    ...
    public static ReceiverParameterDescriptor createContextReceiverParameterForCallable(CallableDescriptor callableDescriptor, KotlinType kotlinType, Name name, Annotations annotations) {
        if (callableDescriptor == null) {
            $$$reportNull$$$0(32);
        }
        if (annotations == null) {
        ...
        return new ReceiverParameterDescriptorImpl(callableDescriptor, new ContextReceiver(callableDescriptor, kotlinType, name, (ReceiverValue) null), annotations);
    }

    public static ReceiverParameterDescriptor createContextReceiverParameterForClass(ClassDescriptor classDescriptor, KotlinType kotlinType, Name name, Annotations annotations) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(34);
        }
        if (annotations == null) {
        ...
        return new ReceiverParameterDescriptorImpl(classDescriptor, new ContextClassReceiver(classDescriptor, kotlinType, name, (ReceiverValue) null), annotations);
    }
}
