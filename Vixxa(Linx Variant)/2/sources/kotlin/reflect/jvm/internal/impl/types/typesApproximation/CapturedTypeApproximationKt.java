...
public final class CapturedTypeApproximationKt {
    ...
    private static final TypeArgument toTypeArgument(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor) {
        ...
        if (i == 1) {
            ...
            Intrinsics.checkNotNullExpressionValue(type2, TransmitterActivityKt.OPERATION_TYPE);
            return new TypeArgument(typeParameterDescriptor, type, type2);
        } else if (i == 2) {
            KotlinType type3 = typeProjection.getType();
            Intrinsics.checkNotNullExpressionValue(type3, TransmitterActivityKt.OPERATION_TYPE);
            ...
            Intrinsics.checkNotNullExpressionValue(type4, TransmitterActivityKt.OPERATION_TYPE);
