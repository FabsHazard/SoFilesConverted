...
public abstract class AbstractSignatureParts<TAnnotation> {
    ...
    private final JavaTypeQualifiers extractQualifiersFromAnnotations(TypeAndDefaultQualifiers typeAndDefaultQualifiers) {
        ...
        NullabilityQualifierWithMigrationStatus extractNullability = getAnnotationTypeQualifierResolver().extractNullability(iterable, new AbstractSignatureParts$extractQualifiersFromAnnotations$annotationsNullability$1(this));
