...
public final class MemberDeserializer {
    ...
    public MemberDeserializer(DeserializationContext deserializationContext) {
        Intrinsics.checkNotNullParameter(deserializationContext, c.a);
    ...
    public final PropertyDescriptor loadProperty(ProtoBuf.Property property) {
        ...
        Iterable<ProtoBuf.Type> contextReceiverTypes = ProtoTypeTableUtilKt.contextReceiverTypes(property3, this.c.getTypeTable());
        Collection arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(contextReceiverTypes, 10));
        for (ProtoBuf.Type contextReceiver : contextReceiverTypes) {
            arrayList.add(toContextReceiver(contextReceiver, childContext$default, deserializedPropertyDescriptor3));
        }
        ...
        if (booleanValue6) {
            ...
            PropertyGetterDescriptorImpl propertyGetterDescriptorImpl4 = null;
        ...
        if (bool16.booleanValue()) {
            deserializedPropertyDescriptor3.setCompileTimeInitializerFactory(new MemberDeserializer$loadProperty$4(this, property3, deserializedPropertyDescriptor3));
        }
        ...
        if (classKind == ClassKind.ANNOTATION_CLASS) {
            deserializedPropertyDescriptor3.setCompileTimeInitializerFactory(new MemberDeserializer$loadProperty$5(this, property3, deserializedPropertyDescriptor3));
        }
        PropertyDescriptor propertyDescriptor = deserializedPropertyDescriptor3;
        deserializedPropertyDescriptor3.initialize(propertyGetterDescriptorImpl2, propertySetterDescriptorImpl, new FieldDescriptorImpl(getPropertyFieldAnnotations(property3, false), propertyDescriptor), new FieldDescriptorImpl(getPropertyFieldAnnotations(property3, z), propertyDescriptor));
    ...
    public final SimpleFunctionDescriptor loadFunction(ProtoBuf.Function function) {
        ...
        for (ProtoBuf.Type contextReceiver : ProtoTypeTableUtilKt.contextReceiverTypes(function2, this.c.getTypeTable())) {
            ReceiverParameterDescriptor contextReceiver2 = toContextReceiver(contextReceiver, childContext$default, deserializedSimpleFunctionDescriptor);
            if (contextReceiver2 != null) {
                arrayList.add(contextReceiver2);
            }
        }
        List<TypeParameterDescriptor> ownTypeParameters = childContext$default.getTypeDeserializer().getOwnTypeParameters();
    ...
    private final ReceiverParameterDescriptor toContextReceiver(ProtoBuf.Type type, DeserializationContext deserializationContext, CallableDescriptor callableDescriptor) {
        return DescriptorFactory.createContextReceiverParameterForCallable(callableDescriptor, deserializationContext.getTypeDeserializer().type(type), (Name) null, Annotations.Companion.getEMPTY());
    }
}
