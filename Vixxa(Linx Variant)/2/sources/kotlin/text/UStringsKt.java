...
public final class UStringsKt {
    ...
    public static final String m1650toStringV7xB4Y4(int i, int i2) {
        String l = Long.toString(((long) i) & InternalZipConstants.ZIP_64_SIZE_LIMIT, CharsKt.checkRadix(i2));
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m411unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m674unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m490unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m569unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m490unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m438constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m355boximpl(UByte.m361constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m490unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m438constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m618boximpl(UShort.m624constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m438constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m438constructorimpl(i3 * r3);
            int r7 = UInt.m438constructorimpl(UInt.m438constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m517constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m517constructorimpl(j * r5);
            long r13 = ULong.m517constructorimpl(ULong.m517constructorimpl(((long) UInt.m438constructorimpl(digitOf)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + r9);
