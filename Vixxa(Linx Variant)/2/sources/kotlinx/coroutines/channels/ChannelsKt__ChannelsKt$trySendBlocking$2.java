    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m343constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m343constructorimpl(Unit.INSTANCE);
        if (Result.m350isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1885successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1883closedJP2dKIU(Result.m346exceptionOrNullimpl(obj2));
        }
