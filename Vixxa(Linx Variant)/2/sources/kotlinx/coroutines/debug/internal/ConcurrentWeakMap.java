...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int i) {
            ...
            } while (!ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(this.values, i, obj, (Object) null));
        ...
        public final Object putImpl(K k, V v, HashedWeakRef<K> hashedWeakRef) {
            ...
            while (true) {
                ...
                if (hashedWeakRef2 == null) {
                    if (v != null) {
                        ...
                        if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(this.keys, index, (Object) null, hashedWeakRef)) {
                            break;
                        }
                    } else {
                        return null;
            ...
            } while (!ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(this.values, index, obj, v));
            return obj;
        }
