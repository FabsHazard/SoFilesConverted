...
public final class DelayKt {
    ...
    public static final Object m1849delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1850toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1850toDelayMillisLRDsOJo(long j) {
        if (Duration.m1675compareToLRDsOJo(j, Duration.Companion.m1779getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1694getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
