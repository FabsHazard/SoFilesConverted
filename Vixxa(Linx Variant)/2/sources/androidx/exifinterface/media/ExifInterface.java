...
public class ExifInterface {
    ...
    static {
        ...
        SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat(ExtendsKt.DATE_FORMAT_YMDHMS, Locale.US);
    ...
    private static class ExifAttribute {
        ...
        public java.lang.Object getValue(java.nio.ByteOrder r11) {
            /*
                ...
                r2 = 0
                androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream r3 = new androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream     // Catch:{ IOException -> 0x018b, all -> 0x0189 }
            ...
            L_0x001e:
                int r5 = r10.numberOfComponents     // Catch:{ IOException -> 0x0187 }
                if (r4 >= r5) goto L_0x002b
                double r5 = r3.readDouble()     // Catch:{ IOException -> 0x0187 }
            ...
            L_0x0038:
                ...
                float r5 = r3.readFloat()     // Catch:{ IOException -> 0x0187 }
            ...
            L_0x004f:
                int r11 = r10.numberOfComponents     // Catch:{ IOException -> 0x0187 }
                androidx.exifinterface.media.ExifInterface$Rational[] r11 = new androidx.exifinterface.media.ExifInterface.Rational[r11]     // Catch:{ IOException -> 0x0187 }
            L_0x0053:
                int r5 = r10.numberOfComponents     // Catch:{ IOException -> 0x0187 }
                ...
                androidx.exifinterface.media.ExifInterface$Rational r9 = new androidx.exifinterface.media.ExifInterface$Rational     // Catch:{ IOException -> 0x0187 }
            ...
            L_0x00ac:
                ...
                long r5 = r3.readUnsignedInt()     // Catch:{ IOException -> 0x0187 }
                long r7 = r3.readUnsignedInt()     // Catch:{ IOException -> 0x0187 }
                androidx.exifinterface.media.ExifInterface$Rational r9 = new androidx.exifinterface.media.ExifInterface$Rational     // Catch:{ IOException -> 0x0187 }
                r9.<init>(r5, r7)     // Catch:{ IOException -> 0x0187 }
                r11[r4] = r9     // Catch:{ IOException -> 0x0187 }
                int r4 = r4 + 1
            ...
            L_0x00ff:
                int r11 = r10.numberOfComponents     // Catch:{ IOException -> 0x0187 }
                byte[] r5 = androidx.exifinterface.media.ExifInterface.EXIF_ASCII_PREFIX     // Catch:{ IOException -> 0x0187 }
            ...
            L_0x0107:
                ...
                byte[] r5 = r10.bytes     // Catch:{ IOException -> 0x0187 }
                byte r5 = r5[r11]     // Catch:{ IOException -> 0x0187 }
                byte[] r6 = androidx.exifinterface.media.ExifInterface.EXIF_ASCII_PREFIX     // Catch:{ IOException -> 0x0187 }
            ...
            L_0x0117:
                ...
                goto L_0x0107
            L_0x011a:
                byte[] r11 = androidx.exifinterface.media.ExifInterface.EXIF_ASCII_PREFIX     // Catch:{ IOException -> 0x0187 }
                int r4 = r11.length     // Catch:{ IOException -> 0x0187 }
            L_0x011d:
            ...
            L_0x014b:
                ...
                byte r11 = r11[r4]     // Catch:{ IOException -> 0x0187 }
            ...
            L_0x0170:
                ...
                java.nio.charset.Charset r5 = androidx.exifinterface.media.ExifInterface.ASCII     // Catch:{ IOException -> 0x0187 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:53:0x00c0 A[ExcHandler: all (th java.lang.Throwable), Splitter:B:19:0x0056] */
    /* JADX WARNING: Removed duplicated region for block: B:63:0x00d2 A[Catch:{ Exception -> 0x00fd, all -> 0x00fa }] */
    /* JADX WARNING: Removed duplicated region for block: B:64:0x00e1 A[Catch:{ Exception -> 0x00fd, all -> 0x00fa }] */
    ...
    public void saveAttributes() throws java.io.IOException {
        ...
        L_0x0019:
            ...
            java.io.File r3 = java.io.File.createTempFile(r3, r4)     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            java.lang.String r4 = r14.mFilename     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            r5 = 0
            if (r4 == 0) goto L_0x0039
            java.io.FileInputStream r4 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            java.lang.String r7 = r14.mFilename     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            r4.<init>(r7)     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            goto L_0x0047
        L_0x0039:
            java.io.FileDescriptor r4 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            android.system.Os.lseek(r4, r5, r7)     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            java.io.FileInputStream r4 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            java.io.FileDescriptor r7 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
            r4.<init>(r7)     // Catch:{ Exception -> 0x0143, all -> 0x0140 }
        L_0x0047:
            java.io.FileOutputStream r7 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x013c, all -> 0x0138 }
            r7.<init>(r3)     // Catch:{ Exception -> 0x013c, all -> 0x0138 }
            copy(r4, r7)     // Catch:{ Exception -> 0x0136, all -> 0x0134 }
            closeQuietly(r4)
            closeQuietly(r7)
            r4 = 0
            java.io.FileInputStream r7 = new java.io.FileInputStream     // Catch:{ Exception -> 0x00c4, all -> 0x00c0 }
            r7.<init>(r3)     // Catch:{ Exception -> 0x00c4, all -> 0x00c0 }
            java.lang.String r8 = r14.mFilename     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
            if (r8 == 0) goto L_0x0067
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
            java.lang.String r9 = r14.mFilename     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
            r8.<init>(r9)     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
            goto L_0x0075
        L_0x0067:
            java.io.FileDescriptor r8 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
            int r9 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
            android.system.Os.lseek(r8, r5, r9)     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
            java.io.FileDescriptor r9 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
            r8.<init>(r9)     // Catch:{ Exception -> 0x00bb, all -> 0x00c0 }
        L_0x0075:
            java.io.BufferedInputStream r9 = new java.io.BufferedInputStream     // Catch:{ Exception -> 0x00b5, all -> 0x00c0 }
            r9.<init>(r7)     // Catch:{ Exception -> 0x00b5, all -> 0x00c0 }
            java.io.BufferedOutputStream r10 = new java.io.BufferedOutputStream     // Catch:{ Exception -> 0x00af, all -> 0x00ab }
            r10.<init>(r8)     // Catch:{ Exception -> 0x00af, all -> 0x00ab }
            int r11 = r14.mMimeType     // Catch:{ Exception -> 0x00a6 }
            r12 = 4
            if (r11 != r12) goto L_0x0088
            r14.saveJpegAttributes(r9, r10)     // Catch:{ Exception -> 0x00a6 }
            goto L_0x0097
        L_0x0088:
            r12 = 13
            if (r11 != r12) goto L_0x0090
            r14.savePngAttributes(r9, r10)     // Catch:{ Exception -> 0x00a6 }
            goto L_0x0097
        L_0x0090:
            r12 = 14
            if (r11 != r12) goto L_0x0097
            r14.saveWebpAttributes(r9, r10)     // Catch:{ Exception -> 0x00a6 }
        L_0x0097:
            closeQuietly(r9)
            closeQuietly(r10)
            r3.delete()
        ...
        L_0x00c7:
            ...
            r8 = r10
        L_0x00c9:
            java.io.FileInputStream r11 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0102, all -> 0x00ff }
            r11.<init>(r3)     // Catch:{ Exception -> 0x0102, all -> 0x00ff }
            java.lang.String r2 = r14.mFilename     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            if (r2 != 0) goto L_0x00e1
            java.io.FileDescriptor r2 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            int r12 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            android.system.Os.lseek(r2, r5, r12)     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            java.io.FileOutputStream r2 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            java.io.FileDescriptor r5 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            r2.<init>(r5)     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            goto L_0x00e8
        L_0x00e1:
            java.io.FileOutputStream r2 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            java.lang.String r5 = r14.mFilename     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            r2.<init>(r5)     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
        L_0x00e8:
            r8 = r2
            copy(r11, r8)     // Catch:{ Exception -> 0x00fd, all -> 0x00fa }
            closeQuietly(r11)     // Catch:{ all -> 0x00a3 }
            closeQuietly(r8)     // Catch:{ all -> 0x00a3 }
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x00a3 }
            java.lang.String r1 = "Failed to save new file"
            r0.<init>(r1, r7)     // Catch:{ all -> 0x00a3 }
        ...
        L_0x0102:
            ...
            r2 = r4
        L_0x0105:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ all -> 0x011c }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x011c }
            r5.<init>(r0)     // Catch:{ all -> 0x011c }
            java.lang.String r0 = r3.getAbsolutePath()     // Catch:{ all -> 0x011c }
            java.lang.StringBuilder r0 = r5.append(r0)     // Catch:{ all -> 0x011c }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x011c }
            r4.<init>(r0, r2)     // Catch:{ all -> 0x011c }
            throw r4     // Catch:{ all -> 0x011c }
        L_0x011c:
            r0 = move-exception
        L_0x011d:
            r2 = r11
        L_0x011e:
            closeQuietly(r2)     // Catch:{ all -> 0x0125 }
            closeQuietly(r8)     // Catch:{ all -> 0x0125 }
        ...
        L_0x0143:
            ...
            r7 = r2
        L_0x0145:
            java.io.IOException r1 = new java.io.IOException     // Catch:{ all -> 0x014d }
            java.lang.String r3 = "Failed to copy original file to temp file"
            r1.<init>(r3, r0)     // Catch:{ all -> 0x014d }
    ...
    public byte[] getThumbnailBytes() {
        ...
        L_0x003a:
            ...
            java.io.FileDescriptor r1 = android.system.Os.dup(r1)     // Catch:{ Exception -> 0x009d, all -> 0x009a }
            int r3 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0095, all -> 0x0092 }
            r4 = 0
            android.system.Os.lseek(r1, r4, r3)     // Catch:{ Exception -> 0x0095, all -> 0x0092 }
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            ...
            String[] split2 = split[0].split(InternalZipConstants.ZIP_FILE_SEPARATOR, -1);
            String[] split3 = split[1].split(InternalZipConstants.ZIP_FILE_SEPARATOR, -1);
            String[] split4 = split[2].split(InternalZipConstants.ZIP_FILE_SEPARATOR, -1);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:77:0x00e8 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void getJpegAttributes(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r21, int r22, int r23) throws java.io.IOException {
        ...
        L_0x00f0:
            ...
            r11.<init>(r6, r12)
            androidx.exifinterface.media.ExifInterface$ExifAttribute r6 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createString(r11)
            r10.put(r9, r6)
        L_0x0112:
            r10 = r3
            goto L_0x00b3
    ...
    private void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r27, int r28) throws java.io.IOException {
        ...
        L_0x016c:
            ...
            r11 = 6
            androidx.exifinterface.media.ExifInterface$ExifAttribute r8 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r11, (java.nio.ByteOrder) r8)
            int r11 = r0.mOrfThumbnailOffset
            r18 = r14
            r21 = r15
            long r14 = (long) r11
            java.nio.ByteOrder r11 = r0.mExifByteOrder
            androidx.exifinterface.media.ExifInterface$ExifAttribute r11 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createULong((long) r14, (java.nio.ByteOrder) r11)
        ...
        L_0x0215:
            ...
            if (r8 == r6) goto L_0x0233
            r3 = 9
            if (r8 == r3) goto L_0x022e
            r3 = 13
            if (r8 == r3) goto L_0x022e
            r3 = -1
            goto L_0x0242
