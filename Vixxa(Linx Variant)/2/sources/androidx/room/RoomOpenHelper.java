...
public class RoomOpenHelper extends SupportSQLiteOpenHelper.Callback {
    ...
    private final void checkIdentity(androidx.sqlite.db.SupportSQLiteDatabase r4) {
        /*
            ...
            r0 = r4
            android.database.Cursor r0 = (android.database.Cursor) r0     // Catch:{ all -> 0x0060 }
            boolean r1 = r0.moveToFirst()     // Catch:{ all -> 0x0060 }
            r2 = 0
            if (r1 == 0) goto L_0x0027
            r1 = 0
            java.lang.String r0 = r0.getString(r1)     // Catch:{ all -> 0x0060 }
            goto L_0x002b
        L_0x0027:
            r0 = r2
