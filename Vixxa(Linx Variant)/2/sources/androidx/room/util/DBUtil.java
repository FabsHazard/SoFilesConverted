...
public final class DBUtil {
    ...
    public static final void dropFtsSyncTriggers(androidx.sqlite.db.SupportSQLiteDatabase r6) {
        /*
            ...
            r2 = r1
            android.database.Cursor r2 = (android.database.Cursor) r2     // Catch:{ all -> 0x0061 }
        L_0x0014:
            boolean r3 = r2.moveToNext()     // Catch:{ all -> 0x0061 }
            r4 = 0
            if (r3 == 0) goto L_0x0023
            java.lang.String r3 = r2.getString(r4)     // Catch:{ all -> 0x0061 }
            r0.add(r3)     // Catch:{ all -> 0x0061 }
            goto L_0x0014
        L_0x0023:
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0061 }
            r2 = 0
    ...
    public static final void foreignKeyCheck(androidx.sqlite.db.SupportSQLiteDatabase r2, java.lang.String r3) {
        /*
            ...
            r3 = r2
            android.database.Cursor r3 = (android.database.Cursor) r3     // Catch:{ all -> 0x003f }
            int r0 = r3.getCount()     // Catch:{ all -> 0x003f }
            if (r0 > 0) goto L_0x0035
            kotlin.Unit r3 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x003f }
            r3 = 0
            kotlin.io.CloseableKt.closeFinally(r2, r3)
            return
        L_0x0035:
            java.lang.String r3 = processForeignKeyCheckFailure(r3)     // Catch:{ all -> 0x003f }
            android.database.sqlite.SQLiteConstraintException r0 = new android.database.sqlite.SQLiteConstraintException     // Catch:{ all -> 0x003f }
