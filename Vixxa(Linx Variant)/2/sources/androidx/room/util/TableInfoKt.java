...
public final class TableInfoKt {
    ...
    private static final Map<String, TableInfo.Column> readColumns(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            int columnIndex2 = cursor.getColumnIndex(TransmitterActivityKt.OPERATION_TYPE);
            ...
            while (cursor.moveToNext()) {
                ...
                Intrinsics.checkNotNullExpressionValue(string2, TransmitterActivityKt.OPERATION_TYPE);
    ...
    private static final java.util.Set<androidx.room.util.TableInfo.Index> readIndices(androidx.sqlite.db.SupportSQLiteDatabase r10, java.lang.String r11) {
        /*
            ...
            r1 = r11
            android.database.Cursor r1 = (android.database.Cursor) r1     // Catch:{ all -> 0x007a }
            int r2 = r1.getColumnIndex(r0)     // Catch:{ all -> 0x007a }
            java.lang.String r3 = "origin"
            int r3 = r1.getColumnIndex(r3)     // Catch:{ all -> 0x007a }
            java.lang.String r4 = "unique"
            int r4 = r1.getColumnIndex(r4)     // Catch:{ all -> 0x007a }
            r5 = -1
            r6 = 0
            ...
            goto L_0x0076
        L_0x0039:
            java.util.Set r5 = kotlin.collections.SetsKt.createSetBuilder()     // Catch:{ all -> 0x007a }
        L_0x003d:
            boolean r7 = r1.moveToNext()     // Catch:{ all -> 0x007a }
            if (r7 == 0) goto L_0x006e
            java.lang.String r7 = r1.getString(r3)     // Catch:{ all -> 0x007a }
            java.lang.String r8 = "c"
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r8, (java.lang.Object) r7)     // Catch:{ all -> 0x007a }
            if (r7 != 0) goto L_0x0050
            goto L_0x003d
        L_0x0050:
            java.lang.String r7 = r1.getString(r2)     // Catch:{ all -> 0x007a }
            int r8 = r1.getInt(r4)     // Catch:{ all -> 0x007a }
            r9 = 1
        ...
        L_0x005c:
            r9 = 0
        L_0x005d:
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r7, r0)     // Catch:{ all -> 0x007a }
            androidx.room.util.TableInfo$Index r7 = readIndex(r10, r7, r9)     // Catch:{ all -> 0x007a }
            if (r7 != 0) goto L_0x006a
            kotlin.io.CloseableKt.closeFinally(r11, r6)
            return r6
        L_0x006a:
            r5.add(r7)     // Catch:{ all -> 0x007a }
            goto L_0x003d
        L_0x006e:
            java.util.Set r10 = kotlin.collections.SetsKt.build(r5)     // Catch:{ all -> 0x007a }
            kotlin.io.CloseableKt.closeFinally(r11, r6)
            return r10
        L_0x0076:
            kotlin.io.CloseableKt.closeFinally(r11, r6)
