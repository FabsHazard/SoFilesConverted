    ...
    public static final class Companion {
        ...
        private final java.util.Set<java.lang.String> readColumns(androidx.sqlite.db.SupportSQLiteDatabase r5, java.lang.String r6) {
            /*
                ...
                r6 = r5
                android.database.Cursor r6 = (android.database.Cursor) r6     // Catch:{ all -> 0x004c }
                int r1 = r6.getColumnCount()     // Catch:{ all -> 0x004c }
                if (r1 <= 0) goto L_0x0041
                java.lang.String r1 = "name"
                int r1 = r6.getColumnIndex(r1)     // Catch:{ all -> 0x004c }
            L_0x002e:
                boolean r2 = r6.moveToNext()     // Catch:{ all -> 0x004c }
                if (r2 == 0) goto L_0x0041
                java.lang.String r2 = r6.getString(r1)     // Catch:{ all -> 0x004c }
                java.lang.String r3 = "cursor.getString(nameIndex)"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ all -> 0x004c }
        ...
        private final java.util.Set<java.lang.String> readOptions(androidx.sqlite.db.SupportSQLiteDatabase r3, java.lang.String r4) {
            /*
                ...
                r4 = r3
                android.database.Cursor r4 = (android.database.Cursor) r4     // Catch:{ all -> 0x003d }
                boolean r0 = r4.moveToFirst()     // Catch:{ all -> 0x003d }
                java.lang.String r1 = "sql"
                if (r0 == 0) goto L_0x002f
                int r0 = r4.getColumnIndexOrThrow(r1)     // Catch:{ all -> 0x003d }
                java.lang.String r4 = r4.getString(r0)     // Catch:{ all -> 0x003d }
                goto L_0x0031
            L_0x002f:
                java.lang.String r4 = ""
            L_0x0031:
