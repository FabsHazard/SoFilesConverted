    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i21 = 0; i21 < i16; i21++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i18) {
                ...
                if (this.mOrientation == 1) {
                    i13 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i23, layoutParams.width, false);
                    i12 = View.MeasureSpec.makeMeasureSpec(i18 - i22, BasicMeasure.EXACTLY);
                } else {
                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i18 - i23, BasicMeasure.EXACTLY);
                    i12 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i22, layoutParams.height, false);
                    i13 = makeMeasureSpec;
                }
