...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - TimeUtils.oneDayMillis, location.getLatitude(), location.getLongitude());
        ...
        long j4 = j3;
        long j5 = j2;
        instance.calculateTwilight(currentTimeMillis + TimeUtils.oneDayMillis, location.getLatitude(), location.getLongitude());
        ...
        if (j5 == -1 || j4 == -1) {
            ...
            j = j6 + TimeUtils.oneMinuteMillis;
        }
