...
public final class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
    ...
    private static final class OpenHelper extends SQLiteOpenHelper {
        ...
        private final android.database.sqlite.SQLiteDatabase innerGetDatabase(boolean r5) {
            ...
            L_0x002f:
                android.database.sqlite.SQLiteDatabase r5 = r4.getWritableOrReadableDatabase(r5)     // Catch:{ all -> 0x0034 }
                return r5
            L_0x0034:
                super.close()
            ...
            L_0x003c:
                android.database.sqlite.SQLiteDatabase r5 = r4.getWritableOrReadableDatabase(r5)     // Catch:{ all -> 0x0041 }
                return r5
            L_0x0041:
                r1 = move-exception
                super.close()
            ...
            L_0x0078:
                ...
                android.database.sqlite.SQLiteDatabase r5 = r4.getWritableOrReadableDatabase(r5)     // Catch:{ CallbackException -> 0x0082 }
                return r5
            L_0x0082:
                r5 = move-exception
