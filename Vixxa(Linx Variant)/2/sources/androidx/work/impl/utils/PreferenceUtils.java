...
public class PreferenceUtils {
    ...
    public LiveData<Long> getLastCancelAllTimeMillisLiveData() {
        return Transformations.map((LiveData) this.mWorkDatabase.preferenceDao().getObservableLongValue(KEY_LAST_CANCEL_ALL_TIME_MS), (Function) new Function<Long, Long>() {
