...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r12, int r13, boolean r14) {
            ...
            L_0x0112:
                ...
                androidx.core.app.NotificationCompat.Style.Api16Impl.setTextViewTextSize(r7, r0, r8, r14)
            L_0x0143:
    ...
    public static class CallStyle extends Style {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            Notification.Action.Builder createActionBuilder = Api23Impl.createActionBuilder(icon, action.getTitle(), action.getActionIntent());
            ...
            if (remoteInputs != null) {
                for (RemoteInput addRemoteInput : RemoteInput.fromCompat(remoteInputs)) {
                    Api20Impl.addRemoteInput(createActionBuilder, addRemoteInput);
                }
            }
