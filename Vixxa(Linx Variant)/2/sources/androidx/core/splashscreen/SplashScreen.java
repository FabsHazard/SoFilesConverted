...
public final class SplashScreen {
    ...
    public final void setOnExitAnimationListener(OnExitAnimationListener onExitAnimationListener) {
        Intrinsics.checkNotNullParameter(onExitAnimationListener, "listener");
    ...
    private static class Impl {
        ...
        public static final boolean m28splashScreenWaitPredicate$lambda0() {
            return false;
        }
        ...
        public static final void m27dispatchOnExitAnimation$lambda3(SplashScreenViewProvider splashScreenViewProvider, OnExitAnimationListener onExitAnimationListener) {
            Intrinsics.checkNotNullParameter(splashScreenViewProvider, "$splashScreenViewProvider");
    ...
    private static final class Impl31 extends Impl {
        ...
        public static final void m29setOnExitAnimationListener$lambda0(Impl31 impl31, OnExitAnimationListener onExitAnimationListener, SplashScreenView splashScreenView) {
