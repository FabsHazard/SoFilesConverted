...
final class ContinuationOutcomeReceiver<R, E extends Throwable> extends AtomicBoolean implements OutcomeReceiver<R, E> {
    ...
    public void onResult(R r) {
        Intrinsics.checkNotNullParameter(r, WiseOpenHianalyticsData.UNION_RESULT);
        if (compareAndSet(false, true)) {
            Continuation<R> continuation2 = this.continuation;
            Result.Companion companion = Result.Companion;
            continuation2.resumeWith(Result.m343constructorimpl(r));
        }
    }
    ...
    public void onError(E e) {
        ...
        if (compareAndSet(false, true)) {
            Continuation<R> continuation2 = this.continuation;
            Result.Companion companion = Result.Companion;
            continuation2.resumeWith(Result.m343constructorimpl(ResultKt.createFailure(e)));
        }
    }
