...
public class RawIO {
    ...
    public long readLongLittleEndian(byte[] bArr, int i) {
        ...
        return ((long) (bArr2[0] & UByte.MAX_VALUE)) | (((((((((((((((long) (bArr2[7] & UByte.MAX_VALUE)) << 8) | ((long) (bArr2[6] & UByte.MAX_VALUE))) << 8) | ((long) (bArr2[5] & UByte.MAX_VALUE))) << 8) | ((long) (bArr2[4] & UByte.MAX_VALUE))) << 8) | ((long) (bArr2[3] & UByte.MAX_VALUE))) << 8) | ((long) (bArr2[2] & UByte.MAX_VALUE))) << 8) | ((long) (bArr2[1] & UByte.MAX_VALUE))) << 8);
    }
