...
public class RenameFilesTask extends AbstractModifyFileTask<RenameFilesTaskParameters> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:59:0x0148, code lost:
        r0 = th;
     */
    /* JADX WARNING: Exception block dominator not found, dom blocks: [B:31:0x0116, B:52:0x013e] */
    ...
    public void executeTask(net.lingala.zip4j.tasks.RenameFilesTask.RenameFilesTaskParameters r26, net.lingala.zip4j.progress.ProgressMonitor r27) throws java.io.IOException {
        ...
        L_0x0013:
            ...
            java.io.RandomAccessFile r11 = new java.io.RandomAccessFile     // Catch:{ all -> 0x014a }
            net.lingala.zip4j.model.ZipModel r1 = r12.zipModel     // Catch:{ all -> 0x014a }
            java.io.File r1 = r1.getZipFile()     // Catch:{ all -> 0x014a }
            net.lingala.zip4j.model.enums.RandomAccessFileMode r2 = net.lingala.zip4j.model.enums.RandomAccessFileMode.WRITE     // Catch:{ all -> 0x014a }
            java.lang.String r2 = r2.getValue()     // Catch:{ all -> 0x014a }
            r11.<init>(r1, r2)     // Catch:{ all -> 0x014a }
            net.lingala.zip4j.io.outputstream.SplitOutputStream r10 = new net.lingala.zip4j.io.outputstream.SplitOutputStream     // Catch:{ all -> 0x0139 }
            r10.<init>(r14)     // Catch:{ all -> 0x0139 }
            net.lingala.zip4j.model.Zip4jConfig r1 = r0.zip4jConfig     // Catch:{ all -> 0x0128 }
            java.nio.charset.Charset r9 = r1.getCharset()     // Catch:{ all -> 0x0128 }
            net.lingala.zip4j.model.ZipModel r1 = r12.zipModel     // Catch:{ all -> 0x0128 }
            net.lingala.zip4j.model.CentralDirectory r1 = r1.getCentralDirectory()     // Catch:{ all -> 0x0128 }
            java.util.List r1 = r1.getFileHeaders()     // Catch:{ all -> 0x0128 }
            java.util.List r8 = r12.cloneAndSortFileHeadersByOffset(r1)     // Catch:{ all -> 0x0128 }
        ...
        L_0x012c:
            r1 = r0
        L_0x012d:
            r13.close()     // Catch:{ all -> 0x0131 }
            goto L_0x0136
        L_0x0131:
            r0 = move-exception
            r2 = r0
            r1.addSuppressed(r2)     // Catch:{ all -> 0x0137 }
        L_0x0136:
        ...
        L_0x013c:
            ...
            r15 = 0
        L_0x013e:
            r24.close()     // Catch:{ all -> 0x0142 }
            goto L_0x0147
        L_0x0142:
            r0 = move-exception
            r2 = r0
            r1.addSuppressed(r2)     // Catch:{ all -> 0x0148 }
        L_0x0147:
    ...
    private Map<String, String> filterNonExistingEntriesAndAddSeparatorIfNeeded(Map<String, String> map) throws ZipException {
        ...
        for (Map.Entry next : map.entrySet()) {
            if (Zip4jUtil.isStringNotNullAndNotEmpty((String) next.getKey()) && (fileHeader = HeaderUtil.getFileHeader(this.zipModel, (String) next.getKey())) != null) {
                if (!fileHeader.isDirectory() || ((String) next.getValue()).endsWith(InternalZipConstants.ZIP_FILE_SEPARATOR)) {
                    hashMap.put(next.getKey(), next.getValue());
                } else {
                    hashMap.put(next.getKey(), ((String) next.getValue()) + InternalZipConstants.ZIP_FILE_SEPARATOR);
                }
            }
        }
        return hashMap;
