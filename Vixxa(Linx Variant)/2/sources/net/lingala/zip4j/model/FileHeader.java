...
public class FileHeader extends AbstractFileHeader {
    ...
    public boolean equals(Object obj) {
        ...
        if (determineOffsetOfLocalFileHeader(this) == determineOffsetOfLocalFileHeader((FileHeader) obj)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{getFileName(), Long.valueOf(determineOffsetOfLocalFileHeader(this))});
    }
