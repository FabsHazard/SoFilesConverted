...
public final class Pipe {
    ...
    public final void fold(okio.Sink r8) throws java.io.IOException {
        ...
        L_0x0005:
            ...
            monitor-enter(r0)
            okio.Sink r1 = r7.foldedSink     // Catch:{ all -> 0x0074 }
            if (r1 != 0) goto L_0x0068
            boolean r1 = r7.canceled     // Catch:{ all -> 0x0074 }
            if (r1 != 0) goto L_0x005e
            okio.Buffer r1 = r7.buffer     // Catch:{ all -> 0x0074 }
            boolean r1 = r1.exhausted()     // Catch:{ all -> 0x0074 }
            r2 = 1
            if (r1 == 0) goto L_0x001f
            r7.sourceClosed = r2     // Catch:{ all -> 0x0074 }
            r7.foldedSink = r8     // Catch:{ all -> 0x0074 }
            monitor-exit(r0)
            return
        L_0x001f:
            boolean r1 = r7.sinkClosed     // Catch:{ all -> 0x0074 }
            okio.Buffer r3 = new okio.Buffer     // Catch:{ all -> 0x0074 }
            r3.<init>()     // Catch:{ all -> 0x0074 }
            okio.Buffer r4 = r7.buffer     // Catch:{ all -> 0x0074 }
            long r5 = r4.size()     // Catch:{ all -> 0x0074 }
            r3.write((okio.Buffer) r4, (long) r5)     // Catch:{ all -> 0x0074 }
            okio.Buffer r4 = r7.buffer     // Catch:{ all -> 0x0074 }
            ...
            monitor-exit(r0)
            long r4 = r3.size()     // Catch:{ all -> 0x004a }
            r8.write(r3, r4)     // Catch:{ all -> 0x004a }
        ...
        L_0x004a:
            ...
            okio.Buffer r0 = r7.buffer
            monitor-enter(r0)
            r7.sourceClosed = r2     // Catch:{ all -> 0x005b }
            okio.Buffer r1 = r7.buffer     // Catch:{ all -> 0x005b }
            java.lang.Object r1 = (java.lang.Object) r1     // Catch:{ all -> 0x005b }
        ...
        L_0x005e:
            r7.foldedSink = r8     // Catch:{ all -> 0x0074 }
            java.io.IOException r8 = new java.io.IOException     // Catch:{ all -> 0x0074 }
            java.lang.String r1 = "canceled"
            r8.<init>(r1)     // Catch:{ all -> 0x0074 }
    ...
    public final Sink m2087deprecated_sink() {
        return this.sink;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "source", imports = {}))
    /* renamed from: -deprecated_source  reason: not valid java name */
    public final Source m2088deprecated_source() {
        return this.source;
    }
