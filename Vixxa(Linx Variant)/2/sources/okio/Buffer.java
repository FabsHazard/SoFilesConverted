...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final ByteString hmacSha1(ByteString byteString) {
        ...
        return hmac(InternalZipConstants.AES_MAC_ALGORITHM, byteString);
    }
    ...
    public final byte m2068deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m2069deprecated_size() {
        return this.size;
    }
                    ...
                    if (size() - j3 < j3) {
                        ...
                        if (segment != null) {
                            ...
                            while (j2 < size5) {
                                ...
                                while (i < min2) {
                                    if (bArr2[i] == b2) {
                                        if (_BufferKt.rangeEquals(segment, i + 1, internalArray$okio2, 1, size4)) {
                                        }
                                    }
                                    i2 = i + 1;
                                }
