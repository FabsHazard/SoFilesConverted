...
public final class _PathKt {
    ...
    /* access modifiers changed from: private */
    public static final ByteString SLASH = ByteString.Companion.encodeUtf8(InternalZipConstants.ZIP_FILE_SEPARATOR);
    ...
    public static final int rootLength(Path path) {
        ...
        if (path.getBytes$okio().getByte(0) != b) {
            ...
            return -1;
        } else if (path.getBytes$okio().size() <= 2 || path.getBytes$okio().getByte(1) != b) {
            return 1;
        } else {
    ...
    public static final ByteString toSlash(String str) {
        if (Intrinsics.areEqual((Object) str, (Object) InternalZipConstants.ZIP_FILE_SEPARATOR)) {
            return SLASH;
        }
