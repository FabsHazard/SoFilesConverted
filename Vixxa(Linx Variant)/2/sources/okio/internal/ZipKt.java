...
public final class ZipKt {
    ...
    private static final Map<Path, ZipEntry> buildIndex(List<ZipEntry> list) {
        Path path = Path.Companion.get$default(Path.Companion, InternalZipConstants.ZIP_FILE_SEPARATOR, false, 1, (Object) null);
        ...
        if (readIntLe == CENTRAL_FILE_HEADER_SIGNATURE) {
            ...
            if ((readShortLe & 1) == 0) {
                ...
                if (!StringsKt.contains$default((CharSequence) readUtf8, 0, false, 2, (Object) null)) {
                    ...
                    readExtra(bufferedSource2, readShortLe4, new ZipKt$readEntry$1(booleanRef, j3, longRef2, bufferedSource, longRef, longRef3));
                    if (j3 <= 0 || booleanRef2.element) {
                        String str3 = str2;
                        return new ZipEntry(Path.Companion.get$default(Path.Companion, InternalZipConstants.ZIP_FILE_SEPARATOR, false, 1, (Object) null).resolve(str3), StringsKt.endsWith$default(str3, InternalZipConstants.ZIP_FILE_SEPARATOR, false, 2, (Object) null), bufferedSource2.readUtf8((long) readShortLe5), j4, longRef.element, longRef2.element, readShortLe2, dosDateTimeToEpochMillis, longRef4.element);
                    }
