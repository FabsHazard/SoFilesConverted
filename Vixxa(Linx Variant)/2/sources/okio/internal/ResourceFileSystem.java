...
public final class ResourceFileSystem extends FileSystem {
    ...
    /* access modifiers changed from: private */
    @Deprecated
    public static final Path ROOT = Path.Companion.get$default(Path.Companion, InternalZipConstants.ZIP_FILE_SEPARATOR, false, 1, (Object) null);
    ...
    private static final class Companion {
        ...
        public final Pair<FileSystem, Path> toJarRoot(URL url) {
            ...
            String substring = url2.substring("jar:".length(), lastIndexOf$default);
