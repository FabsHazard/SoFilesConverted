    ...
    public final void invoke(int i, long j) {
        ...
        if (!this.$hasZip64Extra.element) {
            ...
            if (j >= this.$requiredZip64ExtraSize) {
                ...
                longRef.element = longRef.element == InternalZipConstants.ZIP_64_SIZE_LIMIT ? this.$this_readEntry.readLongLe() : this.$size.element;
                Ref.LongRef longRef2 = this.$compressedSize;
                long j2 = 0;
                longRef2.element = longRef2.element == InternalZipConstants.ZIP_64_SIZE_LIMIT ? this.$this_readEntry.readLongLe() : 0;
                Ref.LongRef longRef3 = this.$offset;
                if (longRef3.element == InternalZipConstants.ZIP_64_SIZE_LIMIT) {
