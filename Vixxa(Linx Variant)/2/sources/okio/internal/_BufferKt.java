...
public final class _BufferKt {
    ...
    public static final int commonReadInt(Buffer buffer) {
        ...
        if (buffer.size() >= 4) {
            ...
            byte[] bArr = segment.data;
            byte b = ((bArr[i + 1] & UByte.MAX_VALUE) << 16) | ((bArr[i] & UByte.MAX_VALUE) << 24);
            int i3 = i + 3;
            int i4 = i + 4;
    ...
    public static final long commonReadLong(Buffer buffer) {
        ...
        if (buffer.size() >= 8) {
            ...
            int i2 = segment.limit;
            if (((long) (i2 - i)) < 8) {
                return ((((long) buffer.readInt()) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 32) | (InternalZipConstants.ZIP_64_SIZE_LIMIT & ((long) buffer.readInt()));
            }
            byte[] bArr = segment.data;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:44:0x009b A[EDGE_INSN: B:44:0x009b->B:28:0x009b ?: BREAK  , SYNTHETIC] */
                ...
                if (charAt2 < 128) {
                    ...
                    if (charAt2 < 2048) {
                        ...
                        if (charAt2 > 56319 || 56320 > c || c >= 57344) {
                            ...
                            int i7 = (((charAt2 & 1023) << 10) | (c & 1023)) + CharCompanionObject.MIN_VALUE;
