...
public final class HashingSink extends ForwardingSink implements Sink {
    ...
    public final ByteString hash() {
        ...
        Intrinsics.checkNotNullExpressionValue(bArr, WiseOpenHianalyticsData.UNION_RESULT);
        return new ByteString(bArr);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "hash", imports = {}))
    /* renamed from: -deprecated_hash  reason: not valid java name */
    public final ByteString m2085deprecated_hash() {
        return hash();
    }
    ...
    public static final class Companion {
        ...
        public final HashingSink hmacSha1(Sink sink, ByteString byteString) {
            ...
            return new HashingSink(sink, byteString, InternalZipConstants.AES_MAC_ALGORITHM);
        }
