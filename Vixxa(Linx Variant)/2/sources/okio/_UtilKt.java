...
public final class _UtilKt {
    ...
    public static final String toHexString(long j) {
        ...
        char c = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 60) & 15)];
        char c2 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 56) & 15)];
        char c3 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 52) & 15)];
        char c4 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 48) & 15)];
        char c5 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 44) & 15)];
        char c6 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 40) & 15)];
        char c7 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 36) & 15)];
        char c8 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 32) & 15)];
        char c9 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 28) & 15)];
        char c10 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 24) & 15)];
        char c11 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 20) & 15)];
        char c12 = _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 16) & 15)];
        int i = 0;
        char[] cArr = {c, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 12) & 15)], _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 8) & 15)], _ByteStringKt.getHEX_DIGIT_CHARS()[(int) ((j >> 4) & 15)], _ByteStringKt.getHEX_DIGIT_CHARS()[(int) (j & 15)]};
        while (i < 16 && cArr[i] == '0') {
            i++;
        }
