...
public abstract class FileSystem {
    ...
    public final <T> T m2080read(Path path, Function1<? super BufferedSource, ? extends T> function1) throws IOException {
        T t;
        Intrinsics.checkNotNullParameter(path, "file");
    ...
    public static /* synthetic */ Object m2079write$default(FileSystem fileSystem, Path path, boolean z, Function1 function1, int i, Object obj) throws IOException {
        Object obj2;
        if (obj == null) {
            if ((i & 2) != 0) {
                z = false;
    ...
    public final <T> T m2081write(Path path, boolean z, Function1<? super BufferedSink, ? extends T> function1) throws IOException {
        T t;
        Intrinsics.checkNotNullParameter(path, "file");
        Intrinsics.checkNotNullParameter(function1, "writerAction");
